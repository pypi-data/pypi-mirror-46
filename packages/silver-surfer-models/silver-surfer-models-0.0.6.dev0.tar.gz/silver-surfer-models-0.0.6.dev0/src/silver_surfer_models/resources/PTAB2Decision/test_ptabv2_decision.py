...
from src.silver_surfer_models.resources.PTAB2Decision import PTAB2Decision
...
class PTAB2DecisionResourceTestCase(TestCase):
    def setUp(self):
        ...
        self.ptab2_decision1 = self.inst.create({
            ...
            'identifier': '98cb43419f24f281879cd028cf1d74fb8c52916fc017cb1a',
    ...
    def test_create_violates_unique_constraint(self):
        ...
        data['proceeding_number'] = self.ptab2_decision1['proceeding_number']
        self.assertRaises(
            IntegrityError,
            self.inst.create,
            data,
    ...
    @parameterized.expand([
        ...
        ('proceeding_number', 'ptab2_decision1', 'proceeding_number', 1),
    ])
    ...
    def test_upsert_updates_existing_row(self):
        data = {
            **self.valid_data,
            **{'proceeding_number': self.ptab2_decision1['proceeding_number']},
        }
