...
from .api_compo_freeze2 import api_compo_freeze2
...
main_api = {
  ...
  'help': lambda args: api_help(),
  'h': lambda args: api_help(),
  'compo': lambda args: api_compo(FILES_COMPOSE),
  'compo-freeze': lambda args: api_compo_freeze(FILES_COMPOSE),
  'compo-freeze2': lambda args: api_compo_freeze2(FILES_COMPOSE),
...
def main():
  ...
  if(cmd not in main_api):
    print('unkown command "stackd ' + cmd + '"')
    main_api['help'](args)
    sys.exit(1)
  main_api[cmd](args)
