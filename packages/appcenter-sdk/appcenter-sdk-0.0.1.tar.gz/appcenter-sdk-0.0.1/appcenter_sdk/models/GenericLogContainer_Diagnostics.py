...
class GenericLogContainer_Diagnostics(object):
    ...
    def __init__(self, exceeded_max_limit=None, last_received_log_timestamp=None, logs=None):  # noqa: E501
        """GenericLogContainer_Diagnostics - a model defined in Swagger"""  # noqa: E501
    ...
    def exceeded_max_limit(self):
        """Gets the exceeded_max_limit of this GenericLogContainer_Diagnostics.  # noqa: E501

        indicates if the number of available logs are more than the max allowed return limit(100).  # noqa: E501

        :return: The exceeded_max_limit of this GenericLogContainer_Diagnostics.  # noqa: E501
        :rtype: boolean
        """
    ...
    def exceeded_max_limit(self, exceeded_max_limit):
        """Sets the exceeded_max_limit of this GenericLogContainer_Diagnostics.

        indicates if the number of available logs are more than the max allowed return limit(100).  # noqa: E501

        :param exceeded_max_limit: The exceeded_max_limit of this GenericLogContainer_Diagnostics.  # noqa: E501
        :type: boolean
        """
    ...
    def last_received_log_timestamp(self):
        """Gets the last_received_log_timestamp of this GenericLogContainer_Diagnostics.  # noqa: E501
        ...
        :return: The last_received_log_timestamp of this GenericLogContainer_Diagnostics.  # noqa: E501
        :rtype: string
        """
    ...
    def last_received_log_timestamp(self, last_received_log_timestamp):
        """Sets the last_received_log_timestamp of this GenericLogContainer_Diagnostics.

        the timestamp of the last log received. This value can be used as the start time parameter in the consecutive API call.  # noqa: E501

        :param last_received_log_timestamp: The last_received_log_timestamp of this GenericLogContainer_Diagnostics.  # noqa: E501
        :type: string
        """
    ...
    @property
    def logs(self):
        """Gets the logs of this GenericLogContainer_Diagnostics.  # noqa: E501

        the list of logs  # noqa: E501

        :return: The logs of this GenericLogContainer_Diagnostics.  # noqa: E501
        :rtype: array
        """
        return self._logs
    ...
    @logs.setter
    def logs(self, logs):
        """Sets the logs of this GenericLogContainer_Diagnostics.

        the list of logs  # noqa: E501

        :param logs: The logs of this GenericLogContainer_Diagnostics.  # noqa: E501
        :type: array
        """
        if logs is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GenericLogContainer_Diagnostics):
            return False
