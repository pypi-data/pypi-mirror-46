...
class ReleaseDetailsResponse(object):
    ...
    def __init__(self, id=None, app_name=None, app_display_name=None, version=None, short_version=None, release_notes=None, provisioning_profile_name=None, provisioning_profile_type=None, provisioning_profile_expiry_date=None, is_provisioning_profile_syncing=None, size=None, min_os=None, device_family=None, android_min_api_level=None, bundle_identifier=None, fingerprint=None, uploaded_at=None, download_url=None, app_icon_url=None, install_url=None, destination_type=None, distribution_groups=None, distribution_stores=None, destinations=None, is_udid_provisioned=None, can_resign=None, build=None, enabled=None):  # noqa: E501
