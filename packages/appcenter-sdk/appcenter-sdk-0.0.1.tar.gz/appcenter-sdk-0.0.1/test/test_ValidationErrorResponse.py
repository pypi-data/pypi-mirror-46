...
from ValidationErrorResponse.clsValidationErrorResponse import ValidationErrorResponse  # noqa: E501
...
class TestValidationErrorResponse(unittest.TestCase):
    ...
    def testValidationErrorResponse(self):
        ...
        # model = appcenter_sdk.models.clsValidationErrorResponse.ValidationErrorResponse()  # noqa: E501
        pass
