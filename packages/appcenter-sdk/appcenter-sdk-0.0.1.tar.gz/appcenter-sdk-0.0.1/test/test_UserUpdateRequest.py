...
from UserUpdateRequest.clsUserUpdateRequest import UserUpdateRequest  # noqa: E501
...
class TestUserUpdateRequest(unittest.TestCase):
    ...
    def testUserUpdateRequest(self):
        ...
        # model = appcenter_sdk.models.clsUserUpdateRequest.UserUpdateRequest()  # noqa: E501
        pass
