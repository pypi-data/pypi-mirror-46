...
from ApplicationsResponse.clsApplicationsResponse import ApplicationsResponse  # noqa: E501
...
class TestApplicationsResponse(unittest.TestCase):
    ...
    def testApplicationsResponse(self):
        ...
        # model = appcenter_sdk.models.clsApplicationsResponse.ApplicationsResponse()  # noqa: E501
        pass
