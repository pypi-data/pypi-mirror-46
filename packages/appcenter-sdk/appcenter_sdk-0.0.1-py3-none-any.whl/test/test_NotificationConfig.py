...
from NotificationConfig.clsNotificationConfig import NotificationConfig  # noqa: E501
...
class TestNotificationConfig(unittest.TestCase):
    ...
    def testNotificationConfig(self):
        ...
        # model = appcenter_sdk.models.clsNotificationConfig.NotificationConfig()  # noqa: E501
        pass
