...
class RabbitReceiverV(object):
    ...
    def connect(self):
        ...
        return pika.SelectConnection(self._config.parameters,
    ...
    def on_connection_closed(self, connection, reply_code, reply_text):
        ...
        if self._closing:
            ...
            self._connection.add_timeout(self._config.parameters.socket_timeout, self.reconnect)
    ...
    def reconnect(self):
        ...
        raise ReconnectionException('Disconnected from rabbit server')
    ...
    def on_message(self, unused_channel, basic_deliver, properties, body):
        ...
        """
        _logger.info('Received message # %s from %s: %s',
