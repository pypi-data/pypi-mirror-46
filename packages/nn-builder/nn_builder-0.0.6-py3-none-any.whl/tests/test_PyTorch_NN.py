...
def test_linear_hidden_units_user_input():
    ...
    for input_value in inputs_that_should_fail:
        with pytest.raises(AssertionError):
            NN(input_dim=2, hidden_layers_info=input_value, hidden_activations="relu", output_dim=2, output_activation="relu")
...
def test_input_dim_output_dim_user_input():
    ...
    for input_value in inputs_that_should_fail:
        with pytest.raises(AssertionError):
            NN(input_dim=input_value, hidden_layers_info=[2], hidden_activations="relu", output_dim=2, output_activation="relu")
        with pytest.raises(AssertionError):
            NN(input_dim=2, hidden_layers_info=[2], hidden_activations="relu", output_dim=input_value, output_activation="relu")
...
def test_activations_user_input():
    ...
    for input_value in inputs_that_should_fail:
        with pytest.raises(AssertionError):
            NN(input_dim=2, hidden_layers_info=[2], hidden_activations=input_value, output_dim=2,
               output_activation="relu")
            NN(input_dim=2, hidden_layers_info=[2], hidden_activations="relu", output_dim=2,
...
def test_output_shape_correct():
    ...
    for input_dim, output_dim, linear_hidden_units in zip(input_dims, output_dims, linear_hidden_units_options):
        nn_instance = NN(input_dim=input_dim, hidden_layers_info=linear_hidden_units, hidden_activations="relu",
...
def test_output_activation():
    ...
    for _ in range(RANDOM_ITERATIONS):
        ...
        nn_instance = NN(input_dim=100, hidden_layers_info=[5, 5, 5],
...
def test_linear_layers():
    ...
    for input_dim, output_dim, hidden_units in zip( range(5, 8), range(9, 12), [[2, 9, 2], [3, 5, 6], [9, 12, 2]]):
        nn_instance = NN(input_dim=input_dim, hidden_layers_info=hidden_units,
                         hidden_activations="relu",
...
def test_embedding_layers():
    ...
    for embedding_in_dim_1, embedding_out_dim_1, embedding_in_dim_2, embedding_out_dim_2 in zip(range(5, 8), range(3, 6), range(1, 4), range(24, 27)):
        nn_instance = NN(input_dim=5, hidden_layers_info=[5],
                         output_dim=5,
...
def test_embedding_network_can_solve_simple_problem():
    ...
    y = (X[:, 0] >= 20) * (X[:, 1] <= 20)
    X = X.long()
    nn_instance = NN(input_dim=2, hidden_layers_info=[5],
                     output_dim=1,
...
def test_model_trains():
    ...
    for output_activation in ["sigmoid", "None"]:
        nn_instance = NN(input_dim=X.shape[1], hidden_layers_info=[10, 10, 10], output_dim=1,
    ...
    nn_instance = NN(input_dim=X.shape[1], hidden_layers_info=[10, 10, 10], output_dim=2,
...
def test_dropout():
    ...
    nn_instance = NN(input_dim=X.shape[1], hidden_layers_info=[10, 10], output_dim=1, dropout=0.9999)
    assert nn_instance.dropout_layer.p == 0.9999
    assert not solves_simple_problem(X, y, nn_instance)
    nn_instance = NN(input_dim=X.shape[1], hidden_layers_info=[10, 10], output_dim=1, dropout=0.00001)
    assert solves_simple_problem(X, y, nn_instance)
...
def test_y_range_user_input():
    ...
    for y_range_value in invalid_y_range_inputs:
        with pytest.raises(AssertionError):
            print(y_range_value)
            nn_instance = NN(input_dim=5, hidden_layers_info=[10, 10], output_dim=3,
...
def test_y_range():
    ...
    for _ in range(100):
        ...
        nn_instance = NN(input_dim=5, hidden_layers_info=[10, 10], output_dim=3, y_range=(lower_bound, upper_bound))
...
def test_deals_with_None_activation():
    ...
    nn_instance = NN(input_dim=5, hidden_layers_info=[10, 10], output_dim=3, output_activation=None)
