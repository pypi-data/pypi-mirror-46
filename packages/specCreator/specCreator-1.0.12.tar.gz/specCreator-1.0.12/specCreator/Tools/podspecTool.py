...
class PodspecTool(object):
    ...
    # TODO 不好。
    def changePodSpec(self, podName, subspecName="", useTag=True, commitId="", dependencyDict={}, LFSURL="", replaceName=True, useSSH=False):
    ...
    def changePodSpecForTmpPodspec(self, subSpecName):
        ...
        self.changePodSpec(podName + subSpecName, "Tmp", False, commitID, dependencyDict, "" , True, False)
    ...
    def changePodSpecForCheck(self):
        ...
        dependencyDict = self.arguments.dependencyDict
        commitID = self.arguments.commitId
        self.changePodSpec(podName, "", False, commitID, dependencyDict)

    def changePodSpecForPackage(self, subspecName):
        podName = self.arguments.podName
        dependencyDict = self.arguments.dependencyDict
        commitId = self.arguments.commitId
        self.changePodSpec(podName, subspecName, False, commitId, dependencyDict, "", True, self.arguments.useSSH)

    def changePodspecForPush(self):
        podName = self.arguments.podName
        self.changePodSpec(podName, "", True, "", {}, "", False)
    ...
    def changePodspecForPushRepo(self):
        ...
        if len(LFSURL):
            useTag = False
        self.changePodSpec(podName, "", useTag, "", {}, LFSURL, False)
