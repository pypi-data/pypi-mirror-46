...
# Local imports
from htpio import bridge, telnetio, socketio
...
def parser():
    ...
    setcmd.add_argument('--host', default='192.168.199.31', help="server address")
    setcmd.add_argument('--port', default=23, help="server port")
    setcmd.add_argument('--pin', type=int, help='pin number')
    setcmd.add_argument('--val', type=int, help='signal value')
    setcmd.set_defaults(func=func_set)

    # Get
    getcmd = subparsers.add_parser('get', help='get pin value')
    getcmd.add_argument('--host', default='192.168.199.31', help="server address")
    getcmd.add_argument('--port', default=23, help="server port")
    getcmd.add_argument('--pin', type=int, help='pin number')
    getcmd.set_defaults(func=func_get)

    # Lock
    lockcmd = subparsers.add_parser('lock', help='locks pin')
    lockcmd.add_argument('--host', default='192.168.199.31', help="server address")
    lockcmd.add_argument('--port', default=23, help="server port")
    lockcmd.add_argument('--pin', type=int, help='pin number')
    lockcmd.set_defaults(func=func_lock)

    # Unlock
    unlockcmd = subparsers.add_parser('unlock', help='unlocks pin')
    unlockcmd.add_argument('--host', default='192.168.199.31', help="server address")
    unlockcmd.add_argument('--port', default=23, help="server port")
    unlockcmd.add_argument('--pin', type=int, help='pin number')
    unlockcmd.set_defaults(func=func_unlock)

    # cmd_01 = "-p socket set --host 192.168.199.31 --port 23 --pin 14 --val 1"
    # args = parser.parse_args(cmd_01.split())

    # cmd_02 = "-p socket set --host 192.168.199.31 --port 23 --pin 14 --val 0"
    # args = parser.parse_args(cmd_02.split())

    # cmd_03 = "-p socket lock --host 192.168.199.31 --port 23 --pin 14"
    # args = parser.parse_args(cmd_03.split())

    # cmd_04 = "-p socket unlock --host 192.168.199.31 --port 23 --pin 14"
    # args = parser.parse_args(cmd_04.split())
