...
kwargs = json.loads("""
{
    ...
    "package_data": {
        "aws_cdk.aws_codepipeline_actions._jsii": [
            "aws-codepipeline-actions@0.31.0.jsii.tgz"
        ],
        "aws_cdk.aws_codepipeline_actions": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-codebuild~=0.31.0",
        "aws-cdk.aws-codecommit~=0.31.0",
        "aws-cdk.aws-codedeploy~=0.31.0",
        "aws-cdk.aws-codepipeline~=0.31.0",
