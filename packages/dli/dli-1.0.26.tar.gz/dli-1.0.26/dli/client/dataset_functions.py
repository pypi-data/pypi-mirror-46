...
class DatasetFunctions:
    _KNOWN_FIELDS = set([
        ...
        "taxonomy",
        "loadType",
        "hasAutoRegistryFailureNotifications"
    ])
    @property
    def __root(self):
    ...
    def edit_dataset(
        ...
        **kwargs
        ...
        :param boolean has_auto_registry_failure_notifications: Optional. Controls whether auto-registry sends email notifications on error.
