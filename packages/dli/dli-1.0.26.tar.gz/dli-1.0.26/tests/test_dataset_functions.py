...
class DatasetFunctionsTestCase(SdkIntegrationTestCase):
    ...
    def test_edit_dataset_should_allow_for_editing_auto_reg_failure_notifications_opt_in(self):
        dataset = self.client.register_dataset(
            self.dataset_builder(
                self.package_id,
        ...
        updated_dataset = self.client.edit_dataset(
            dataset.dataset_id,
            has_auto_registry_failure_notifications=False
        )

        assert not updated_dataset.has_auto_registry_failure_notifications
