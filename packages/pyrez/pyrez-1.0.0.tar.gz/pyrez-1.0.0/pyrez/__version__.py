...
__version__ = "1.0.0" #'.'.join(map(str, (1, 0, 0)))
__title__ = "{}-{}".format(__package_name__.capitalize(), __version__)
version = __version__

from collections import namedtuple
version_info = namedtuple("VersionInfo", "major minor micro releaselevel serial")(major=1, minor=0, micro=0, releaselevel="beta", serial=0)
