...
available as
[mlhub_3.4.11.tar.gz](https://mlhub.ai/dist/mlhub_3.4.11.tar.gz) within
the [distribution folder](https://mlhub.ai/dist/) of the MLHub.

To install from the tar.gz file:

    $ wget https://mlhub.ai/dist/mlhub_3.4.11.tar.gz
    $ pip install mlhub_3.4.11.tar.gz
    $ ml

Or extract the above downloaded .tar.gz and install:

    $ wget https://mlhub.ai/dist/mlhub_3.4.11.tar.gz
    $ tar xvf mlhub_3.4.11.tar.gz
    $ cd mlhub
