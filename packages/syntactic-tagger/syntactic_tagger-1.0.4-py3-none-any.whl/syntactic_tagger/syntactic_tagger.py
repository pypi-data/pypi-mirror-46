...
class SyntacticTagger:
    ...
    def load_data(data_type):
        ...
        """
        data_file_path = join(dirname(realpath(__file__)), 'data_files', data_type + '.msgpack.bz2')
    ...
    def choose_tags(self, possible_tags):
        ...
        beforehand that won't have the highest sentence weighthing.
        ...
        post_frag_combs = {}
        # We process the fragments starting fromt the rightmost.
