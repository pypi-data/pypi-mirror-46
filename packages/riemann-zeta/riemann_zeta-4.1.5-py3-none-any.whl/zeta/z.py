...
from zeta.db import addresses, prevouts
...
if __name__ == '__main__':
    ...
    addresses.store_address('tb1qsu7mdkve74yqu4e77z3z2fwj28n3c8tchvqywh')
    addresses.store_address('tb1qzupjhqmthceyj2jc8kglxyrzg2ncq05a0jfeke')
    addresses.store_address('tb1ql7jzqsec9hur4x7kk9l9gxkwpn8djhkcmqw4w4')
    # start tracking
    zeta_task = zeta(
        header_q=header_q,
        prevout_q=prevout_q,
