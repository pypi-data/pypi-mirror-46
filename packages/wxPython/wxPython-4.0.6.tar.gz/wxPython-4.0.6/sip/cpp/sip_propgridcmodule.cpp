...
bool sipVH__propgrid_77(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxPGPropArgCls& id)
{
    bool sipRes = 0;
 ...
 ::wxPropertyGridPage* sipVH__propgrid_76(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int index,const  ::wxString& label,const  ::wxBitmap& bmp, ::wxPropertyGridPage*pageObj)
{
...
void sipVH__propgrid_75(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxPGProperty*p)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "D", p, sipType_wxPGProperty, SIP_NULLPTR);
}

 ::wxColour sipVH__propgrid_74(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int index)
{
     ::wxColour sipRes;
 ...
 ::wxString sipVH__propgrid_73(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxColour& col,int index,int argFlags)
{
     ::wxString sipRes;
...
bool sipVH__propgrid_72(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxString*resString)
{
    bool sipRes = 0;
...
void sipVH__propgrid_71(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, size_t first,size_t second)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "==", first, second);
}

void sipVH__propgrid_70(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int index)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "i", index);
}

bool sipVH__propgrid_69(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, size_t index,const  ::wxString& str)
{
    bool sipRes = 0;
...
bool sipVH__propgrid_68(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxString& str,int index)
{
    bool sipRes = 0;
...
size_t sipVH__propgrid_67(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
    size_t sipRes = 0;
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "");
 ...
 ::wxString sipVH__propgrid_66(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, size_t index)
{
     ::wxString sipRes;
...
void sipVH__propgrid_65(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxPGVariant& value)
{
 ...
 ::wxPGArrayEditorDialog* sipVH__propgrid_64(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
...
bool sipVH__propgrid_63(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxPropertyGrid*propgrid, ::wxWindow*primary,const  ::wxChar*cbt)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "DDx", propgrid, sipType_wxPropertyGrid, SIP_NULLPTR, primary, sipType_wxWindow, SIP_NULLPTR, cbt);
...
bool sipVH__propgrid_62(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindow*parent, ::wxString& value)
{
    bool sipRes = 0;
...
void sipVH__propgrid_61(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxArrayString& arr, ::wxString*pString,const  ::wxUniChar& delimiter)
{
...
bool sipVH__propgrid_60(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxPropertyGrid*propgrid, ::wxString& value)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "DD", propgrid, sipType_wxPropertyGrid, SIP_NULLPTR, &value, sipType_wxString, SIP_NULLPTR);
...
int sipVH__propgrid_59(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int value)
{
    int sipRes = 0;
 ...
 ::wxObject* sipVH__propgrid_58(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxObject* sipRes = 0;
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "");
...
bool sipVH__propgrid_57(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindow*parent)
{
    bool sipRes = 0;
 ...
 ::wxEventCategory sipVH__propgrid_56(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
 ...
 ::wxEvent* sipVH__propgrid_55(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxEvent* sipRes = 0;
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "");
...
static sipEnumTypeDef enumTypes[] = {
    ...
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxNumericPropertyValidator__NumericType, {0}, 0}, sipNameNr_NumericType, 19, SIP_NULLPTR},
    ...
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxPropertyGridInterface__EditableStateFlags, {0}, 0}, sipNameNr_EditableStateFlags, 65, SIP_NULLPTR},
