...
static PyObject *meth_wxGCDC_SetGraphicsContext(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "BJ:", &sipSelf, sipType_wxGCDC, &sipCpp, sipType_wxGraphicsContext, &ctx))
        {
            PyErr_Clear();
...
static sipEncodedTypeDef supers_wxGCDC[] = {{93, 255, 1}};
