...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "NF", new  ::wxString(name), sipType_wxString, SIP_NULLPTR, type, sipType_wxAnimationType);
...
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "DF", &stream, sipType_wxInputStream, SIP_NULLPTR, type, sipType_wxAnimationType);
...
{
     ::wxImage sipRes;
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "u", i);
...
{
     ::wxString sipRes;
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "N", new  ::wxString(tip), sipType_wxString, SIP_NULLPTR);
