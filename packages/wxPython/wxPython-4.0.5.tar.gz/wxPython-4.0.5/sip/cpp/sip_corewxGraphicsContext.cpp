...
static PyObject *meth_wxGraphicsContext_CreateLinearGradientBrush(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "BddddJ1J1", &sipSelf, sipType_wxGraphicsContext, &sipCpp, &x1, &y1, &x2, &y2, sipType_wxColour, &c1, &c1State, sipType_wxColour, &c2, &c2State))
        {
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "BddddJ9", &sipSelf, sipType_wxGraphicsContext, &sipCpp, &x1, &y1, &x2, &y2, sipType_wxGraphicsGradientStops, &stops))
        {
             ::wxGraphicsBrush*sipRes;
...
static PyObject *meth_wxGraphicsContext_CreateRadialGradientBrush(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "BdddddJ1J1", &sipSelf, sipType_wxGraphicsContext, &sipCpp, &xo, &yo, &xc, &yc, &radius, sipType_wxColour, &oColor, &oColorState, sipType_wxColour, &cColor, &cColorState))
        {
             ::wxGraphicsBrush*sipRes;
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "BdddddJ9", &sipSelf, sipType_wxGraphicsContext, &sipCpp, &xo, &yo, &xc, &yc, &radius, sipType_wxGraphicsGradientStops, &stops))
        {
             ::wxGraphicsBrush*sipRes;
...
static sipEncodedTypeDef supers_wxGraphicsContext[] = {{220, 255, 1}};
...
sipVariableDef variables_wxGraphicsContext[] = {
    {PropertyVariable, sipName_Transform, &methods_wxGraphicsContext[40], &methods_wxGraphicsContext[53], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_TextExtent, &methods_wxGraphicsContext[39], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_NativeContext, &methods_wxGraphicsContext[36], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_InterpolationQuality, &methods_wxGraphicsContext[35], &methods_wxGraphicsContext[51], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CompositionMode, &methods_wxGraphicsContext[32], &methods_wxGraphicsContext[49], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_AntialiasMode, &methods_wxGraphicsContext[31], &methods_wxGraphicsContext[47], SIP_NULLPTR, SIP_NULLPTR},
};
