...
static void *init_type_wxFSFile(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, sipKwdList, sipUnused, "@J0J1J1J1J1", &streamWrapper, sipType_wxInputStream, &stream, &streamState, sipType_wxString,&location, &locationState, sipType_wxString,&mimetype, &mimetypeState, sipType_wxString,&anchor, &anchorState, sipType_wxDateTime, &modif, &modifState))
        {
            PyErr_Clear();
            ...
            sipTransferTo(streamWrapper, (PyObject *)sipSelf);
