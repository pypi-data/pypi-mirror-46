...
void sipwxAppConsole::ExitMainLoop()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[6],sipPySelf,SIP_NULLPTR,sipName_ExitMainLoop);
...
int sipwxAppConsole::MainLoop()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[7],sipPySelf,SIP_NULLPTR,sipName_MainLoop);
...
int sipwxAppConsole::FilterEvent( ::wxEvent& event)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[8],sipPySelf,SIP_NULLPTR,sipName_FilterEvent);
...
bool sipwxAppConsole::ProcessEvent( ::wxEvent& event)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[9],sipPySelf,SIP_NULLPTR,sipName_ProcessEvent);
...
bool sipwxAppConsole::TryAfter( ::wxEvent& event)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[11],sipPySelf,SIP_NULLPTR,sipName_TryAfter);
...
static sipEncodedTypeDef supers_wxAppConsole[] = {{147, 255, 0}, {143, 255, 1}};
