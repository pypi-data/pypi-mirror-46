...
class HostDeveloper(object):
	...
	System Costs = SystemCosts
	Tax Credit Incentives = TaxCreditIncentives
	Payment Incentives = PaymentIncentives
	Host = Host
	Common = Common
	...
	Time of Delivery = TimeOfDelivery
	Reserve Accounts = ReserveAccounts
	Depreciation = Depreciation
	Salvage Value = SalvageValue
	Solution Mode = SolutionMode
	PPA Price = PPAPrice
	Construction Financing = ConstructionFinancing
	Project Term Debt = ProjectTermDebt
	Other Capital Costs = OtherCapitalCosts
	IRR Targets = IRRTargets
	Cash Incentives = CashIncentives
	Battery = Battery
	Outputs = Outputs
