...
def accuracy_per_tag(model, x, y):
    ...
    # New, better accuracy metric:
    # This is independent of how we change our dom() calls.
    # Accuracy: # tags right ÷ # tags in corpus
    # False positives: # tags falsely positive ÷ # tags in corpus
    # False negatives: # tags falsely negative ÷ # tags in corpus
