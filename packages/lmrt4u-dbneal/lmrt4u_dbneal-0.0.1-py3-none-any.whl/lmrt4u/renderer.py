...
def renderAscii(totalPoints, completedPointArr, totalDays):
    ...
    fig = apl.figure()
    fig.plot(x, expectedLinear, label='Points', xlabel= "Time", title="Expected")
    fig.plot(x, actualLinear, label='Points', xlim=(0, totalDays), ylim=(0, totalPoints), xlabel= "Time", title="Actual")
    fig.show()
