...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-codedeploy", "0.31.0", __name__, "aws-codedeploy@0.31.0.jsii.tgz")
...
class ILambdaDeploymentGroup(aws_cdk.cdk.IResource, jsii.compat.Protocol):
    ...
    @jsii.member(jsii_name="export")
    def export(self) -> "LambdaDeploymentGroupAttributes":
...
class IServerDeploymentConfig(jsii.compat.Protocol):
    ...
    @jsii.member(jsii_name="export")
    def export(self) -> "ServerDeploymentConfigAttributes":
        ...
...
class IServerDeploymentGroup(aws_cdk.cdk.IResource, jsii.compat.Protocol):
    ...
    @jsii.member(jsii_name="export")
    def export(self) -> "ServerDeploymentGroupAttributes":
        ...
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codedeploy.ServerDeploymentConfigAttributes", jsii_struct_bases=[])
class ServerDeploymentConfigAttributes(jsii.compat.TypedDict):
