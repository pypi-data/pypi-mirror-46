...
class Binomial(Distribution):
    ...
    def calculate_stdev(self):
        ...
        """
        return math.sqrt( self.n * self.p * (1.0 - self.p))
    ...
    def replace_stats_with_data(self):
        ...
        """
        #super().read_data_file(file_name="./numbers_binomial.txt")
        self.n = len(self.data)
        #self.p = len([ones for ones in self.data if ones == '1'])/(self.n)
    ...
    def plot_bar(self):
        ...
        Returns:
            None
        """
        #plt.bar(arange(self.data), self.data)
        plt.bar(x=['0', '1'], height=[(1.0 - self.p)* self.n, self.p * self.n])
        plt.xlabel('outcome')
        plt.ylabel('count')
        plt.title("Bar Chart of the Data Set")
    ...
    def pdf(self, k):
        ...
        c2 = math.pow(p, k) * math.pow((1.0 - p), (n - k))
        return c1 * c2
    ...
    def plot_bar_pdf(self):
        ...
        for k in range(self.n + 1):
            x_range.append(k)
            pdf_vals.append(self.pdf(k))
            
        plt.bar(x_range, pdf_vals)
        plt.xlabel('Data outcomes')
        plt.ylabel('pdf')
    ...
    def __add__(self, other):    
        ...
        new_binomial = Binomial(self.p, new_n)
