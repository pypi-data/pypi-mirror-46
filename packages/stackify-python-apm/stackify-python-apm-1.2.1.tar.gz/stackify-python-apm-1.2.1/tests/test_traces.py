...
class TracerTest(TestCase):
    ...
    def test_trace_creation(self):
        tracer = Tracer(self.client.queue_listener.enqueue, sample_rate=1.0, ignore_patterns=None)
        assert tracer
...
class CaptureSpanTest(TestCase):
    def setUp(self):
        self.client = Client(CONFIG)
        self.tracer = Tracer(self.client.queue_listener.enqueue, sample_rate=1.0, ignore_patterns=None)
