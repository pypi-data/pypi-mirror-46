...
class Jira(AtlassianRestAPI):
    def server_info(self, do_health_check=False):
        """
        Returns general information about the current JIRA server.
        :param do_health_check:
        :return:
        """
        params = {'doHealthCheck': False}
        if do_health_check:
            params['doHealthCheck'] = do_health_check
        return self.get('rest/api/2/serverInfo', params=params)
