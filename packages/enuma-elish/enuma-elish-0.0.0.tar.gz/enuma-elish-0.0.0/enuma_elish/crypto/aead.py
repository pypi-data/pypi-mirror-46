...
from enuma_elish.crypto import util
from enuma_elish.crypto import hkdf
from enuma_elish.common import ord, chr
...
class AeadCryptoBase(object):
    """
    Handles basic aead process of enuma_elish protocol
