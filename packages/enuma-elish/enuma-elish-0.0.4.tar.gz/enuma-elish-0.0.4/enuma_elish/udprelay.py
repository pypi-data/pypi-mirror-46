...
# enuma_elish UDP Request (before encrypted)
# +------+----------+----------+----------+
...
# enuma_elish UDP Response (before encrypted)
# +------+----------+----------+----------+
# | ATYP | DST.ADDR | DST.PORT |   DATA   |
# +------+----------+----------+----------+
# |  1   | Variable |    2     | Variable |
...
# enuma_elish UDP Request and Response (after encrypted)
# +-------+--------------+
# |   IV  |    PAYLOAD   |
# +-------+--------------+
# | Fixed |   Variable   |
...
#           request
# `local`   means local server of enuma_elish
# `remote`  means remote server of enuma_elish
...
from enuma_elish import cryptor, eventloop, lru_cache, common, shell
from enuma_elish.common import parse_header, pack_addr, onetimeauth_verify, \
