...
def get_directory_tree(directory, category=None):
    logger.debug("Reading directory %s, category: %s", directory, category)
    ...
    for child in os.listdir(directory):
        ...
        if category is not None and child.replace('.json', '') != category:
            continue
