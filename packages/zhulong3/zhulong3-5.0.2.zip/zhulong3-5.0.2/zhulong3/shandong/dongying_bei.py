...
def f1(driver, num):
    ...
    req=requests.post(url1,headers=headers,data=form_data,timeout=10)
...
data = [
    ...
    ##包含招标,变更
    ["gcjs_zhao_gg", "http://103.239.153.139:88/dyztb/ZTB?flag=-1",["name", "ggstart_time", "href", "info"], f1, f2],
    ##包含中标,流标
    ["gcjs_zhong_gg", "http://103.239.153.139:88/dyztb/ZTB?flag=2",["name", "ggstart_time", "href", "info"], f1, f2],
