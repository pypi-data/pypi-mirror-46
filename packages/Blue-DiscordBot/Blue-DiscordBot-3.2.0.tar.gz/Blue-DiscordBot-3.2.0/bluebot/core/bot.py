...
class BlueBase(commands.GroupMixin, commands.bot.BotBase, RPCMixin):
    """Mixin for the main bot class.

    This exists because `Blue` inherits from `discord.AutoShardedClient`, which
        ...
        for command in cog.__cog_commands__:
            ...
            if not isinstance(command, commands.Command):
                raise RuntimeError(
                    ...
                    " is not using Blue's command module, and cannot be added. "
                    "If this is your cog, please use `from bluebot.core import commands`"
...
class Blue(BlueBase, discord.AutoShardedClient):
    """
