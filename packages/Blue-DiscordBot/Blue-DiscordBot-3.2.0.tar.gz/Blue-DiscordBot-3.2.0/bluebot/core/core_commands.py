...
class Core(commands.Cog, CoreLogic):
    ...
    async def info(self, ctx: commands.Context):
        ...
        about = _(
            "This is an instance of [Blue, an open source Discord bot]({}) "
    ...
    async def owner(self, ctx: commands.Context):
        ...
        owner_disclaimer = _(
            "⚠ **Only** the person who is hosting Blue should be "
    ...
    async def locale(self, ctx: commands.Context, locale_name: str):
        ...
        red_path = Path(red_dist.location) / "bluebot"
    ...
    async def backup(self, ctx: commands.Context, *, backup_path: str = None):
        ...
        from bluebot.core.data_manager import basic_config, instance_name
