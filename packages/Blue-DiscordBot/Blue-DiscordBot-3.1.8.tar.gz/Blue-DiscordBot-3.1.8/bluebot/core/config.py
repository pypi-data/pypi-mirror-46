...
log = logging.getLogger("blue.config")
...
class Value:
    ...
    driver : `bluebot.core.drivers.red_base.BaseDriver`
...
class Config:
    ...
    unique_identifier : `int`
        ...
        conflicts occur.
    driver
        An instance of a driver that implements `bluebot.core.drivers.red_base.BaseDriver`.
    force_registration : `bool`
