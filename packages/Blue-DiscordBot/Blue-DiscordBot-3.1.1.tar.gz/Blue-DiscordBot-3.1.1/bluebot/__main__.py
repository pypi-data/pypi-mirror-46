...
from bluebot.core.bot import Red, ExitCodes
from bluebot.core.cog_manager import CogManagerUI
from bluebot.core.json_io import JsonIO
from bluebot.core.global_checks import init_global_checks
from bluebot.core.events import init_events
from bluebot.core.cli import interactive_config, confirm, parse_cli_flags
from bluebot.core.core_commands import Core
from bluebot.core.dev_commands import Dev
from bluebot.core import __version__, modlog, bank, data_manager
...
#               Blue - Discord Bot v3
#
#         Made by AdityaNugraha, improved by many
#
...
def main():
    ...
    token = os.environ.get("BLUE_TOKEN", tmp_data["token"])
    if cli_flags.token:
