...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-sns", "0.31.0", __name__, "aws-sns@0.31.0.jsii.tgz")
...
class ITopic(aws_cdk.cdk.IResource, aws_cdk.aws_cloudwatch.IAlarmAction, aws_cdk.aws_s3_notifications.IBucketNotificationDestination, aws_cdk.aws_autoscaling_api.ILifecycleHookTarget, jsii.compat.Protocol):
    ...
    def export(self) -> "TopicAttributes":
        """Export this Topic."""
        ...
...
@jsii.data_type(jsii_type="@aws-cdk/aws-sns.TopicAttributes", jsii_struct_bases=[])
class TopicAttributes(jsii.compat.TypedDict):
...
class Topic(TopicBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sns.Topic"):
    ...
    @classmethod
    def from_topic_attributes(cls, scope: aws_cdk.cdk.Construct, id: str, *, topic_arn: str, topic_name: str) -> "ITopic":
        ...
        Arguments:
            ...
            topicName: -
        """
        attrs: TopicAttributes = {"topicArn": topic_arn, "topicName": topic_name}

        return jsii.sinvoke(cls, "fromTopicAttributes", [scope, id, attrs])
...
__all__ = ["CfnSubscription", "CfnSubscriptionProps", "CfnTopic", "CfnTopicPolicy", "CfnTopicPolicyProps", "CfnTopicProps", "EmailSubscriptionOptions", "ITopic", "Subscription", "SubscriptionProps", "SubscriptionProtocol", "Topic", "TopicAttributes", "TopicBase", "TopicPolicy", "TopicPolicyProps", "TopicProps", "__jsii_assembly__"]
