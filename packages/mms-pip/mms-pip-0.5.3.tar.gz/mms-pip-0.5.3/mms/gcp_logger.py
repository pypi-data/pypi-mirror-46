class Logger(object):
    ...
    def __init__(self, run_id, project_id, local_run=False, module_id=None, version_id=None, function_name=None, cluster_name=None, namespace_name=None, container_name=None, location=None, resource_type='global'):
