...
class GalleryClient(Client):
    ...
    def get_acquisition_options(self, item_id, installation_target, test_commerce=None, is_free_or_trial_install=None):
        ...
        :rtype: :class:`<AcquisitionOptions> <azure.devops.v5_0.gallery.models.AcquisitionOptions>`
        """
        route_values = {}
    ...
    def request_acquisition(self, acquisition_request):
        """RequestAcquisition.
        [Preview API]
        :param :class:`<ExtensionAcquisitionRequest> <azure.devops.v5_0.gallery.models.ExtensionAcquisitionRequest>` acquisition_request:
        :rtype: :class:`<ExtensionAcquisitionRequest> <azure.devops.v5_0.gallery.models.ExtensionAcquisitionRequest>`
        """
    ...
    def associate_azure_publisher(self, publisher_name, azure_publisher_id):
        ...
        :rtype: :class:`<AzurePublisher> <azure.devops.v5_0.gallery.models.AzurePublisher>`
        """
        route_values = {}
        if publisher_name is not None:
            route_values['publisherName'] = self._serialize.url('publisher_name', publisher_name, 'str')
    ...
    def get_category_details(self, category_name, languages=None, product=None):
        ...
        :param str languages:
        :param str product:
        :rtype: :class:`<CategoriesResult> <azure.devops.v5_0.gallery.models.CategoriesResult>`
        """
        route_values = {}
    ...
    def get_category_tree(self, product, category_id, lcid=None, source=None, product_version=None, skus=None, sub_skus=None):
        ...
        :param str skus:
        :param str sub_skus:
        :rtype: :class:`<ProductCategory> <azure.devops.v5_0.gallery.models.ProductCategory>`
        """
        route_values = {}
        if product is not None:
    ...
    def get_root_categories(self, product, lcid=None, source=None, product_version=None, skus=None, sub_skus=None):
        ...
        :param str skus:
        :param str sub_skus:
        :rtype: :class:`<ProductCategoriesResult> <azure.devops.v5_0.gallery.models.ProductCategoriesResult>`
        """
        route_values = {}
        if product is not None:
            route_values['product'] = self._serialize.url('product', product, 'str')
    ...
    def perform_edit_extension_draft_operation(self, draft_patch, publisher_name, extension_name, draft_id):
        ...
        [Preview API]
        :param :class:`<ExtensionDraftPatch> <azure.devops.v5_0.gallery.models.ExtensionDraftPatch>` draft_patch:
        :param str publisher_name:
        :param str extension_name:
        :param str draft_id:
        :rtype: :class:`<ExtensionDraft> <azure.devops.v5_0.gallery.models.ExtensionDraft>`
    ...
    def add_asset_for_edit_extension_draft(self, upload_stream, publisher_name, extension_name, draft_id, asset_type, **kwargs):
        ...
        :param str draft_id:
        :param str asset_type:
        :rtype: :class:`<ExtensionDraftAsset> <azure.devops.v5_0.gallery.models.ExtensionDraftAsset>`
        """
        route_values = {}
        if publisher_name is not None:
            route_values['publisherName'] = self._serialize.url('publisher_name', publisher_name, 'str')
    ...
    def get_extension_events(self, publisher_name, extension_name, count=None, after_date=None, include=None, include_property=None):
        ...
        :rtype: :class:`<ExtensionEvents> <azure.devops.v5_0.gallery.models.ExtensionEvents>`
        """
        route_values = {}
        if publisher_name is not None:
            route_values['publisherName'] = self._serialize.url('publisher_name', publisher_name, 'str')
    ...
    def query_extensions(self, extension_query, account_token=None, account_token_header=None):
        """QueryExtensions.
        [Preview API]
        :param :class:`<ExtensionQuery> <azure.devops.v5_0.gallery.models.ExtensionQuery>` extension_query:
        :param str account_token:
        :param String account_token_header: Header to pass the account token
        :rtype: :class:`<ExtensionQueryResult> <azure.devops.v5_0.gallery.models.ExtensionQueryResult>`
        """
        query_parameters = {}
        if account_token is not None:
            query_parameters['accountToken'] = self._serialize.query('account_token', account_token, 'str')
    ...
    def create_extension(self, upload_stream, **kwargs):
        ...
        [Preview API]
        :param object upload_stream: Stream to upload
        :rtype: :class:`<PublishedExtension> <azure.devops.v5_0.gallery.models.PublishedExtension>`
        """
        if "callback" in kwargs:
            callback = kwargs["callback"]
        else:
    ...
    def send_notifications(self, notification_data):
        ...
        :param :class:`<NotificationsData> <azure.devops.v5_0.gallery.models.NotificationsData>` notification_data: Denoting the data needed to send notification
        """
    ...
    def create_publisher(self, publisher):
        """CreatePublisher.
        [Preview API]
        :param :class:`<Publisher> <azure.devops.v5_0.gallery.models.Publisher>` publisher:
    ...
    def get_questions(self, publisher_name, extension_name, count=None, page=None, after_date=None):
        ...
        :rtype: :class:`<QuestionsResult> <azure.devops.v5_0.gallery.models.QuestionsResult>`
        """
        route_values = {}
        if publisher_name is not None:
            route_values['publisherName'] = self._serialize.url('publisher_name', publisher_name, 'str')
    ...
    def report_question(self, concern, pub_name, ext_name, question_id):
        ...
        :param :class:`<Concern> <azure.devops.v5_0.gallery.models.Concern>` concern: User reported concern with a question for the extension.
        ...
        :rtype: :class:`<Concern> <azure.devops.v5_0.gallery.models.Concern>`
        """
        route_values = {}
    ...
    def create_question(self, question, publisher_name, extension_name):
        ...
        :param :class:`<Question> <azure.devops.v5_0.gallery.models.Question>` question: Question to be created for the extension.
        :param str publisher_name: Name of the publisher who published the extension.
        :param str extension_name: Name of the extension.
        :rtype: :class:`<Question> <azure.devops.v5_0.gallery.models.Question>`
        """
        route_values = {}
        if publisher_name is not None:
            route_values['publisherName'] = self._serialize.url('publisher_name', publisher_name, 'str')
    ...
    def update_question(self, question, publisher_name, extension_name, question_id):
        ...
        :param :class:`<Question> <azure.devops.v5_0.gallery.models.Question>` question: Updated question to be set for the extension.
        :param str publisher_name: Name of the publisher who published the extension.
        :param str extension_name: Name of the extension.
        :param long question_id: Identifier of the question to be updated for the extension.
        :rtype: :class:`<Question> <azure.devops.v5_0.gallery.models.Question>`
    ...
    def create_response(self, response, publisher_name, extension_name, question_id):
        ...
        :param :class:`<Response> <azure.devops.v5_0.gallery.models.Response>` response: Response to be created for the extension.
        :param str publisher_name: Name of the publisher who published the extension.
        :param str extension_name: Name of the extension.
        :param long question_id: Identifier of the question for which response is to be created for the extension.
        :rtype: :class:`<Response> <azure.devops.v5_0.gallery.models.Response>`
        """
        route_values = {}
        if publisher_name is not None:
            route_values['publisherName'] = self._serialize.url('publisher_name', publisher_name, 'str')
    ...
    def update_response(self, response, publisher_name, extension_name, question_id, response_id):
        ...
        :param :class:`<Response> <azure.devops.v5_0.gallery.models.Response>` response: Updated response to be set for the extension.
        :param str publisher_name: Name of the publisher who published the extension.
        :param str extension_name: Name of the extension.
    ...
    def get_reviews(self, publisher_name, extension_name, count=None, filter_options=None, before_date=None, after_date=None):
        ...
        :rtype: :class:`<ReviewsResult> <azure.devops.v5_0.gallery.models.ReviewsResult>`
        """
        route_values = {}
        if publisher_name is not None:
            route_values['publisherName'] = self._serialize.url('publisher_name', publisher_name, 'str')
    ...
    def update_review(self, review_patch, pub_name, ext_name, review_id):
        ...
        :param :class:`<ReviewPatch> <azure.devops.v5_0.gallery.models.ReviewPatch>` review_patch: ReviewPatch object which contains the changes to be applied to the review
        :param str pub_name: Name of the pubilsher who published the extension
        :param str ext_name: Name of the extension
        :param long review_id: Id of the review which needs to be updated
        :rtype: :class:`<ReviewPatch> <azure.devops.v5_0.gallery.models.ReviewPatch>`
        """
        route_values = {}
        if pub_name is not None:
            route_values['pubName'] = self._serialize.url('pub_name', pub_name, 'str')
    ...
    def create_category(self, category):
        """CreateCategory.
        [Preview API]
        :param :class:`<ExtensionCategory> <azure.devops.v5_0.gallery.models.ExtensionCategory>` category:
        :rtype: :class:`<ExtensionCategory> <azure.devops.v5_0.gallery.models.ExtensionCategory>`
        """
    ...
    def get_extension_daily_stats(self, publisher_name, extension_name, days=None, aggregate=None, after_date=None):
        ...
        :rtype: :class:`<ExtensionDailyStats> <azure.devops.v5_0.gallery.models.ExtensionDailyStats>`
        """
        route_values = {}
        if publisher_name is not None:
            route_values['publisherName'] = self._serialize.url('publisher_name', publisher_name, 'str')
