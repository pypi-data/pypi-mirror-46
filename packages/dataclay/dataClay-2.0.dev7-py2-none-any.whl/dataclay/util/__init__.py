...
class Configuration(object):
    ...
    def read_from_file(cls):
        ...
        try:
            ...
            if hasattr(flags, 'MAX_RETRIES_LOGICMODULE'):
                logger.info("Found global.properties variable MAX_RETRIES_LOGICMODULE=%s" % flags.MAX_RETRIES_LOGICMODULE)
                cls.MAX_RETRIES_LOGICMODULE = int(flags.MAX_RETRIES_LOGICMODULE)
            if hasattr(flags, 'SLEEP_RETRIES_LOGICMODULE'):
                logger.info("Found global.properties variable SLEEP_RETRIES_LOGICMODULE=%s" % flags.SLEEP_RETRIES_LOGICMODULE)
                cls.SLEEP_RETRIES_LOGICMODULE = int(flags.SLEEP_RETRIES_LOGICMODULE)
        except:
