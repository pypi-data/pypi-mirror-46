...
class RunWatcher(object):
    ...
    def get_tb_artifacts(self, client):
        container_artifacts = client.get_artifact_by_container(RUN_ORIGIN, self._run_object._data_container_id)
    ...
    def refresh_log_artifacts(self):
        for artifact in self.get_tb_artifacts(self._client):
            ...
            uri = self._client.get_file_uri(RUN_ORIGIN, self._run_object._data_container_id, remote_path)
