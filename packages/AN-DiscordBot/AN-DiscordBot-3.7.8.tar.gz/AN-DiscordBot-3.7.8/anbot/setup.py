...
import anbot.logging
from anbot.core.cli import confirm
from anbot.core.data_manager import (
...
from anbot.core.utils import safe_delete
from anbot.core import Config
from anbot.core.drivers import BackendType, IdentifierData
from anbot.core.drivers.red_json import JSON

conversion_log = logging.getLogger("an.converter")
...
def basic_setup():
    ...
    if storage_type == BackendType.MONGO:
        from anbot.core.drivers.red_mongo import get_config_details
...
async def json_to_mongov2(instance):
    ...
    from anbot.core.drivers import red_mongo
...
async def mongov2_to_json(instance):
    ...
    from anbot.core.drivers import red_json
...
async def create_backup(instance):
    ...
    if confirm("Would you like to make a backup of the data for this instance? (y/n)"):
        ...
        if pth.exists():
            ...
            from anbot.cogs.downloader.repo_manager import RepoManager
...
def cli(ctx, debug):
    ...
    anbot.logging.init_logging(level=level, location=Path.cwd() / "red_setup_logs")
