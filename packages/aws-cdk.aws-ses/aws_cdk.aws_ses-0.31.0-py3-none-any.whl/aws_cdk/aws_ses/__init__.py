...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-ses", "0.31.0", __name__, "aws-ses@0.31.0.jsii.tgz")
...
class IReceiptRule(aws_cdk.cdk.IResource, jsii.compat.Protocol):
    ...
    def export(self) -> "ReceiptRuleAttributes":
...
class IReceiptRuleSet(aws_cdk.cdk.IResource, jsii.compat.Protocol):
    ...
    @jsii.member(jsii_name="export")
    def export(self) -> "ReceiptRuleSetAttributes":
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ses.ReceiptRuleAttributes", jsii_struct_bases=[])
class ReceiptRuleAttributes(jsii.compat.TypedDict):
    receiptRuleName: str
    """The name of the receipt rule."""
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ses.ReceiptRuleSetAttributes", jsii_struct_bases=[])
class ReceiptRuleSetAttributes(jsii.compat.TypedDict):
...
__all__ = ["CfnConfigurationSet", "CfnConfigurationSetEventDestination", "CfnConfigurationSetEventDestinationProps", "CfnConfigurationSetProps", "CfnReceiptFilter", "CfnReceiptFilterProps", "CfnReceiptRule", "CfnReceiptRuleProps", "CfnReceiptRuleSet", "CfnReceiptRuleSetProps", "CfnTemplate", "CfnTemplateProps", "DropSpamReceiptRule", "DropSpamReceiptRuleProps", "EmailEncoding", "IReceiptRule", "IReceiptRuleAction", "IReceiptRuleSet", "LambdaInvocationType", "ReceiptFilter", "ReceiptFilterPolicy", "ReceiptFilterProps", "ReceiptRule", "ReceiptRuleActionProps", "ReceiptRuleAddHeaderAction", "ReceiptRuleAddHeaderActionProps", "ReceiptRuleAttributes", "ReceiptRuleBounceAction", "ReceiptRuleBounceActionProps", "ReceiptRuleBounceActionTemplate", "ReceiptRuleBounceActionTemplateProps", "ReceiptRuleLambdaAction", "ReceiptRuleLambdaActionProps", "ReceiptRuleOptions", "ReceiptRuleProps", "ReceiptRuleS3Action", "ReceiptRuleS3ActionProps", "ReceiptRuleSet", "ReceiptRuleSetAttributes", "ReceiptRuleSetProps", "ReceiptRuleSnsAction", "ReceiptRuleSnsActionProps", "ReceiptRuleStopAction", "ReceiptRuleStopActionProps", "TlsPolicy", "WhiteListReceiptFilter", "WhiteListReceiptFilterProps", "__jsii_assembly__"]
