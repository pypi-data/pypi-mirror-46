...
class DefaultApi(object):
    ...
    def svgconvert_post(self, **kwargs):  # noqa: E501
        """converts pptx file to svg image  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.svgconvert_post(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.svgconvert_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.svgconvert_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def svgconvert_post_with_http_info(self, **kwargs):  # noqa: E501
        """converts pptx file to svg image  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.svgconvert_post_with_http_info(async_req=True)
        >>> result = thread.get()
