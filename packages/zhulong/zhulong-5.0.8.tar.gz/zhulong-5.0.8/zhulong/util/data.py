zhulong_diqu_dict = {
    ...
    "fujian": ["fujian", "fuqing", "fuzhou", "jianou", "longyan",
               ...
               "zhangzhou"],
    "guangdong": ["heyuan", "huizhou", "jiangmen", "jieyang", "meizhou",
                  "yunfu", "zhanjiang", "zhaoqing", "zhongshan", "zhuhai",
                  "lianzhou", "nanxiong", 'shaoguan', "sihui", "yingde"
        , "guangzhou"
    ...
    "hunan": ["changde", "chenzhou", "hengyang", "huaihua", "loudi"
        , "shaoyang", "xiangtan", "yiyang", "yongzhou", "yueyang"
        , "zhangjiajie", "zhuzhou", 'liling', 'liuyang', 'yuanjiang'
        , "changsha"
              ],
    ...
    "jilin": ['baicheng', 'baishan', 'changchun', 'jilin', 'jilinshi',
    ...
    "neimenggu": [
        ...
        "wulanchabu", "xilinguolemeng", "neimenggu",
    ],
    ...
    "shandong": ["anqiu", "binzhou", "dongying", "feicheng", "jiaozhou",
        ...
        , "heze", "jining", "leling", "qufu", "zoucheng"
        , "liaocheng"
    ...
    "sichuan": ["bazhong", "chengdu", "chongzhou", "dazhou", "deyang",
                ...
                "mianyang1", "mianyang2", "nanchong", "neijiang", "panzhihua",
                "pengzhou", "qionglai", "shifang", "sichuan", "suining",
                "wanyuan", "yaan", "yibin", "sichuan",
                ],
    "xizang": ['xizang', 'lasa', 'rikaze'],

    "yunnan": ['baoshan', 'chuxiong', 'dali', 'lijiang', 'lincang', 'puer', 'tengchong', 'wenshan', 'yunnan', 'yuxi',
               'zhaotong', 'kunming'],
