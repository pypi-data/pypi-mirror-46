...
def get_df():
    data1 = {'shandong': ['anqiu', 'binzhou', 'dezhou', 'dongying', 'feicheng', 'heze', 'jiaozhou', 'jinan', 'jining',
                          'laiwu', 'leling', 'liaocheng', 'linqing', 'linyi', 'pingdu', 'qingdao', 'qufu', 'rizhao',
                          'rongcheng', 'rushan', 'shandong', 'taian', 'tengzhou', 'weifang', 'weihai', 'xintai',
                          'yantai', 'yucheng', 'zaozhuang', 'zibo', 'zoucheng'],
             ...
             'jilin': ['baicheng', 'baishan', 'changchun', 'jilin', 'jilinshi', 'liaoyuan', 'siping', 'songyuan',
                       'tonghua'],
             'guangdong': ['guangzhou', 'heyuan', 'huizhou', 'jiangmen', 'jieyang', 'lianzhou', 'meizhou', 'nanxiong',
                           'shaoguan', 'shenzhen', 'sihui', 'yingde', 'yunfu', 'zhanjiang', 'zhaoqing', 'zhongshan',
                           'zhuhai'],
             'neimenggu': ['baotou', 'bayannaoer', 'chifeng', 'eeduosi', 'huhehaote', 'hulunbeier', 'manzhouli',
                           'neimenggu', 'tongliao', 'wuhai', 'wulanchabu', 'xilinguolemeng', 'xinganmeng'],
             'fujian': ['fujian', 'fuqing', 'fuzhou', 'jianou', 'longyan', 'nanan', 'nanping', 'ningde', 'putian',
                        'quanzhou', 'sanming', 'shaowu', 'wuyishan', 'xiamen', 'yongan', 'zhangzhou'],
             'qinghai': ['qinghai', 'xining'], 'chongqing': ['yongchuan'],
             'shanxi': ['chenzhou', 'shanxi', 'weinan', 'xian', 'xianyang', 'yanan'],
             'xinjiang': ['beitun', 'kezhou', 'wulumuqi', 'xinjiang'], 'ningxia': ['guyuan', 'ningxia', 'yinchuan'],
             'jiangxi': ['dexing', 'fengcheng', 'fuzhou', 'ganzhou', 'gaoan', 'jian', 'jiangxi', 'jingdezhen',
                         'jinggangshan', 'lushan', 'nanchang', 'ruichang', 'ruijin', 'shangrao', 'xinyu', 'yichun',
                         'yingtan', 'zhangshu'],
             'henan': ['anyang', 'dengfeng', 'gongyi', 'hebi', 'jiaozhuo', 'jiyuan', 'jiyuan1', 'kaifeng', 'linzhou',
                       'luohe', 'luoyang', 'mengzhou', 'nanyang', 'pingdingshan', 'puyang', 'qinyang', 'ruzhou',
                       'sanmenxia', 'shangqiu', 'weihui', 'wugang', 'xinmi', 'xinxiang', 'xinyang', 'xinzheng',
                       'xuchang', 'yanshi', 'yongcheng', 'zhengzhou', 'zhoukou', 'zhumadian'], 'shanxi1': ['shanxi'],
             ...
             'sichuan': ['bazhong', 'chengdu', 'chongzhou', 'dazhou', 'deyang', 'dujiangyan', 'guangan', 'guanghan',
                         ...
                         'mianyang1', 'mianyang2', 'nanchong', 'neijiang', 'panzhihua', 'pengzhou', 'qionglai',
                         'shifang', 'sichuan', 'sichuan2', 'suining', 'wanyuan', 'yaan', 'yibin'],
             'guangxi': ['baise', 'beihai', 'chongzuo', 'fangchenggang', 'guangxi', 'guigang', 'guilin', 'hechi',
                         'hezhou', 'laibin', 'liuzhou', 'nanning', 'qinzhou', 'wuzhou'],
             'hunan': ['changde', 'changsha', 'chenzhou', 'hengyang', 'huaihua', 'liling', 'liuyang', 'loudi',
                       'shaoyang', 'xiangtan', 'yiyang', 'yongzhou', 'yuanjiang', 'yueyang', 'zhangjiajie', 'zhuzhou'],
             'zhejiang': ['cixi', 'dongyang', 'hangzhou', 'huzhou', 'jiaxing', 'jinhua', 'linhai', 'lishui', 'longquan',
                          'ningbo', 'pinghu', 'quzhou', 'ruian', 'shaoxing', 'shengzhou', 'taizhou', 'tongxiang',
                          'wenling', 'wenzhou', 'yiwu', 'yueqing', 'yuhuan', 'zhejiang', 'zhoushan', 'zhuji'],
             ...
             'liaoning': ['anshan', 'beizhen', 'benxi', 'chaoyang', 'dalian', 'dandong', 'donggang', 'fushun', 'fuxin',
                          'haicheng', 'huludao', 'jinzhou', 'liaoning', 'liaoyang', 'panjin', 'shenyang', 'tieling',
                          'yingkou'],
             'anhui': ['anqing', 'bengbu', 'bozhou', 'chaohu', 'chizhou', 'chuzhou', 'fuyang', 'hefei', 'huaibei',
                       'huainan', 'huangshan', 'luan', 'maanshan', 'suzhou', 'tongling', 'wuhu', 'xuancheng']}
