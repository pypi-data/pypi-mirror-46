...
from zhulong.util.etl import est_tables, gg_html, gg_meta, add_info, est_meta, est_html
    ...
    if flag == 1:
        ...
        for li in lis:
            ...
            try:
                ...
                title = a.text.strip()
            link = "http://ggzyjy.dz.gov.cn" + a["href"]
...
data1 = [
    ["gcjs_yucai_gg", "http://ggzyjy.dz.gov.cn/TPFront/xmxx/004001/004001005/004001005001/?Paging=1",
     ["name", "ggstart_time", "href","info"],add_info(f1,{'diqu':'市本级'}),f2],

    ["gcjs_zhaobiao_gg", "http://ggzyjy.dz.gov.cn/TPFront/xmxx/004001/004001001/004001001001/?Paging=1",
     ["name", "ggstart_time", "href","info"],add_info(f1,{'diqu':'市本级'}),f2],

    ["gcjs_biangeng_gg", "http://ggzyjy.dz.gov.cn/TPFront/xmxx/004001/004001002/004001002001/?Paging=1",
     ["name", "ggstart_time", "href","info"],add_info(f1,{'diqu':'市本级'}),f2],

    ["gcjs_zhongbiaohx_gg", "http://ggzyjy.dz.gov.cn/TPFront/xmxx/004001/004001008/004001008001/?Paging=1",
     ["name", "ggstart_time", "href","info"],add_info(f1,{'diqu':'市本级'}),f2],

    ["gcjs_gqita_zhong_liu_gg", "http://ggzyjy.dz.gov.cn/TPFront/xmxx/004001/004001003/004001003001/?Paging=1",
     ["name", "ggstart_time", "href","info"],add_info(f1,{'diqu':'市本级'}),f2],

    ["gcjs_hetong_gg", "http://ggzyjy.dz.gov.cn/TPFront/xmxx/004001/004001006/004001006001/?Paging=1",
     ["name", "ggstart_time", "href","info"],add_info(f1,{'diqu':'市本级'}),f2],

    ["zfcg_zhaobiao_gg", "http://ggzyjy.dz.gov.cn/TPFront/xmxx/004002/004002001/004002001001/?Paging=1",
     ["name", "ggstart_time", "href","info"],add_info(f1,{'diqu':'市本级'}),f2],

    ["zfcg_biangeng_gg", "http://ggzyjy.dz.gov.cn/TPFront/xmxx/004002/004002002/004002002001/?Paging=1",
     ["name", "ggstart_time", "href","info"],add_info(f1,{'diqu':'市本级'}),f2],

    ["zfcg_gqita_zhong_liu_gg", "http://ggzyjy.dz.gov.cn/TPFront/xmxx/004002/004002003/004002003001/?Paging=1",
     ["name", "ggstart_time", "href","info"],add_info(f1,{'diqu':'市本级'}),f2],

    ["zfcg_yucai_gg", "http://ggzyjy.dz.gov.cn/TPFront/xmxx/004002/004002005/004002005001/?Paging=1",
     ["name", "ggstart_time", "href","info"],add_info(f1,{'diqu':'市本级'}),f2],

    ["zfcg_hetong_gg", "http://ggzyjy.dz.gov.cn/TPFront/xmxx/004002/004002006/004002006001/?Paging=1",
     ["name", "ggstart_time", "href","info"],add_info(f1,{'diqu':'市本级'}),f2],

    ["qsy_yucai_gg", "http://ggzyjy.dz.gov.cn/TPFront/xmxx/004006/004006002/004006002001/004006002001001/?Paging=1",
     ["name", "ggstart_time", "href", "info"],add_info(f1,{'jylx':'货物服务','diqu':'市本级'}), f2],

    ["qsy_zhaobiao_gg", "http://ggzyjy.dz.gov.cn/TPFront/xmxx/004006/004006002/004006002002/004006002002001/?Paging=1",
     ["name", "ggstart_time", "href", "info"],add_info(f1,{'jylx':'货物服务','diqu':'市本级'}), f2],

    ["qsy_biangeng_gg",
     "http://ggzyjy.dz.gov.cn/TPFront/xmxx/004006/004006002/004006002003/004006002003001/?Paging=1",
     ["name", "ggstart_time", "href", "info"],add_info(f1,{'jylx':'货物服务','diqu':'市本级'}), f2],

    ["qsy_gqita_zhong_liu_gg",
     "http://ggzyjy.dz.gov.cn/TPFront/xmxx/004006/004006002/004006002004/004006002004001/?Paging=1",
     ["name", "ggstart_time", "href", "info"],add_info(f1,{'jylx':'货物服务','diqu':'市本级'}), f2],

    ["qsy_hetong_gg",
     "http://ggzyjy.dz.gov.cn/TPFront/xmxx/004006/004006002/004006002005/004006002005001/?Paging=1",
     ["name", "ggstart_time", "href", "info"],add_info(f1,{'jylx':'货物服务','diqu':'市本级'}), f2],
...
def get_data():
    ...
    # # "http://ggzyjy.dz.gov.cn/ll/xmxx/004001/004001005/004001005002/?Paging=1"
            ...
            for w2 in ggtype1.keys():
                for w3 in xs2.keys():
                    if w1 == w3:
                        ...
                        href = "http://ggzyjy.dz.gov.cn/%s/xmxx/004001/%s/%s/?Paging=1" % (xs1[w1], p1, p2)
            ...
            for w2 in ggtype2.keys():
                for w3 in xs2.keys():
                    if w1 == w3:
                        ...
                        if w2 == 'yucai':
                            href = "http://ggzyjy.dz.gov.cn/qh/xmxx/004001/004001007/004001007001/?Paging=1"
                        else:
                            href = "http://ggzyjy.dz.gov.cn/%s/xmxx/004001/%s/%s/?Paging=1" % (xs1[w1], p1, p2)
                        tb = "gcjs_%s_diqu%s_gg" % (w2, xs2[w3])
                        col = ["name", "ggstart_time", "href", "info"]
    ...
    # 'http://ggzyjy.dz.gov.cn/qy/xmxx/004002/004002001/004002001010/?Paging=3'
    for w1 in xs1.keys():
        for w2 in ggtype2.keys():
            for w3 in xs2.keys():
                if w1 == w3:
                    ...
                    href = "http://ggzyjy.dz.gov.cn/%s/xmxx/004002/%s/%s/?Paging=1" % (xs1[w1], p1, p2)
