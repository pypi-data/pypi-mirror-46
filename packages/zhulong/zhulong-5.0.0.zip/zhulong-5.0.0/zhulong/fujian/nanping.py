    ...
    if "http://np.fjzfcg.gov.cn" in url:
        ...
        for tr in trs:
            ...
            if 'http' in link:
                ...
                href = "http://npggzy.gov.cn" + link.strip()
...
data = [
    ...
    ["qsydw_gqita_zhong_liu_gg",
     "http://npggzy.gov.cn/npztb/qxzbxx/013005/",
     ["name", "ggstart_time", "href", "info"],f1, f2],
...
if __name__=='__main__':
    work(conp=["postgres","since2015","192.168.4.175","fujian","nanping"])
