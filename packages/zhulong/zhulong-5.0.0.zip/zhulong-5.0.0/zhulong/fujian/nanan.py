...
data = [
    ...
    ["gcjs_gqita_bian_bu_da_xiaoer_gg",
    ...
    ["gcjs_zhongbiao_xiaoer_gg",
     "http://www.nazbcg.gov.cn/hyweb/transInfo/getTenderInfoPage.do/x=4",
     ["name", "ggstart_time", "href", "info"], f1, f2],

    ["gcjs_liubiao_xiaoer_gg",
     "http://www.nazbcg.gov.cn/hyweb/transInfo/getTenderInfoPage.do/x=7",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ...
    ["qsy_biangeng_gg",
     "http://www.nazbcg.gov.cn/hyweb/govPurchase/getMongoGovPurchaseNoticePage.do/g=4",
     ["name", "ggstart_time", "href", "info"], f1, f2],

    ["qsy_zsjg_gg",
     "http://www.nazbcg.gov.cn/hyweb/govPurchase/getMongoGovPurchaseNoticePage.do/g=5",
     ["name", "ggstart_time", "href", "info"], f1, f2],

    ["qsy_liubiao_gg",
     "http://www.nazbcg.gov.cn/hyweb/govPurchase/getMongoGovPurchaseNoticePage.do/g=7",
     ["name", "ggstart_time", "href", "info"], f1, f2],
...
if __name__=='__main__':
    ...
    # url = "http://www.nazbcg.gov.cn/hyweb/commons/simpleBidDetails.do?handle=1&projId=0d7d6575-62f9-4792-8d74-d246ec705e69&noticeType=1"
    # driver.get(url)
    # df = f3(driver, url)
    # print(df)
    # driver=webdriver.Chrome()
    # url = "http://www.nazbcg.gov.cn/hyweb/govPurchase/getMongoGovPurchaseNoticePage.do/z=1"
    # driver.get(url)
    # for i in range(1, 6):
    #     df=f1(driver, i)
    #     print(df)
