...
data = [
    ...
    ["zfcg_zhaobiao_dyly_gg", "http://ggzy.sqzwfw.gov.cn/jyxx/tradeInfo.html",
     ["name", "ggstart_time", "href", "info"],
     add_info(before(f1, "政府采购", "单一来源公示"),{"method":"单一来源"}), before(f2, "政府采购", "单一来源公示")],
    #
    ["gcjs_gqita_gg", "http://ggzy.sqzwfw.gov.cn/jyxx/tradeInfo.html",
     ["name", "ggstart_time", "href", "info"],
...
if __name__ == '__main__':
    ...
    #     'pageSize': '10',
    # }
    # content = json.loads(requests.post(url,data=form_data).text)
    # print(content)
    # url2 = "http://ggzy.sqzwfw.gov.cn/WebBuilder/jyxxAction.action?cmd=getListByCount"
    # content2 = json.loads(requests.post(url2, data=form_data2).text)
    # print(content2['custom'])

    # driver = webdriver.Chrome()
    # driver.get('http://ggzy.sqzwfw.gov.cn/jyxx/tradeInfo.html')
    # print(before(f2, "其他交易", "无")(driver))

    # print(before(f1, "其他交易", "无")(driver, 3))
