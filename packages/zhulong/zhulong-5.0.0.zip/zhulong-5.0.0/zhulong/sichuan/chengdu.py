...
data = [
    ...
    ["zfcg_zhaobiao_gg", "https://www.cdggzy.com/site/Notice/ZFCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_1(f1), click_link_1(f2)],

    ["zfcg_biangeng_gg", "https://www.cdggzy.com/site/Notice/ZFCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(f1), click_link_2(f2)],

    ["zfcg_gqita_zhong_liu_gg", "https://www.cdggzy.com/site/Notice/ZFCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_3(f1), click_link_3(f2)],
