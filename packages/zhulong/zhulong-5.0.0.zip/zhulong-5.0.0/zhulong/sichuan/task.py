...
def task_jiangyou(**args):
    ...
    jiangyou.work(conp, pageloadtimeout=60, **args)
...
def task_longchang(**args):
    ...
    longchang.work(conp, pageloadtimeout=60, **args)
...
def task_mianyang1(**args):
    ...
    mianyang1.work(conp, pageloadtimeout=60, pageLoadStrategy="none", **args)
...
def task_neijiang(**args):
    ...
    neijiang.work(conp, pageloadtimeout=60, pageLoadStrategy="none", **args)
