...
data = [
    ...
    ["zfcg_zhaobiao_gg",
     "http://www.ordosggzyjy.org.cn/TPFront/zfcg/010001/?categorynum=010001",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["zfcg_gqita_yanshou_gg",
     "http://www.ordosggzyjy.org.cn/TPFront/zfcg/010011/?categorynum=010011",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["zfcg_yucai_gg",
     "http://www.ordosggzyjy.org.cn/TPFront/zfcg/010009/?categorynum=010009",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["zfcg_zgys_gg",
     "http://www.ordosggzyjy.org.cn/TPFront/zfcg/010012/?categorynum=010012",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["zfcg_biangeng_gg",
     "http://www.ordosggzyjy.org.cn/TPFront/zfcg/010002/?categorynum=010002",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["zfcg_zhongbiao_gg",
     "http://www.ordosggzyjy.org.cn/TPFront/zfcg/010003/?categorynum=010003",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["zfcg_gqita_zhongbiaobiangeng_gg",
     "http://www.ordosggzyjy.org.cn/TPFront/zfcg/010004/?categorynum=010004",
     ["name", "ggstart_time", "href", "info"], add_info(f1,{'tag':'中标变更'}), f2],
    ["zfcg_liubiao_gg",
...
if __name__ == "__main__":
    ...
    # url= "http://www.ordosggzyjy.org.cn/TPFront/showinfo/MoreListSqhb.aspx?CategoryNum=009002"
    ...
    # driver.quit()
    #
    # url= "http://www.ordosggzyjy.org.cn/TPFront/zfcg/010011/?categorynum=010011"
    # driver = webdriver.Chrome()
    # driver.get(url)
    ...
    # driver.quit()
    #
    # url= "http://www.ordosggzyjy.org.cn/TPFront/zfcg/010006/?categorynum=010006"
    # driver = webdriver.Chrome()
    # driver.get(url)
    # for i in range(1,78):
    #     f1(driver,i)
    ...
    work(conp=["postgres", "since2015", "192.168.3.171", "neimenggu", "eeduosi"],num=4,total=10)
    # url= "http://www.ordosggzyjy.org.cn/TPFront/showinfo/MoreListSqhb.aspx?CategoryNum=009001"
    ...
    # for i in range(1,66): print(f1(driver, i))
    # for i in range(1,72):
    #     f1(driver,i)
    #
    # driver.quit()