...
def f1(driver, num):
    url = "http://ggzy.tlzw.gov.cn/EpointWebBuilder_tlsggzy/jyxxInfoAction.action"
    headers = {
        ...
        "Referer": "http://ggzy.tlzw.gov.cn/tlsggzy/jsgc/subpage.html",
    ...
    for name, ggstart_time, url in zip(name_list, ggstart_time_list, url_list):
        name = re.sub(' ','',name)
        url = "http://ggzy.tlzw.gov.cn" + url.replace('\\', '').replace(' ', '')
...
data = [
    ["gcjs_zhaobiao_gg",
     "http://ggzy.tlzw.gov.cn/tlsggzy/jsgc/subpage.html",
...
if __name__ == "__main__":
    ...
    # driver.get("http://ggzy.tlzw.gov.cn/tlsggzy/jsgc/subpage.html")
    # for i in range(1,50):
