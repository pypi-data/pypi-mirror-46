...
def f1(driver, num):
    ...
    for content in content_list:
        ...
        ggstart_time = content.xpath("./a/span/text()")[0].split(" ")[1]
...
if __name__ == "__main__":
    # url = "http://zwzx.bynr.gov.cn/sunshineGov/list.shtml?columnId=402883f365a786900165a7ecd0e50016&siteId=1&newsType=ggzyjy&pageNumber=1"
    ...
    work(conp=["postgres", "since2015", "192.168.3.171", "neimenggu", "bayannaoer"])
