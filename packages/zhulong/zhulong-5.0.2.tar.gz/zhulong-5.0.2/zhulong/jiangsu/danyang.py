...
data = [
    ...
    ["jqita_zhaobiao_gg", "http://www.dyzgw.com.cn/dyzgw/jyxx/001014/001014001/MoreInfo.aspx?CategoryNum=001014001",
     ["name", "ggstart_time", "href", "info"], add_info(f1,{"tag":"综合交易"}), f2],
    ["jqita_zhaobiao_gg", "http://www.dyzgw.com.cn/dyzgw/jyxx/001014/001014002/MoreInfo.aspx?CategoryNum=001014002",
     ["name", "ggstart_time", "href", "info"], add_info(f1,{"tag":"综合交易"}), f2],
