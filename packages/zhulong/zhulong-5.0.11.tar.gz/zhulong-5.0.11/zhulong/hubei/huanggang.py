...
data=[
    ["gcjs_gg","http://ggzy.hg.gov.cn/ceinwz/WebInfo_List.aspx?&newsid=700&jsgc=0100000&zbdl=1&FromUrl=jygg",["bh","name","href","ggstart_time","info"],f1,f2],
    ["zfcg_gg","http://ggzy.hg.gov.cn/ceinwz/WebInfo_List.aspx?&newsid=400&zfcg=0100000&FromUrl=jygg",["bh","name","href","ggstart_time","info"],f1,f2]
    ]
...
if __name__=='__main__':
    work(conp=["postgres","since2015","127.0.0.1","hubei","huanggang"])
