...
data=[
    ["gcjs_gg","http://www.szztb.com.cn/Category/More?id=643&typeId=0",["name","href","ggstart_time","info"],f1,f2],

    ["zfcg_gg","http://www.szztb.com.cn/Category/More?id=644&typeId=0",["name","href","ggstart_time","info"],f1,f2],
    ]
