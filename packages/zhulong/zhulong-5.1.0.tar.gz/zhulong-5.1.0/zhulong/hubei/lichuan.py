...
data = [
    ###包含:招标,流标,变更
    ["gcjs_gqita_zhao_liu_bian_gg", "http://lc.eszggzy.cn/lcweb/jyxx/070001/070001001/",
     ['name', 'ggstart_time', 'href', 'info'],f1, f2],
    ["gcjs_gqita_bian_liu_gg", "http://lc.eszggzy.cn/lcweb/jyxx/070001/070001002/",
     ['name', 'ggstart_time', 'href', 'info'],f1, f2],
    ["gcjs_zhongbiaohx_gg", "http://lc.eszggzy.cn/lcweb/jyxx/070001/070001003/",
     ['name', 'ggstart_time', 'href', 'info'], f1, f2],

    ##包含:招标,流标,变更
    ["zfcg_gqita_zhao_liu_bian_gg", "http://lc.eszggzy.cn/lcweb/jyxx/070002/070002001/",
     ['name', 'ggstart_time', 'href', 'info'],f1, f2],
    ["zfcg_biangeng_gg", "http://lc.eszggzy.cn/lcweb/jyxx/070002/070002002/",
     ['name', 'ggstart_time', 'href', 'info'],f1, f2],
    ["zfcg_zhongbiao_gg", "http://lc.eszggzy.cn/lcweb/jyxx/070002/070002003/",
     ['name', 'ggstart_time', 'href', 'info'],f1, f2],
    ["zfcg_zhaobiao_danyilaiyuan_gg", "http://lc.eszggzy.cn/lcweb/jyxx/070002/070002004/",
     ['name', 'ggstart_time', 'href', 'info'],f1, f2],

    ##包含:招标,流标,变更
    ["qsy_gqita_zhao_liu_bian_gg", "http://lc.eszggzy.cn/lcweb/jyxx/070005/070005001/",
     ['name', 'ggstart_time', 'href', 'info'],f1, f2],
    ["qsy_biangeng_gg", "http://lc.eszggzy.cn/lcweb/jyxx/070005/070005002/",
     ['name', 'ggstart_time', 'href', 'info'],f1, f2],
