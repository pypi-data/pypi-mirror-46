...
data = [
    ...
    ["gcjs_shigong_zhongbiaohx_gg",
     "http://ggzyjy.yichang.gov.cn/TPFront/jyxx/003001/003001003/003001003001/?pageing=1",
     ["name", "ggstart_time", "href", "info"], add_info(f1, {"gctype": "施工"}), f2],
    ...
    ["zfcg_gongcheng_zhongbiao_gg",
     "http://ggzyjy.yichang.gov.cn/TPFront/jyxx/003002/003002003/003002003003/?pageing=1",
     ["name", "ggstart_time", "href", "info"], add_info(f1, {"gctype": "工程"}), f2],
...
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "hubei", "yichang"])
