...
data=[
    ["jqita_zhaobiao_gg","http://zyjy.jingmen.gov.cn/Front/ShowInfo/MoreInfoListjyxx.aspx?CategoryNum=003002&Paging=1",["name","ggstart_time","jytype","href","info"],f1,f2 ],

    ["jqita_zhongbiao_gg","http://zyjy.jingmen.gov.cn/Front/ShowInfo/MoreInfoListjyxx.aspx?CategoryNum=003003&Paging=1",["name","ggstart_time","jytype","href","info"],f1,f2],
]
