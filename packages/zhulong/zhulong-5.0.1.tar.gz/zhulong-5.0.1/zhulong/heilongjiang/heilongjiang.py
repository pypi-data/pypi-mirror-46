...
data=[
    ...
    ["yiliao_zhaobiao_gg","http://www.hljggzyjyw.gov.cn/trade/tradezfcg?cid=20&pageNo=1&type=1&notice_name=",["name","ggstart_time","href","info"],f1,f2],
    ##无信息
    ["yiliao_liubiao_gg","http://www.hljggzyjyw.gov.cn/trade/tradezfcg?cid=20&pageNo=1&type=5&notice_name=",["name","ggstart_time","href","info"],f1,f2],
    ##只有一条数据
    ["yiliao_zhongbiao_gg","http://www.hljggzyjyw.gov.cn/trade/tradezfcg?cid=20&pageNo=1&type=4&notice_name=",["name","ggstart_time","href","info"],f1,f2],
    ["yiliao_zhongbiaohx_gg","http://www.hljggzyjyw.gov.cn/trade/tradezfcg?cid=20&pageNo=1&type=3&notice_name=",["name","ggstart_time","href","info"],f1,f2],
