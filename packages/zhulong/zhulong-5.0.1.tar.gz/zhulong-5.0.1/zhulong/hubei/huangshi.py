...
def f1(driver,num):
    ...
    for li in lis:
        ...
        tmp=[a["title"],"http://www.hsztbzx.com"+a["href"],re.findall("[0-9/]{4,}",span.text)[0]]
        data.append(tmp)
...
data=[ 
        ...
        ["gcjs_biangen_gg","http://www.hsztbzx.com/BidNotice/jsgc/bggg", ["name","ggstart_time","href","info"],f1,f2 ] ,
        ...
        ["zfcg_biangen_gg","http://www.hsztbzx.com/BidNotice/zfcg/bggg", ["name","ggstart_time","href","info"],f1,f2 ] ,
