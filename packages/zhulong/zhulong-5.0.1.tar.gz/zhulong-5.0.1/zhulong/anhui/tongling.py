...
if __name__=='__main__':
    ...
    # work(conp=["postgres","since2015","192.168.4.175","anhui","tongling"],headless=False,num=1)
    # work(conp=["postgres","since2015","192.168.3.171","anhui","tongling"],headless=True,num=1,cdc_total=None)
