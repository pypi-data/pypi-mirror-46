...
data = [
    ["gcjs_gqita_zhao_zhong_gg", "http://www.szztb.com.cn/Category/More?id=643&typeId=0",
     ["name", "href", "ggstart_time", "info"], f1, f2],

    ["zfcg_gqita_zhao_bian_zhong_liu_gg", "http://www.szztb.com.cn/Category/More?id=644&typeId=0",
     ["name", "href", "ggstart_time", "info"], f1, f2],
]
...
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "hubei", "suizhou"])
