...
data=[
    ["gcjs_gqita_zhao_zhong_gg","http://ggzy.hg.gov.cn/ceinwz/WebInfo_List.aspx?&newsid=700&jsgc=0100000&zbdl=1&FromUrl=jygg",["name",'ggstart_time',"href","info"],f1,f2],
    ["zfcg_gqita_zhao_zhong_liu_bian_gg","http://ggzy.hg.gov.cn/ceinwz/WebInfo_List.aspx?&newsid=400&zfcg=0100000&FromUrl=jygg",["name",'ggstart_time',"href","info"],f1,f2]
    ]
