...
def get_command_data(id, db: Database = None):
    if db is None:
        db = Database()
...
def get_response_data(id, db: Database = None):
    if db is None:
        db = Database()
...
def add_edit_voice_command(username, id, name, command_data, response_data, action_data, db: Database = None):
    if db is None:
        db = Database()
...
def delete_voice_command(username, id, db: Database = None):
    if db is None:
        db = Database()
...
def add_command_data(commands, id, db: Database = None):
    if db is None:
        db = Database()
...
def add_response_data(responses, id, db: Database = None):
    if db is None:
        db = Database()
...
def run_custom_voice_commands(text, username, db: Database = None):
    if db is None:
        db = Database()
