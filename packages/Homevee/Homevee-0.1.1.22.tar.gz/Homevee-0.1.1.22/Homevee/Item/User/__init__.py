...
class User(Item):
    ...
    def delete(self, db=None):
        try:
            Database.delete("DELETE FROM USERDATA WHERE USERNAME == :user", {'user': self.username})
            return True
        except:
            return False
    ...
    def save_to_db(self, db=None):
        try:
            ...
            if (self.id is None or self.id == ""):
                Database.insert("""INSERT INTO USERDATA (USERNAME, PASSWORD, IP, PERMISSIONS, PW_SALT) VALUES 
    ...
    @staticmethod
    def load_by_permissions(permissions, db=None):
