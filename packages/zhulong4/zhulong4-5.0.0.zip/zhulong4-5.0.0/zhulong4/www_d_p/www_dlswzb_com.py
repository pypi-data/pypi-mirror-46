...
def work(conp, **args):
    est_meta_large(conp, data=data, diqu="国家电投", **args)
    est_html(conp, f=f3, **args)


# 页数太多，应加大线程数，而且网页加载慢,一次性跑不完
if __name__ == '__main__':
    work(conp=["postgres", "since2015", "192.168.3.171", "guoziqiang3", "www_dlswzb_com"],pageloadtimeout=60,pageLoadStrategy="none",num=30)
