...
data = [
    ["qy_zhaobiao_gg",
     "http://ec.ceec.net.cn/HomeInfo/ProjectList.aspx?InfoLevel=MQA=&bigType=WgBCAEcARwA=&smallType=aAB3AA==&PageD=2",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["qy_yucai_gg",
     "http://ec.ceec.net.cn/HomeInfo/ProjectList.aspx?InfoLevel=MQA=&bigType=QwBHAFkARwA=",
     ["name", "ggstart_time", "href", "info"], f1, f2],

    ["qy_zhaobiao_caigou_hw_gg",
     "http://ec.ceec.net.cn/HomeInfo/ProjectList.aspx?InfoLevel=MgA=&bigType=QwBHAEcARwA=&smallType=aAB3AA==&PageD=2",
     ["name", "ggstart_time", "href","info"], add_info(f1,{'type':"货物"}), f2],
    ["qy_zhaobiao_caigou_gc_gg",
     "http://ec.ceec.net.cn/HomeInfo/ProjectList.aspx?InfoLevel=MgA=&bigType=QwBHAEcARwA=&smallType=ZwBjAA==&PageD=2",
     ["name", "ggstart_time", "href","info"], add_info(f1,{'type':"工程"}), f2],
    ["qy_zhaobiao_caigou_fw_gg",
     "http://ec.ceec.net.cn/HomeInfo/ProjectList.aspx?InfoLevel=MgA=&bigType=QwBHAEcARwA=&smallType=ZgB3AA==&PageD=2",
     ["name", "ggstart_time", "href","info"], add_info(f1,{'type':"服务"}), f2],

    ["qy_zhongbiao_hw_gg",
     "http://ec.ceec.net.cn/HomeInfo/ProjectList.aspx?InfoLevel=MgA=&bigType=WgBCAEcAUwA=&smallType=aAB3AA==&PageD=2",
     ["name", "ggstart_time", "href", "info"], add_info(f1,{'type':"货物"}), f2],
    ["qy_zhongbiao_gc_gg",
     "http://ec.ceec.net.cn/HomeInfo/ProjectList.aspx?InfoLevel=MgA=&bigType=WgBCAEcAUwA=&smallType=ZwBjAA==&PageD=2",
     ["name", "ggstart_time", "href", "info"], add_info(f1,{'type':"工程"}), f2],
    ["qy_zhongbiao_fw_gg",
     "http://ec.ceec.net.cn/HomeInfo/ProjectList.aspx?InfoLevel=MgA=&bigType=WgBCAEcAUwA=&smallType=ZgB3AA==&PageD=2",
     ["name", "ggstart_time", "href", "info"], add_info(f1,{'type':"服务"}), f2],

    ["qy_zhongbiaohx_hw_gg",
     "http://ec.ceec.net.cn/HomeInfo/ProjectList.aspx?InfoLevel=MgA=&bigType=WgBYAEcAUwA=&smallType=aAB3AA==&PageD=2",
     ["name", "ggstart_time", "href", "info"], add_info(f1,{'type':"货物"}), f2],
    ["qy_zhongbiao_gc_gg",
     "http://ec.ceec.net.cn/HomeInfo/ProjectList.aspx?InfoLevel=MgA=&bigType=WgBYAEcAUwA=&smallType=ZwBjAA==&PageD=2",
     ["name", "ggstart_time", "href", "info"], add_info(f1,{'type':"工程"}), f2],
    ["qy_zhongbiao_fw_gg",
     "http://ec.ceec.net.cn/HomeInfo/ProjectList.aspx?InfoLevel=MgA=&bigType=WgBYAEcAUwA=&smallType=ZgB3AA==&PageD=2",
     ["name", "ggstart_time", "href", "info"], add_info(f1,{'type':"服务"}), f2],
]
