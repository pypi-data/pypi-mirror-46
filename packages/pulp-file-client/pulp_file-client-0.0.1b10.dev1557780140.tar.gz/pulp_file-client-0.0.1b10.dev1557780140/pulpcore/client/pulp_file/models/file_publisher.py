...
class FilePublisher(object):
    ...
    def __init__(self, href=None, created=None, type=None, name=None, last_updated=None, manifest='PULP_MANIFEST'):  # noqa: E501
        """FilePublisher - a model defined in OpenAPI"""  # noqa: E501
