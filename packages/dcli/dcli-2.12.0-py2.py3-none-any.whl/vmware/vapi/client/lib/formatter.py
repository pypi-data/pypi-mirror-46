...
class BaseVisitor(object):
    ...
    def color_output(self, output_text):
        ...
        """
        if not CliOptions.DCLI_COLORS_ENABLED or not CliOptions.DCLI_COLORED_OUTPUT:
            return output_text
        ...
        elif isinstance(self, ColoredSimpleVisitor):
...
# Colored Simple format visitor
#
class ColoredSimpleVisitor(SimpleVisitor):
    """ Distinction class for colorized SimpleVisitor """
    pass
