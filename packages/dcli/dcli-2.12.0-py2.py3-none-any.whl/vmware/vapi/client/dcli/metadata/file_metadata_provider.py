...
from vmware.vapi.client.dcli.metadata.input_definition_provider import InputDefinitionProvider
...
class FileMetadataProvider(AbstractMetadataProvider):
    ...
    def __init__(self,
        ...
        if server_type == 'internal':
            json_str, _ = FileMetadataProvider.\
            ...
            json_str = FileMetadataProvider.read_metadata(server_url,
                                                          server_type,
                                                          requests_session,
                                                          token)
    ...
    @staticmethod
    def read_metadata(server_url, server_type, requests_session, token):
        """
        ...
        json_str, file_name = FileMetadataProvider.read_local_metadata(metadata_file_from_env_var)
        if not json_str:
            ...
            cached_session = \
                FileMetadataProvider.get_cached_session(requests_session)
