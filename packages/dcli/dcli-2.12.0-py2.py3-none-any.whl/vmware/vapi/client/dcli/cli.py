...
class CliMain(object):
    ...
    def get_internal_commands_provider(self):
        ...
        :rtype:  :class:`vmware.vapi.client.dcli.metadata.file_metadata_providerLocalMetadataProvider`
        :return: Instance internal commands provider
        """
        if not self.internal_commands_provider:
            self.internal_commands_provider = FileMetadataProvider(server_type='internal')
