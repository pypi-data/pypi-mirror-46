...
def is_mod_or_superior(ctx: "Context") -> Awaitable[bool]:
    warnings.warn(
        "`ANBOT.main.checks.is_mod_or_superior` is deprecated and will be removed in a future "
...
def is_admin_or_superior(ctx: "Context") -> Awaitable[bool]:
    warnings.warn(
        "`ANBOT.main.checks.is_admin_or_superior` is deprecated and will be removed in a future "
...
def check_permissions(ctx: "Context", perms: Dict[str, bool]) -> Awaitable[bool]:
    warnings.warn(
        "`ANBOT.main.checks.check_permissions` is deprecated and will be removed in a future "
