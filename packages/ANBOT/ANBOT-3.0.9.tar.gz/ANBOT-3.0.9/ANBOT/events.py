...
def init_events(bot, cli_flags):
    ...
    async def on_ready():
        ...
        red_pkg = pkg_resources.get_distribution("ANBOT")
...
def _get_startup_screen_specs():
    ...
    try:
        encoder("â”Œâ”â””â”˜â”€â”‚")  # border symbols
    except UnicodeEncodeError:
        ascii_border = True
    else:
        ascii_border = False
