...
async def is_allowed_by_hierarchy(
    bot: "ANBOT", settings: "Config", guild: discord.Guild, mod: discord.Member, user: discord.Member
):
...
async def is_mod_or_superior(
    bot: "ANBOT", obj: Union[discord.Message, discord.Member, discord.Role]
):
