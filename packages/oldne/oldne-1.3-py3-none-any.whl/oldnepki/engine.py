...
class engine():
    def __init__(self, middleware = "NN"):
        ...
        if middleware == "NN" or middleware == "nanomsg":
            self.manager = oldne.behavior_manager("NN",  pattern = "surveyor")
        elif middleware == "ROS":
            self.manager = oldne.behavior_manager("ROS",  pattern = "actionlib")
        elif middleware == "ZMQ":
            self.manager = oldne.behavior_manager("ZMQ",  pattern = "pubsub")
        else:
