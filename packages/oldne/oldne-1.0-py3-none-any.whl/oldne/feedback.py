...
class feedback():
    ...
    def __init__(self, node_name):
        """ Class used to help in the creation of an action node with oldne framework (ZeroMQ and NanoMsg) """
        self.node_name = node_name

        configuration =  {'transport': "ZMQ", 'network': "P2P", 'mode':"many2one", 'ip': '127.0.0.1', 'msg_type' : 'dict' }
        self.status_pub = oldne.publisher("/node_status", self.node_name, configuration)
    ...
    def execution_error(self):
        ...
        status_message = {'node':self.node_name, 'input':"execution_error"}
        self.status_pub.send_info(status_message)
