...
class TestOptions(unittest.TestCase):
    ...
    def test_json_dump_str_no_raises(self):
        self.options.json_dump = 'this isnt a real path'

    def test_json_dump_int_no_raises(self):
        with self.assertRaises(ValueError):
            self.options.json_dump = 0
...
class TestProduct(unittest.TestCase):
    ...
    def test_to_dict_all_fields_fill(self):
        product = Product('name', '314.443.32', 40, 'www.fakeurl.com', 3, ['fakeimg.jpg', 'anotherone.jpg'], ['blue'], 'justatest')
        expected_dict = {
            'name': 'name',
            'id_no': '314.443.32',
            'price': 40,
            'url': 'www.fakeurl.com',
            'rating': 3,
            'img_urls': ['fakeimg.jpg', 'anotherone.jpg'],
            'colors': ['blue'],
            'tag': 'justatest'
        }
        self.assertEqual(expected_dict, product.to_dict())

    def test_to_dict_some_fields_none(self):
        product = Product('name', '314.443.32', 40, 'www.fakeurl.com', None, None, None, None)
        expected_dict = {
            'name': 'name',
            'id_no': '314.443.32',
            'price': 40,
