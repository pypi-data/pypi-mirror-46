...
def surf_sample_grd3d_lay(nx, ny, nz, p_coord_v, p_zcorn_v, p_actnum_v, klayer, mx, my, xori, xstep, yori, ystep, rotation, p_zval_v, option, debug):
    return _cxtgeo.surf_sample_grd3d_lay(nx, ny, nz, p_coord_v, p_zcorn_v, p_actnum_v, klayer, mx, my, xori, xstep, yori, ystep, rotation, p_zval_v, option, debug)
...
def pol_resampling(nlen, xv, yv, zv, smpl, hext, nbuf, nolen, xov, yov, zov, hlen, option, debug):
    return _cxtgeo.pol_resampling(nlen, xv, yv, zv, smpl, hext, nbuf, nolen, xov, yov, zov, hlen, option, debug)
