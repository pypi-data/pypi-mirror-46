...
outputPath = "/home/magarcd/Escritorio/output/PRUEBAarticulo"
datasetPath= "/DogCat"
featureExtractors = []
datasetName = datasetPath[datasetPath.rfind("/")+1:]
print(outputPath + "/" + datasetName +'/ConfModel.json')

imagePaths = "/home/magarcd/Escritorio/dataset/DogCatTest"
...
#
groundTruthFile = auxPath + "/grountruth.csv"
groundTruth = []
csvfile2 = open(groundTruthFile, "r")
for line in csvfile2:
    line = line.split(",")
    print(str(line[1]))
    print("ERERERERERERERERERERERERERERERERERE")
    if (str(line[1])=="dog\n"):
        groundTruth.append(1)
    else:
        groundTruth.append(0)
