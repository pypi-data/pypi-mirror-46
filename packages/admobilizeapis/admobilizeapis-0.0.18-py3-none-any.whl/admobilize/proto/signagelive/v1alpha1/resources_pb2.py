...
_CREDENTIAL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='network_id', full_name='admobilize.signagelive.v1alpha1.Credential.network_id', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='user_id', full_name='admobilize.signagelive.v1alpha1.Credential.user_id', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_mappings', full_name='admobilize.signagelive.v1alpha1.Credential.num_mappings', index=8,
...
_MAPPING = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='created_at', full_name='admobilize.signagelive.v1alpha1.Mapping.created_at', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='updated_at', full_name='admobilize.signagelive.v1alpha1.Mapping.updated_at', index=6,
