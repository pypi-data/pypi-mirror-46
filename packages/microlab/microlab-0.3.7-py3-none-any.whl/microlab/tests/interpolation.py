...
def test_interpolation_cubic_from_1D_signal():
    ...
    total_numbers = 100
    cubic_1d = Interpolation_Cubic(signal=signal_1, total_number=total_numbers, verbose=False)
...
def test_interpolation_cubic_from_2D_signal():
    ...
    total_numbers = 100
    cubic_2d = Interpolation_Cubic(signal=signal_1, total_number=total_numbers, verbose=False)
