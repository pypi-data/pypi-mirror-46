    ...
    for shape in blocks:
        ...
        if precision is None:
            ...
            if precision ==4 or precision == 8:
                ...
                IBLANK = True
        if IBLANK:
            bl_data = np.frombuffer(fp.read(k),dtype = int_type[precision])
        else:
...
if __name__=='__main__':
    ...
    # main()
    t = read('/home/yxs/F/pythonAPP/julia_CFD/transdiff_p3d.g')
    write('/home/yxs/F/pythonAPP/julia_CFD/transdiff_p3d_save.g',t)
    s = read("/home/yxs/F/pythonAPP/julia_CFD/transdiff_p3d_save.g")