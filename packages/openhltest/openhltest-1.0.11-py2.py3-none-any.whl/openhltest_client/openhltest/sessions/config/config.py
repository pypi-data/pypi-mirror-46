...
class Config(Base):
	...
	YANG_KEY = None
	YANG_PROPERTY_MAP = {}
	YANG_ACTIONS = ["port-control", "clear", "load", "save", "arp-control", "traffic-control", "device-groups-control", "bgpv4-control", "bgpv6-control", "ospfv2-control", "ospfv3-control", "isis-control", "bfdv4-control", "bfdv6-control"]
