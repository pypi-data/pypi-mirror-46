...
//        cout<<"args.at(ai + 1):"<<args.at(ai + 1)<<endl;
        ...
        try {
            ...
            else if (args[ai] == "-log_dir") { log_dir = args.at(ai + 1).c_str(); }
            else {
...
//         << "this is " << endl;
    std::cerr << "\nhelp info......\n"
              ...
              << "  -log_dir                  a dirctory to save temp file [" << log_dir << "]\n"
              << "  -cofile                   max length of word ngram [" << cofile << "]\n"
              << "  -vocab_file               output vocabulary [" << vocab_file << "]\n"
              << "  -temp_file                temporary file of common occurrence chunk [" << temp_file << "]\n"
              << "  -embd_file                embedded file[" << embd_file << "]\n"
              ...
              << "  -symmetric                max length of char ngram [" << symmetric << "]\n";
