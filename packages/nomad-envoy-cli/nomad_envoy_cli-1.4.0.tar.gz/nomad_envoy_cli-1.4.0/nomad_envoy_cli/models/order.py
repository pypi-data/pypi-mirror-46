...
class Order(object):
    ...
    def __init__(self, order_id=None, client_order_ref=None, items=None, customer=None, status=None, tracking_reference=None, destination_code=None, node_code=None):  # noqa: E501
