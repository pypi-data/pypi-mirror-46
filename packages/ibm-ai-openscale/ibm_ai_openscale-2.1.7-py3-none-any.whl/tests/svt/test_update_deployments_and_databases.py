...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_15_prepare_deployment(self):
        deployment = TestAIOpenScaleClient.wml_client.deployments.create(artifact_uid=TestAIOpenScaleClient.model_uid, name="{} 2".format(TestAIOpenScaleClient.deployment_name), asynchronous=False)
        TestAIOpenScaleClient.deployment_uid2 = TestAIOpenScaleClient.wml_client.deployments.get_uid(deployment)
        print("New deployment uid: {}".format(TestAIOpenScaleClient.deployment_uid2))

    def test_16_update_deployments(self):
        TestAIOpenScaleClient.subscription.update(deployment_uids=TestAIOpenScaleClient.deployment_uid2)
        self.assertTrue(str(TestAIOpenScaleClient.deployment_uid2) in str(TestAIOpenScaleClient.subscription.get_details()))
    ...
    def test_20_delete_deployment(self):
