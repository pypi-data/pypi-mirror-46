...
def make_weights_from_histograms(mass1,
    ...
    if activation_counts is None or num_bins is None:
        ...
        params_array = activation_counts.loc[:,'mass1':'spin2z'].values
        idx = closest_template(params, params_array)
        event_weights = activation_counts.loc[:,'bns':'bbh'].values[idx]
        a_hat_bns, a_hat_mg, a_hat_nsbh, a_hat_bbh = event_weights
