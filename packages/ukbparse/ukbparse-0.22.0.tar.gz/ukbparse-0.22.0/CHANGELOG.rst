...
* ``ukbparse`` has been superseded by ``funpack`` and will no longer be
  developed. Head to https://git.fmrib.ox.ac.uk/fsl/funpack for more
  details.
