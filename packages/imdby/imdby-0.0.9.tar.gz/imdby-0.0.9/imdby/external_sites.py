...
class external_sites:
    ...
    def __init__(self, titleid):
        ...
        try:
            ...
            for index, item in enumerate(official_sites):
                try:
        ...
        try:
            ...
            for index, item in enumerate(miscellaneous_sites):
                try:
                    titles.append(item.text.strip())
                    urls.append(get('https://www.imdb.com' + item.a['href']).url)
                except:
        ...
        try:
            ...
            for index, item in enumerate(photographs_sites):
                try:
                    titles.append(item.text.strip())
                    urls.append(get('https://www.imdb.com' + item.a['href']).url)
                except:
        ...
        try:
            ...
            for index, item in enumerate(videos_clips_and_trailers_sites):
                try:
                    titles.append(item.text.strip())
                    urls.append(get('https://www.imdb.com' + item.a['href']).url)
                except:
