...
function GetOciCommandsToLongParams_fs() {
    $ociCommandsToLongParams = @{
        ...
        'fs file-system create' = 'availability-domain compartment-id defined-tags display-name freeform-tags from-json help max-wait-seconds wait-for-state wait-interval-seconds'
        ...
        'fs file-system update' = 'defined-tags display-name file-system-id force freeform-tags from-json help if-match max-wait-seconds wait-for-state wait-interval-seconds'
