...
function GetOciCommandsToLongParams_network() {
    $ociCommandsToLongParams = @{
        ...
        'network ip-sec-connection create' = 'compartment-id cpe-id cpe-local-identifier cpe-local-identifier-type defined-tags display-name drg-id freeform-tags from-json help max-wait-seconds static-routes wait-for-state wait-interval-seconds'
