...
*CAUTION*: DO NOT use *was* for threaded or processed function's argument or DO NOT access it from target function.
Skitai's *was* is highly coupled with request handling thread pool. But within execution pool, it might be cause of unexpected errors.
So you should use internal properties of *was* as arguments like below and absolutly forget about *was*.

.. code:: python
  
  @app.route ('...')
  def foo ():    
    return was.Thread (generate_xls, was.request.ARGS).then (
