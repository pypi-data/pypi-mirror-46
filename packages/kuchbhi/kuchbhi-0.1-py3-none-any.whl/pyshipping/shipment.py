...
class AbstractItem(object):
    ...
    def max_packstueck_gewicht(self):
        ...
        return (old_div(self.gewicht_pro_exportkarton, self.produkte_pro_exportkarton)) * self.menge
...
class simpleTests(unittest.TestCase):
    ...
    def test_stupid(self):
        ...
        aitem.einzelvolumen = old_div((750 * 200 * 100), 10 / 10 / 10)
        ...
        aitem2.einzelvolumen = old_div((750 * 200 * 100), 10 / 10 / 10)
