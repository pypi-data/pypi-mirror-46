...
def set_security_config(consumer_name=None, private_key_file=None, encrypted_shared_key_file=None):
    config.consumerName = consumer_name or config.consumerName
    config.privateKeyFile = private_key_file or config.privateKeyFile
    config.encryptedSharedKeyFile = encrypted_shared_key_file or config.encryptedSharedKeyFile
