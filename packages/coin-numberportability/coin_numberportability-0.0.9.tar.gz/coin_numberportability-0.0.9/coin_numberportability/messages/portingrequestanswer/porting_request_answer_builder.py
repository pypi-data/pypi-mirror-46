...
class PortingRequestAnswerRepeatsBuilder(EnumRepeatsBuilder):
    ...
    def finish(self):
        seq = PortingRequestAnswerSeq(self._number_series, self._blockingcode, self.firstpossibledate, self._note, self._donornetworkoperator, self.donorserviceprovider)
