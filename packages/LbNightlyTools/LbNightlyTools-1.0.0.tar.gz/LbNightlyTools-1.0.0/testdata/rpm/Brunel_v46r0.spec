...
cd  ${RPM_BUILD_ROOT}/opt/LHCbSoft/lhcb/ && tar jxf %TMPDIR%/packs/src/Brunel.v46r0.lhcb-release.999.src.tar.bz2 --strip-components=1 -C %{projectUp}/%{projectUp}_%{lbversion}
