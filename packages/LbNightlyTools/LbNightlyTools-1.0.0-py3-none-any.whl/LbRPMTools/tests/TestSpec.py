...
rsync -arL %{buildlocation}/%{project}/InstallArea/%{cmtconfig} ${RPM_BUILD_ROOT}/opt/LHCbSoft/lhcb/%{projectUp}/%{projectUp}_%{lbversion}/InstallArea/
...
cd  ${RPM_BUILD_ROOT}/opt/LHCbSoft/lhcb/ && tar jxf /tmp/toto.tar.gz --strip-components=1 -C %{projectUp}/%{projectUp}_%{lbversion}
...
%install
mkdir -p ${RPM_BUILD_ROOT}/opt/LHCbSoft/lhcb/%{projectUp}/%{projectUp}_%{lbversion}
cd  ${RPM_BUILD_ROOT}/opt/LHCbSoft/lhcb/ && tar jxf /tmp/toto.tar.bz2 --strip-components=1 -C %{projectUp}/%{projectUp}_%{lbversion}
