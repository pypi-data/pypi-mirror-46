...
class ContourLegend(legend.TabularLegend):
    ...
    def include_cutoff_levels(self):
        """(**deprecated**) Show color bands for levels affected by color cutoff.

        .. deprecated:: 0.13
            Use `ContourLegend.show_cutoff_levels` instead.
        """
        tecutil.warn_api_moved('ContourLegend.include_cutoff_levels',
                               'ContourLegend.show_cutoff_levels')
        return self.show_cutoff_levels

    @include_cutoff_levels.setter
    def include_cutoff_levels(self, value):
        tecutil.warn_api_moved('ContourLegend.include_cutoff_levels',
                               'ContourLegend.show_cutoff_levels')
        self.show_cutoff_levels = value
