...
class StreamtraceTerminationLine(StreamtraceStyle):
    ...
    @property
    def is_active(self):
        """(**deprecated**) Activate/disable the streamtrace termination line.

        .. deprecated:: 0.13
            Use `StreamtraceTerminationLine.active` instead.
        """
        tecutil.warn_api_moved('StreamtraceTerminationLine.is_active',
...
class Streamtraces(session.Style):
    ...
    def position(self, stream_number):
        ...
        with self.plot.frame.activated():
            ...
            return tecutil.XYZPosition(*position)
    ...
    @property
    def are_active(self):
        """(**deprecated**) Determine if there are active streamtraces.

        .. deprecated:: 0.13
            Use `Streamtraces.active` instead.
        """
        tecutil.warn_api_moved('Streamtraces.are_active', 'Streamtraces.active')
        return self.active
