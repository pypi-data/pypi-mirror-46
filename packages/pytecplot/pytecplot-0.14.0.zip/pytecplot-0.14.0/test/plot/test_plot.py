...
class TestCartesian2DFieldPlot(unittest.TestCase):
    ...
    def test_fieldmap(self):
        ...
        self.assertIsInstance(self.plot.fieldmap(self.dataset.zone(0)),
                                                 Cartesian2DFieldmap)
        self.assertEqual(self.plot.fieldmap(-1)._offset1,
                         self.plot.fieldmap(self.dataset.num_zones - 1)._offset1)
...
class TestLinePlot(unittest.TestCase):
    ...
    def test_add_linemap(self):
        ...
        # TODO: fix TecUtilServer add_linemap with NULL for name
        # add_linemap() without any args crashes windows and Mac when fetching
        # the name.
...
class TestXYLinePlot(unittest.TestCase):
    ...
    def test_linemap(self):
        ...
        self.assertEqual(lmap2.uid, self.plot.linemap(-1).uid)
        self.assertEqual(lmap1.uid, self.plot.linemap(-2).uid)
...
class TestPolarLinePlot(unittest.TestCase):
    ...
    def test_linemaps(self):
        ...
        # TODO: fix TecUtilServer add_linemap with NULL for name
        # add_linemap() without any args crashes mac and windows when
        # fetching the name.
        if platform.system() not in ['Darwin', 'Windows']:
