...
class TMC5130_mask_shift(object):
	...
	SD_MODE                 = ( 0x04, 0x00000040,  6 ) # IOIN
	SWCOMP_IN               = ( 0x04, 0x00000080,  7 ) # IOIN
	VERSION                 = ( 0x04, 0xFF000000, 24 ) # IOIN

	# OUTPUT
	OUTPUT                  = ( 0x04, 0x00000001,  0 ) # OUTPUT
	...
	POS_EDGENEG_EDGE        = ( 0x38, 0x000000C0,  6 ) # ENCMODE
	...
	TFD_ALL                 = ( 0x6C, 0x00000070,  4 ) # CHOPCONF
	OFFSET                  = ( 0x6C, 0x00000780,  7 ) # CHOPCONF
	TFD_3                   = ( 0x6C, 0x00000800, 11 ) # CHOPCONF
