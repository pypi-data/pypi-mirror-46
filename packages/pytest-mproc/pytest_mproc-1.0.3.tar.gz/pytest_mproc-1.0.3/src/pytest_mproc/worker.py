...
class WorkerSession:
    ...
    def pytest_internalerror(self, excrepr):
        self._result_q.put(('error_message', excrepr))
    ...
    def pytest_runtest_logreport(self, report):
        ...
        """
        self._result_q.put(('test_status', report))
    ...
    def pytest_sessionfinish(self, exitstatus):
        ...
        """
        self._result_q.put(('exit', (self._index, self._count, exitstatus, time.time() - self._session_start_time)))
