...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-servicediscovery", "0.31.0", __name__, "aws-servicediscovery@0.31.0.jsii.tgz")
