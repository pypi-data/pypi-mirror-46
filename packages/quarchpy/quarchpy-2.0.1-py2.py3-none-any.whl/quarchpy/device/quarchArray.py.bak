    ...
    def scanSubModules(self):
        ...
        for str in responseList:
            ...
            if ("FAIL" in strResponse):
                ...
                # TODO: This is not good enough, the format should be SERIAL:COM4<4> or REST:192.168.1.22<4> but we don't have this information yet
                moduleList["ARRAY:" + arraySerial + "<" + strAddr + ">"] = subSerial
