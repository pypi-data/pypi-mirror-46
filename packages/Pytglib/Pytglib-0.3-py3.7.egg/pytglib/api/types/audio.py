...
class Audio(Object):
    ...
    def __init__(self, duration, title, performer, file_name, mime_type, album_cover_thumbnail, audio, **kwargs):
    ...
    def read(q: dict, *args) -> "Audio":
        ...
        return Audio(duration, title, performer, file_name, mime_type, album_cover_thumbnail, audio)
