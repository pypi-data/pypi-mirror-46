...
class StickerSetInfo(Object):
    ...
    def __init__(self, id, title, name, is_installed, is_archived, is_official, is_masks, is_viewed, size, covers, **kwargs):
    ...
    def read(q: dict, *args) -> "StickerSetInfo":
        ...
        return StickerSetInfo(id, title, name, is_installed, is_archived, is_official, is_masks, is_viewed, size, covers)
