...
# -*- coding: utf-8 -*-
#
# ndx-speech documentation build configuration file, created by
# sphinx-quickstart on Mon May 20 20:26:55 2019.
#
...
htmlhelp_basename = 'ndx-speechdoc'
...
latex_documents = [
    (master_doc, 'ndx-speech.tex', 'ndx-speech Documentation',
     'Ben Dichter', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndx-speech', 'ndx-speech Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ndx-speech', 'ndx-speech Documentation',
     author, 'ndx-speech', 'One line description of project.',
     'Miscellaneous'),
]
