...
# DISABLED/BUG: this line fails when `pip install humanizer` but works `pip install .`
...
name = 'humanizer'
version = '0.1.0'
description = 'A developer friendly data/value humanizer for debugging/logging - for Python.'
keywords = [
    'humanizer',
    'humanize',
    'data',
