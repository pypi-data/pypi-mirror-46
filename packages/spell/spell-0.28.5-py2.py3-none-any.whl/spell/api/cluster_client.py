...
class ClusterClient(base_client.BaseClient):
    ...
    def create_gcp_cluster(self, name, service_account_id, gs_bucket,
                           vpc_id, subnet, region, project, zone, gs_access_key_id, gs_secret_access_key):
        ...
        region - region in which the subnet lives
        project - project that network lives in
        zone - a zone in subnets to launch a machine in
