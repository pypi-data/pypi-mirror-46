...
astrospectrum_warning_messages = {
    ...
    "scene_fp_overflow": "Some pixels are too bright to be represented by a floating point number and have been truncated. Check your sources and source normalizations."
}
