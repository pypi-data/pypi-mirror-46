...
a_strategy_imagingapphot = {
    'allOf': [
        {
            'type': 'object',
            'required': ['aperture_size','method','target_source','target_type','strat_offset_xy','units'],
            'properties': {
                'aperture_size':   {'type': 'number'},
...
a_strategy_choice = {
    ...
    'oneOf': [a_strategy_coronagraphy, a_strategy_ifunodinscene, a_strategy_ifunodoffscene,
              a_strategy_imagingapphot, a_strategy_msafullapphot, a_strategy_soss, a_strategy_specapphot, a_strategy_taphot],
}
