...
* objects related to tokens and tecto tokens:
    * _Node - abstract base class for Token and TectoToken with support for an ordered tree
...
class _Node(ABC):
    ...
    def toIndentTreeString(self, printToken: Union[Callable[['Token'], str], Callable[['TectoToken'], str]], indentStr: str='   ', depth: int=0) -> str:
        """
