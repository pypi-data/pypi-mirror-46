...
class Request(NamedTuple):
    ...
    class Builder:
        ...
        def __init__(self):
            self.analyses: Optional[Set[AnalysisType]] = None
            self.htmlExtractor: Optional[str] = None
            self.language: Optional[str] = None
            self.langDetectPrior: Optional[str] = None
            self.domain: Optional[str] = None
            self.textType: Optional[str] = None
            self.referenceDate: Optional[str] = None
            self.diacritization: Optional[str] = None
            self.returnMentions: bool = False
            self.returnItemSentiment: bool = False
            self.custom: JsonType = {}
        ...
        def setOptions(self, *,
            ...
            """
            Sets builder parameters that are commonly shared by multiple requests.

            :param analyses: What analyses to return z.
        ...
        def setCustom(self, custom: JsonType) -> 'Request.Builder':
            ...
            :param custom: Any custom options passed to the G3 API endpoint
            :return: The builder for fluent style chaining.
            """
        ...
        def build(self, *,
            ...
            if custom is not None and self.custom:
                custom = dict(self.custom).update(custom)
