...
class TestRequest(TestCase):
    ...
    def test_isoDate(self):
        self.assertEqual('2019-05-12', Request.Builder._isoDate(datetime.datetime(2019, 5, 12)))
        self.assertEqual('2019-05-12', Request.Builder._isoDate(datetime.date(2019, 5, 12)))
        self.assertEqual('2019-05-12', Request.Builder._isoDate('2019-05-12'))

        self.assertEqual('2019-05-02', Request.Builder._isoDate('2019-5-2'))

        with self.assertRaises(ValueError):
            Request.Builder._isoDate('5.12.2019')

        with self.assertRaises(ValueError):
            Request.Builder._isoDate('2019-15-02')
