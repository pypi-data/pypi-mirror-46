...
def remoteCall(url: str, *,
    ...
    @param auth: http 'Authorization' header, has priority over 'key' if specified, or 'AuthBase' object
    ...
    @throws: requests.RequestException
    """
