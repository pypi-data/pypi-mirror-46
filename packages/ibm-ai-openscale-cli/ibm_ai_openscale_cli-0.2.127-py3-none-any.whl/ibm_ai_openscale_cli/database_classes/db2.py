...
class DB2():
    ...
    def __init__(self, credentials):
        if 'ssldsn' in credentials:
            ...
            conn_string = 'DATABASE={};HOSTNAME={};PORT={};PROTOCOL=TCPIP;UID={};PWD={};'.format(credentials['db'], credentials['hostname'], credentials['port'], credentials['username'], credentials['password'])
