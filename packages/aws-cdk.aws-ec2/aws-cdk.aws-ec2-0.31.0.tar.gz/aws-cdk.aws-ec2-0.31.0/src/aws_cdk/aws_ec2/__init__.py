...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-ec2", "0.31.0", __name__, "aws-ec2@0.31.0.jsii.tgz")
...
class ISecurityGroup(aws_cdk.cdk.IResource, ISecurityGroupRule, IConnectable, jsii.compat.Protocol):
    ...
    def export(self) -> "SecurityGroupAttributes":
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ec2.SecurityGroupAttributes", jsii_struct_bases=[])
class SecurityGroupAttributes(jsii.compat.TypedDict):
    securityGroupId: str
