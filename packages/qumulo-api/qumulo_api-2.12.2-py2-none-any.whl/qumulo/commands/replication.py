...
class ReplicationModifySourceRelationship(qumulo.lib.opts.Subcommand):
    ...
    def options(parser):
        ...
        group.add_argument(
            ...
            action="store_true",
            help="Set the source directory as read-only.")
        group.add_argument(
            "--unset-source-directory-read-only",
            action="store_true",
            help="Unset the source directory as read-only.")
    ...
    def main(conninfo, credentials, args):
        ...
        if args.set_source_directory_read_only:
            optional_args['source_root_read_only'] = True
        elif args.unset_source_directory_read_only:
