...
def materialization_status(pid, eid, rid, name):
...
def xdc_materialize_attach(pid, eid, xdcid, rid, mid):
    ...
    """
    return do_put(
        'projects/'+pid+'/experiments/'+eid+'/xdc/'+xdcid+'/connection/'+rid+'/'+mid,
        {},
    )

def xdc_materialize_detach(pid, eid, xdcid, rid, mid):
