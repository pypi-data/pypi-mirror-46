...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-lambda", "0.31.0", __name__, "aws-lambda@0.31.0.jsii.tgz")
...
class IFunction(aws_cdk.cdk.IResource, aws_cdk.aws_logs.ILogSubscriptionDestination, aws_cdk.aws_s3_notifications.IBucketNotificationDestination, aws_cdk.aws_ec2.IConnectable, aws_cdk.aws_stepfunctions.IStepFunctionsTaskResource, aws_cdk.aws_iam.IGrantable, jsii.compat.Protocol):
    ...
    def export(self) -> "FunctionAttributes":
...
class Function(FunctionBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-lambda.Function"):
    ...
    def from_function_attributes(cls, scope: aws_cdk.cdk.Construct, id: str, *, function_arn: str, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, security_group_id: typing.Optional[str]=None) -> "IFunction":
        ...
        Arguments:
            ...
            attrs: A reference to a Lambda function. Can be created manually (see example above) or obtained through a call to ``lambda.export()``.
...
class ILayerVersion(aws_cdk.cdk.IResource, jsii.compat.Protocol):
    ...
    @jsii.member(jsii_name="export")
    def export(self) -> "LayerVersionAttributes":
...
__all__ = ["Alias", "AliasProps", "AssetCode", "CfnAlias", "CfnAliasProps", "CfnEventSourceMapping", "CfnEventSourceMappingProps", "CfnFunction", "CfnFunctionProps", "CfnLayerVersion", "CfnLayerVersionPermission", "CfnLayerVersionPermissionProps", "CfnLayerVersionProps", "CfnParametersCode", "CfnParametersCodeProps", "CfnPermission", "CfnPermissionProps", "CfnVersion", "CfnVersionProps", "Code", "EventSourceMapping", "EventSourceMappingProps", "Function", "FunctionAttributes", "FunctionBase", "FunctionProps", "IEventSource", "IFunction", "ILayerVersion", "InlineCode", "LambdaRuntimeProps", "LayerVersion", "LayerVersionAttributes", "LayerVersionProps", "LayerVersionUsageGrantee", "LogRetention", "LogRetentionProps", "Permission", "Runtime", "RuntimeFamily", "S3Code", "SingletonFunction", "SingletonFunctionProps", "SingletonLayerVersion", "SingletonLayerVersionProps", "StartingPosition", "Tracing", "Version", "VersionProps", "VersionWeight", "__jsii_assembly__"]
