...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-lambda", "0.32.0", __name__, "aws-lambda@0.32.0.jsii.tgz")
...
class IFunction(aws_cdk.cdk.IResource, aws_cdk.aws_logs.ILogSubscriptionDestination, aws_cdk.aws_s3_notifications.IBucketNotificationDestination, aws_cdk.aws_ec2.IConnectable, aws_cdk.aws_iam.IGrantable, jsii.compat.Protocol):
    @staticmethod
    def __jsii_proxy_class__():
...
class _IFunctionProxy(jsii.proxy_for(aws_cdk.cdk.IResource), jsii.proxy_for(aws_cdk.aws_logs.ILogSubscriptionDestination), jsii.proxy_for(aws_cdk.aws_s3_notifications.IBucketNotificationDestination), jsii.proxy_for(aws_cdk.aws_ec2.IConnectable), jsii.proxy_for(aws_cdk.aws_iam.IGrantable)):
