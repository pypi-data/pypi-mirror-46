...
class Page(object):
    ...
    def __init__(self, id=None, block_order=None, blocks=None, client_id=None, colors=None, dt_u=None, filter_excludes=None, filters=None, section_title=None, section_title_template=None, slug=None, sub_nav=None, title=None, title_template=None, use_druid=None, user_id=None, views=None, widgets=None):  # noqa: E501
