...
class AggregationParameterizedTask(object):
    ...
    def __init__(self, dataset=None, date_dimension=None, dimensions=None, filters=None, granularity=None, joins=None, metrics=None, post_filters=None, post_transforms=None, segment=None, transforms=None):  # noqa: E501
