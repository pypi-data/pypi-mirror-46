...
class DataView(object):
    ...
    def __init__(self, all_dimensions=None, client_id=None, dataset=None, dimensions=None, filters=None, granularity=None, limit=None, metrics=None, mode=None, sort=None):  # noqa: E501
