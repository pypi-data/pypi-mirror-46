...
class AggregationTaskMetric(object):
    ...
    def __init__(self, average=None, avg=None, collect=None, collect_set=None, count=None, count_distinct=None, count_distinct_approx=None, cumulative=None, cumulative_count=None, cumulative_sum=None, implode=None, kurtosis=None, min=None, sample_standard_deviation=None, sample_stddev=None, skewness=None, standard_deviation=None, stddev=None, sum=None, variance=None):  # noqa: E501
