...
class ClientSso(object):
    ...
    def __init__(self, auth_code_url=None, claims=None, client_id=None, id_issuer=None, prompt=None, redirect_uri=None, secret=None, token_authentication_method=None, token_exchange_url=None, type=None):  # noqa: E501
