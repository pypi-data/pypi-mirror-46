...
class DefaultApi(object):
    ...
    def delete_activity_by_key(self, external_key, client_id, integration_id, **kwargs):  # noqa: E501
        """Hard delete an activity by external key  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_activity_by_key(external_key, client_id, integration_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_activity_by_key_with_http_info(external_key, client_id, integration_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_activity_by_key_with_http_info(external_key, client_id, integration_id, **kwargs)  # noqa: E501
            return data

    def delete_activity_by_key_with_http_info(self, external_key, client_id, integration_id, **kwargs):  # noqa: E501
        """Hard delete an activity by external key  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_activity_by_key_with_http_info(external_key, client_id, integration_id, async_req=True)
        >>> result = thread.get()
