...
def newsolution(name=None, suffix_enable=False):
    """
    ...
    Args:
        ...
        suffix_enable: True if suffixes are added to project names to denote
    ...
    solution.suffix_enable = suffix_enable
    return solution

########################################


def newproject(name=None, project_type_name=None, suffix_enable=False):
    """
    ...
    Args:
        ...
        project_type_name: Kind of project to make 'tool', 'app', 'library',
    ...
    project = Project(name=name, project_type_name=project_type_name)
    project.suffix_enable = suffix_enable
    return project
