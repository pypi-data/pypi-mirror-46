    ...
    for configuration in solution.projects[0].configurations:
        ...
        if alllists or liblist:
            ...
            for item in alllists:
                ...
                # Add to file group
                codewarriorprojectfile.addtogroups(solution.projects[0].platform, configuration, parts)

            filelist = sorted(filelist, key=unicode.lower)
            for item in filelist:
                target.filelist.append(FILE(solution.projects[0].platform, configuration, item))
            ...
            for item in liblist:
                ...
                codewarriorprojectfile.addtogroups(
                    solution.projects[0].platform, configuration, [
                        'Libraries', item])
