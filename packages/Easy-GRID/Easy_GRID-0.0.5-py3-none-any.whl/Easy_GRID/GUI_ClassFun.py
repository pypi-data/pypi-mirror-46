...
def magnifying_glass(widget, pos, area=300, zoom=4):
    size = int(area/zoom)
    ...
    painter.setPen(pen)
    # define rect
    rect = QRect(0, 0, int(area), int(area))
    rect.translate(pixmap.rect().center()-rect.center())
    # draw rect
    ...
    line1.translate(pixmap.rect().center()-QPoint(0,0))
    line2.translate(pixmap.rect().center()-QPoint(0,0))
    # draw lines
