...
data=[
    ##包含招标,需求
    ["zfcg_zhaobiao_gg","http://www.jmzfcg.com/article.php?act=list&typeid=3&page=1",["name","ggstart_time","href",'info'],f1,f2],
    ["zfcg_gqita_da_bian_gg","http://www.jmzfcg.com/article.php?act=list&typeid=4&page=1",["name","ggstart_time","href",'info'],f1,f2],
