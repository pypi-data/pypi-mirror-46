...
GATEWAY_MODELS = ['gateway','gateway.v2', 'gateway.mieu01', 'acpartner.v3']


class LumiGatewayDiscovery:
    """PyXiami."""
        ...
        try:
            ...
            while True:
                ...
                if disabled:
                    ...
                    self.gateways[ip_add] = LumiGateway(
...
class LumiGateway:
    ...
    def _discover_devices(self):
        ...
        device_types = {
            'sensor': ['sensor_ht', 'gateway', 'gateway.mieu01','gateway.v3', 'weather',
            ...
            'light': ['gateway', 'gateway.v3', 'gateway.mieu01'],
            'cover': ['curtain'],
