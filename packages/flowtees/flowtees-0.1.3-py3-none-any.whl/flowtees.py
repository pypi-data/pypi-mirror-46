...
@click.command()
@click.option('--react-namespace', nargs=1, type=bool, default=True, show_default=True, help='This sets whether React import statements should be converted to a namespace import.')
@click.argument('component_dir')
def main(component_dir: str, react_namespace: bool):
