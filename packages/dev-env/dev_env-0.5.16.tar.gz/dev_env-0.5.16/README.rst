...
-  take a look at the `shell and python scripts <bin>`__ to assess
   ``dev-env`` capability
-  `here's <https://github.com/simonsdave/dev-env/tree/release-0.5.16/docs/using.md>`__
...
-  if you'd like to help contribute to ``dev-env`` see
   `this <https://github.com/simonsdave/dev-env/tree/release-0.5.16/docs/contributing.md>`__
