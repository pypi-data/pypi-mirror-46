...
class Pipeline:
    ...
    def get_context(self, key: str, default_value=None, deserializer=dill.loads):
        ...
        :param key: the key for the context to get
        :param default_value: an optional parameter, a default value to return if the context for the given key is not found 
        :return: the context for the given key, if it exists, otherwise the default value, or none.
        """
    ...
    def add_dependency(self, pipeline):
        ...
        :param pipeline: pipeline on which this pipeline depends
        """
    ...
    def from_pipeline(self, pipeline):
        ...
        :param pipeline: pipeline from which to copy this pipeline
        """
