...
def decode_JWT(*args, verify):
    ...
    jwt exceptions.
    """
    invalidTokenMsg = 'Your Cortex Token is invalid.  Refer to https://docs.cortex.insights.ai/docs/cortex-tools/access/ for more information.'
    expiredTokenMsg = 'Your Cortex Token has expired.  Refer to https://docs.cortex.insights.ai/docs/cortex-tools/access/ for more information.'
    try:
