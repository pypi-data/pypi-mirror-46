...
def derive_entity_event_attributes_for_each_interaction(interactions_df, insights_df, conceptTypesToConsider:str, df_timeframe:str="eternally") -> List[ObservedProfileAttribute]:
    ...
    attribute_value_constructor = lambda x: EntityAttributeValue(value=EntityEvent(
        event=implicit_attributes.NameTemplates.ENTITY_INTERACTION_INSTANCE.format(**pydash.merge({implicit_templates.TIMEFRAME: df_timeframe}, x)),
