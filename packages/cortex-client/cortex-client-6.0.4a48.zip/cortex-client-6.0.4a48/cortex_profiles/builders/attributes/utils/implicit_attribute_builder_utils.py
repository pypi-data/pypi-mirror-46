...
def derive_implicit_attributes_from_timeranged_dataframes(
        timerange:str, insights_df: pd.DataFrame, interactions_df: pd.DataFrame, sessions_df: pd.DataFrame,
    ...
    return flatten_list_recursively([
        ...
        implicit_login_attribute_builders.derive_statistical_summary_for_daily_login_counts(sessions_df, timerange),
        implicit_login_attribute_builders.derive_statistical_summary_for_daily_login_durations(sessions_df, timerange),
    ] + [
        implicit_insight_attribute_builders.derive_entity_event_attributes_for_each_interaction(interactions_df, insights_df, cType, timerange)
