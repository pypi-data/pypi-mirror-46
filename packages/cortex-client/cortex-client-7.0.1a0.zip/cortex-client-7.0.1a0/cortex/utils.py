...
def decodeJWT(*args, verify):
    """
    thin wrapper around jwt.decode. This function exists for better error handling of the
    jwt exceptions.
    """
    invalidTokenMsg = 'Your Cortex Token is invalid.  Refer to https://docs.cortex-dev.insights.ai/docs/cortex-tools/access/ for more information.'
    expiredTokenMsg = 'Your Cortex Token is invalid.  Refer to https://docs.cortex-dev.insights.ai/docs/cortex-tools/access/ for more information.'
    try:
        ...
        if not decodedJWT['tenant'] and not decodedJWT['sub']:
