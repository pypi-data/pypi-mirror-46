...
class ClickhouseDriver(object):
    ...
    def get_data(self, df, dtypes, has_header=True, nullable_list=None, user_dtype=None):
        ...
        user_dtype_vals_lower = [self.clean_col_name(v) for v in user_dtype.values()]
        ...
        if not nullable_list and not dtypes_has_int:
            ...
            int_col_names = [col_name for col_name, kind in user_dtype.items() if self.clean_col_name(kind) in int_col_types]
