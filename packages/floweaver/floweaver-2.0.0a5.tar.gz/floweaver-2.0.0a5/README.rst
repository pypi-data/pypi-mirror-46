...
<https://mybinder.org/v2/gh/ricklupton/floweaver/master?filepath=docs%2Ftutorials%2Fquickstart.ipynb>`__.
...
To get started, open the `quickstart tutorial <docs/tutorials/quickstart.ipynb>`__ in
