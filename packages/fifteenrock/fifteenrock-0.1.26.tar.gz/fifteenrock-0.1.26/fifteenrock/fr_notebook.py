...
#             result = deploy(credentials=credentials, credentials_path=credentials_path, main_file=str(module_path),
...
def deploy_notebook(project: str, function: str, url: str = None, dependencies: List = None,
                    credentials: Dict = None, credentials_path: str = None,
    ...
    if is_notebook():
        ...
        requirements_file = str(util.make_requirements_file_notebook(tmp_dir))
