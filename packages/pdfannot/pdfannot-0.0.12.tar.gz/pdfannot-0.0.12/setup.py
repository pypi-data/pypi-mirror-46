...
setup(name="pdfannot",
      ...
      package_data={'': ['ressources/pdf_annot_3_output.xlsx', # TODO : add those ressources in the install packages
                         'ressources/pdf_test_annot.pdf',
                         'test_ressources/pdf_test_annot.pdf',
