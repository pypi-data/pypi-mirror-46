...
`This <https://github.com/simonsdave/cloudfeaster/tree/release-0.9.18/docs/story.md>`__
is the story behind Cloudfeaster.

What Next
---------

-  `this <https://github.com/simonsdave/cloudfeaster/tree/release-0.9.18/docs/spider_authors.md>`__
   describes how to author spiders using Cloudfeaster
-  see
   `these <https://github.com/simonsdave/cloudfeaster/tree/release-0.9.18/docs/contributing.md>`__
...
.. |CircleCI| image:: https://circleci.com/gh/simonsdave/cloudfeaster/tree/release-0.9.18.svg?style=shield
   :target: https://circleci.com/gh/simonsdave/cloudfeaster/tree/release-0.9.18
