...
id = "a5dc03abae44ddffd13827a0cba5e7b86c024fbd"
date = "2019-05-20 10:55:31 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "a5dc03abae44ddffd13827a0cba5e7b86c024fbd":
        return
    msg = "Program id (a5dc03abae44ddffd13827a0cba5e7b86c024fbd) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
