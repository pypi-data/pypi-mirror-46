...
id = "d2f6cf477d78fc6be6ca723e575a140d7411d912"
date = "2019-05-6 23:28:44 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "d2f6cf477d78fc6be6ca723e575a140d7411d912":
        return
    msg = "Program id (d2f6cf477d78fc6be6ca723e575a140d7411d912) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
