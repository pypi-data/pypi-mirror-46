...
id = "88746d635de4a491f14fcfd73be6b3f522e784dd"
date = "2019-05-24 17:19:21 +0000"
branch = "None"
tag = "lalsuite-v6.57"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "88746d635de4a491f14fcfd73be6b3f522e784dd":
        return
    msg = "Program id (88746d635de4a491f14fcfd73be6b3f522e784dd) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
