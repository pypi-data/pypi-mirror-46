...
id = "eeb0ed3fbc72fc97a8186437255a0d93ea349584"
date = "2019-05-22 16:48:05 +0000"
branch = "None"
tag = "lalsuite-v6.55"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "eeb0ed3fbc72fc97a8186437255a0d93ea349584":
        return
    msg = "Program id (eeb0ed3fbc72fc97a8186437255a0d93ea349584) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
