...
id = "bc939b4fdd39e73fa82b0c4581cc33f9ac32981b"
date = "2019-05-17 15:31:14 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "bc939b4fdd39e73fa82b0c4581cc33f9ac32981b":
        return
    msg = "Program id (bc939b4fdd39e73fa82b0c4581cc33f9ac32981b) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
