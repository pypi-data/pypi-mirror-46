...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-kinesis", "0.31.0", __name__, "aws-kinesis@0.31.0.jsii.tgz")
...
class IStream(aws_cdk.cdk.IResource, aws_cdk.aws_logs.ILogSubscriptionDestination, jsii.compat.Protocol):
    ...
    def export(self) -> "StreamAttributes":
...
class Stream(aws_cdk.cdk.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-kinesis.Stream"):
    ...
    @classmethod
    def from_stream_attributes(cls, scope: aws_cdk.cdk.Construct, id: str, *, stream_arn: str, encryption_key: typing.Optional[aws_cdk.aws_kms.EncryptionKeyImportProps]=None) -> "IStream":
