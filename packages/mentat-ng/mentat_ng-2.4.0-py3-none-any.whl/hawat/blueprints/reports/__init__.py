    ...
    def authorize_item_action(cls, item):
        ...
        *Interface implementation* of :py:func:`hawat.base.ItemShowView.authorize_item_action`.
        ...
        permission_mm = flask_principal.Permission(
            ...
            hawat.acl.ManagementNeed(item.group.id)
        )
    ...
    def get_action_menu(cls):
        ...
        *Interface implementation* of :py:func:`hawat.base.ItemShowView.get_action_menu`.
        ...
        action_menu.add_entry(
            ...
            legend = lambda x: lazy_gettext('Search for all events related to report &quot;%(item)s&quot;', item = x.label),
            link = lambda x: flask.url_for('events.search', **build_related_search_params(x))
        )
        action_menu.add_entry(
            'endpoint',
            'delete',
        ...
        action_menu.add_entry(
            ...
            link = lambda x: flask.url_for('reports.data', fileid = x.label, filetype = 'json'),
        ...
        action_menu.add_entry(
            ...
            link = lambda x: flask.url_for('reports.data', fileid = x.label, filetype = 'csv'),
            hidelegend = True
        )
        action_menu.add_entry(
            'endpoint',
            ...
            link = lambda x: flask.url_for('reports.data', fileid = x.label, filetype = 'jsonzip'),
        ...
        action_menu.add_entry(
            ...
            link = lambda x: flask.url_for('reports.data', fileid = x.label, filetype = 'csvzip'),
            icon = 'action-download-zip',
            hidelegend = True
        )
        return action_menu
    ...
    def do_after_search(self, items):
        ...
        *Interface implementation* of :py:func:`hawat.base.SearchView.do_after_search`.
        ...
        if items:
            ...
            self.response_context.update(
                statistics = mentat.stats.idea.aggregate_stats_reports(items, dt_from, dt_to)
            )
...
class DeleteView(HTMLMixin, SQLAlchemyMixin, ItemDeleteView):  # pylint: disable=locally-disabled,too-many-ancestors
    ...
    def get_menu_legend(cls, item = None):
        ...
        *Interface implementation* of :py:func:`hawat.base.BaseView.get_menu_legend`.
        """
        return lazy_gettext('Delete event report &quot;%(item)s&quot;', item = str(item))
    ...
    def register_app(self, app):
        ...
        * application menu customization
        ...
        app.set_csag(
            ...
            SearchView,
            URLParamsBuilder({'submit': 'Search'}).add_rule('groups', True)
        )
