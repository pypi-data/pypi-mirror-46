...
class TestMentatStatsIdea(unittest.TestCase):
    ...
    def test_02_make_toplist(self):
        ...
        self.assertEqual(mentat.stats.idea._make_toplist(test2, 'detectors', 5), {  # pylint: disable=locally-disabled,protected-access
            'detectors': {
                '__REST__': 55,
                'org.example.dionaea': 5,
                'org.example.kryten': 10,
    ...
    def test_06_truncate_stats(self):
        ...
        self.assertEqual(
            mentat.stats.idea.truncate_stats(mentat.stats.idea.evaluate_events(self.ideas_raw), 3),
            {
                'abuses': {'__unknown__': 2, 'abuse@cesnet.cz': 4},
