...
class GeometryServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GeometryOperationUnary = channel.unary_unary(
        ...
        request_serializer=epl_dot_protobuf_dot_geometry__service__pb2.GeometryRequest.SerializeToString,
        response_deserializer=epl_dot_protobuf_dot_geometry__service__pb2.GeometryResponse.FromString,
        )
    ...
    self.FileOperationBiStreamFlow = channel.stream_stream(
        ...
        request_serializer=epl_dot_protobuf_dot_geometry__service__pb2.FileRequestChunk.SerializeToString,
        response_deserializer=epl_dot_protobuf_dot_geometry__service__pb2.GeometryResponse.FromString,
        )
...
def add_GeometryServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'GeometryOperationUnary': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=epl_dot_protobuf_dot_geometry__service__pb2.GeometryRequest.FromString,
          response_serializer=epl_dot_protobuf_dot_geometry__service__pb2.GeometryResponse.SerializeToString,
      ),
      ...
      'FileOperationBiStreamFlow': grpc.stream_stream_rpc_method_handler(
          ...
          request_deserializer=epl_dot_protobuf_dot_geometry__service__pb2.FileRequestChunk.FromString,
          response_serializer=epl_dot_protobuf_dot_geometry__service__pb2.GeometryResponse.SerializeToString,
      ),
  }
