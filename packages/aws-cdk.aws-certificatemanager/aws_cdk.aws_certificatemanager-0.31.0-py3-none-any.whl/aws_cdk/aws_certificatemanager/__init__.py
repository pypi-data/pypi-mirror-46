...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-certificatemanager", "0.31.0", __name__, "aws-certificatemanager@0.31.0.jsii.tgz")
@jsii.data_type(jsii_type="@aws-cdk/aws-certificatemanager.CertificateAttributes", jsii_struct_bases=[])
class CertificateAttributes(jsii.compat.TypedDict):
...
class ICertificate(aws_cdk.cdk.IResource, jsii.compat.Protocol):
    ...
    def export(self) -> "CertificateAttributes":
...
__all__ = ["Certificate", "CertificateAttributes", "CertificateProps", "CfnCertificate", "CfnCertificateProps", "DnsValidatedCertificate", "DnsValidatedCertificateProps", "ICertificate", "__jsii_assembly__"]
