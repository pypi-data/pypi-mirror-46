...
class FastText:
            ...
            model = Sequential(
                [
                    ...
                    Embedding(
                        ...
                        embeddings_initializer=keras.initializers.RandomUniform(seed=17)
                    ),
                    Bidirectional(LSTM(
                            50, 
                            return_sequences=True,
                            kernel_initializer=keras.initializers.glorot_uniform(seed=17),
                            recurrent_initializer=keras.initializers.Orthogonal(seed=17)
                        )
                    ),
                    GlobalMaxPool1D(),
                    Dropout(0.3, seed=17),
    ...
    def train(
        ...
        kerasboard = TensorBoard(log_dir="/tmp/tensorboard/{}".format(time_stamp),
