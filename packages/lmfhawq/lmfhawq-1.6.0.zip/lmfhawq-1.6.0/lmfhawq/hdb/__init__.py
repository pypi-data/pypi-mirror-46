import lmfhawq.hdb.zl as src 

import lmfhawq.hdb.zldb as v 

from lmfhawq.hdb.data import zhulong_diqu_dict
...
src_add_quyu2=src.add_quyu_fast2


src_drop_quyu2=src.drop_quyu_fast2
src_add_quyu3=src.add_quyu_fast3
