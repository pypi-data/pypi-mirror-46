...
def add_dependency(packl_path, dependency_name, comments, as_extra=None):
    '''
    ...
    if as_extra:
        add_to_setup_md(
            packl_path, comments, as_extra, dependency_name, 'extra_requires'
        )
    else:
        add_to_setup_md(
            packl_path, comments, 'install_requires', dependency_name
        )
