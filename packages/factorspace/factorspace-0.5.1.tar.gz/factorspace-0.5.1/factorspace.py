...
#差转算法
def sub_rotate(train_data,train_label,none_value=-1,train_times=100,used_factors=False,fast=False,rule_weight=False):
...
#因素分析法
def factor_analy(train_data,train_label,last_rules_set=[],none_value=-1,train_times=-1,used_factors=False,zero_decide_random=False,rule_weight=False,strict=False):
