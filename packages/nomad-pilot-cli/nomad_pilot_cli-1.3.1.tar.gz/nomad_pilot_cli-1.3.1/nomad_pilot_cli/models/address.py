...
class Address(object):
    ...
    def __init__(self, first_name=None, last_name=None, address1=None, address2=None, city=None, state=None, country=None, zip=None, tin=None, phone=None, country_code=None, id_card=None, email=None, company=None):  # noqa: E501
