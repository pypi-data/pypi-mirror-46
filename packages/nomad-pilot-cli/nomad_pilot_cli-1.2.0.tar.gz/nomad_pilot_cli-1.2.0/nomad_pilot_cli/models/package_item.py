...
class PackageItem(object):
    ...
    def __init__(self, name=None, barcode=None, sku_number=None, quantity=None, price=None, brand=None, quantity_uom=None, hs_code=None, country_of_origin=None, goldjet=None, gross_weight=None, net_weight=None):  # noqa: E501
