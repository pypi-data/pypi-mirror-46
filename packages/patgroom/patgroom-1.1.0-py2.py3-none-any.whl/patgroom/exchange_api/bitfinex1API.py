...
Public:
    candles   获取K线数据
Private：
    wattels    获取exchange,margin,fund等账户信息
"""
...
# info = string2timestamp('2018-08-17 06:03:00')
# print(info)
# date1 = timestamp_to_Localtime(1534526760000 / 1000)
# # date2 = timestamp2datetime(1534485780000 / 1000)
# print(date1)
# exit()
# # print(date2)
...
class EndpointsMixin(object):
    # Public API #######################################################
    @tryagain(sleep_second=2, retry=3)
    ...
    # Positions
    @tryagain(sleep_second=5, retry=3)
...
class BitfinexV1API(EndpointsMixin, object):
...
# bfx1 = BitfinexV1API(environment="live", key=KEY, secret_key=SECRET)
# # info = bfx1.ticker(symbol='BTCUSD')
# info = bfx1.wallet_balances()
# print(info)
