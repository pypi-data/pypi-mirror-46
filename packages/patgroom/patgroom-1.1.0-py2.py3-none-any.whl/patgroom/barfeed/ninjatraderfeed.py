...
# import patgroom.barfeed
# from patgroom.barfeed import csvfeed
# from patgroom import bar
...
class Frequency(object):
    MINUTE = patgroom.bar.Frequency.MINUTE
    DAILY = patgroom.bar.Frequency.DAY
...
class RowParser(csvfeed.RowParser):
    ...
    def __parseDateTime(self, dateTime):
        ret = None
        if self.__frequency == patgroom.bar.Frequency.MINUTE:
            ret = parse_datetime(dateTime)
        elif self.__frequency == patgroom.bar.Frequency.DAY:
...
class Feed(csvfeed.BarFeed):
    """A :class:`patgroom.barfeed.csvfeed.BarFeed` that loads bars from CSV files exported from NinjaTrader.

    :param frequency: The frequency of the bars. Only **patgroom.bar.Frequency.MINUTE** or **patgroom.bar.Frequency.DAY**
        are supported.
    :param timezone: The default timezone to use to localize bars. Check :mod:`patgroom.marketsession`.
    :type timezone: A pytz timezone.
    :param maxLen: The maximum number of values that the :class:`patgroom.dataseries.bards.BarDataSeries` will hold.
    ...
    def addBarsFromCSV(self, instrument, path, timezone=None):
        ...
        :type path: string.
        :param timezone: The timezone to use to localize bars. Check :mod:`patgroom.marketsession`.
        :type timezone: A pytz timezone.
        """
