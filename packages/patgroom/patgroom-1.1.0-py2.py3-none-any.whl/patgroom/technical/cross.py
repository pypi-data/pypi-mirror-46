...
def cross_type(values1, values2):
    assert (len(values1) == len(values2))
    if len(values1) == 2:
        crosstype = 0
        v1_1 = values1[0]
        ...
        if v1_1 is not None and v1_2 is not None and v2_1 is not None and v2_2 is not None:
            if v1_2 > v2_2 and v1_1 <= v2_1:  # 上穿
                crosstype = 1
            elif v1_2 < v2_2 and v1_1 >= v2_1:  # 下穿
                crosstype = -1
            else:
                crosstype = 0
        return crosstype
