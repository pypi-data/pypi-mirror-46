...
@click.option("-r", "--register", default=None, help="Serve a single register, otherwise serve all know registers as a catalog")
@click.option("-p", "--port", default=8088, help="port for server, defaults to 8088")
@click.option("-d", "--debug", is_flag=True, help="More verbose logging and automatically reload on changes")
