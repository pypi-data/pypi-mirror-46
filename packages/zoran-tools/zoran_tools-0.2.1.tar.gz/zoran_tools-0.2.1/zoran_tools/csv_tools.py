...
def readcsv(filename, encoding='utf8', delimiter=',', quotechar='"', li=True):
    """
...
def write_csv(filename, row_or_rows, mode='a+', encoding='utf8', newline='',
              delimiter=',', quotechar='"', quoting='all'):
    """
...
def write_csv_row(filename, row, mode='a+', encoding='utf8', newline='',
              delimiter=',', quotechar='"', quoting='all'):
    return write_csv(filename, row, mode, encoding, newline, delimiter, quotechar, quoting)


def write_csv_rows(filename, rows, mode='a+', encoding='utf8', newline='',
              delimiter=',', quotechar='"', quoting='all'):
    return write_csv(filename, rows, mode, encoding, newline, delimiter, quotechar, quoting)
