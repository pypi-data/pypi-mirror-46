...
class LocustEndpoint:
    ...
    def __init__(self, endpoint, methods, name=None, headers=None, body=None):
        ...
        # self.influx_client = InfluxDBClient('10.18.10.131', 8086, 'root', 'root', 'ubili')
    ...
    def status_check(self, request_object, t):
        ...
        # self.write_to_influx(t, self.endpoint)
    ...
    def write_to_influx(self, response_time, endpoint):
        data = [
            {
            "measurement": "endpoints",
            "fields": {
                endpoint: float(response_time)    
                        }
            }
        ]
...
class LocustEndpointCollection(object):
    ...
    def __init__(self):
        ...
        self.totals     = runners.locust_runner.stats.num_requests
