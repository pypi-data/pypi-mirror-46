...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-glue", "0.31.0", __name__, "aws-glue@0.31.0.jsii.tgz")
...
@jsii.data_type(jsii_type="@aws-cdk/aws-glue.DatabaseAttributes", jsii_struct_bases=[])
class DatabaseAttributes(jsii.compat.TypedDict):
    catalogArn: str
...
class IDatabase(aws_cdk.cdk.IResource, jsii.compat.Protocol):
    ...
    def export(self) -> "DatabaseAttributes":
        ...
...
class Database(aws_cdk.cdk.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-glue.Database"):
    ...
    @jsii.member(jsii_name="fromDatabaseAttributes")
    @classmethod
    def from_database_attributes(cls, scope: aws_cdk.cdk.Construct, id: str, *, catalog_arn: str, catalog_id: str, database_arn: str, database_name: str, location_uri: str) -> "IDatabase":
        ...
        Arguments:
            ...
            attrs: A ``DatabaseAttributes`` object. Can be obtained from a call to ``database.export()`` or manually created.
            catalogArn: -
            catalogId: -
            databaseArn: -
            databaseName: -
            locationUri: -
        """
        attrs: DatabaseAttributes = {"catalogArn": catalog_arn, "catalogId": catalog_id, "databaseArn": database_arn, "databaseName": database_name, "locationUri": location_uri}

        return jsii.sinvoke(cls, "fromDatabaseAttributes", [scope, id, attrs])
...
class ITable(aws_cdk.cdk.IResource, jsii.compat.Protocol):
    ...
    @jsii.member(jsii_name="export")
    def export(self) -> "TableAttributes":
        ...
...
class Table(aws_cdk.cdk.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-glue.Table"):
    ...
    def from_table_attributes(cls, scope: aws_cdk.cdk.Construct, id: str, *, table_arn: str, table_name: str) -> "ITable":
        ...
        Arguments:
            scope: The scope creating construct (usually ``this``).
            id: The construct's id.
            attrs: A ``TableImportProps`` object. Can be obtained from a call to ``table.export()`` or manually created.
            tableArn: -
            tableName: -
        """
