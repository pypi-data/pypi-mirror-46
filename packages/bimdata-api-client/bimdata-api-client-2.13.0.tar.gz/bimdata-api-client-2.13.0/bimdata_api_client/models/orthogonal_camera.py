...
class OrthogonalCamera(object):
    ...
    def __init__(self, view_to_world_scale=None, camera_direction=None, camera_up_vector=None, camera_view_point=None):  # noqa: E501
    ...
    def view_to_world_scale(self, view_to_world_scale):
        ...
        :type: float
        """
        if view_to_world_scale is None:
