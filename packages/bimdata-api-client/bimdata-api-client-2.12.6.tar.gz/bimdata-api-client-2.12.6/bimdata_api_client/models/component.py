...
class Component(object):
    ...
    def __init__(self, ifc_guid=None, originating_system=None, authoring_tool_id=None):  # noqa: E501
    ...
    def ifc_guid(self, ifc_guid):
        ...
        :type: str
        """
        if ifc_guid is not None and len(ifc_guid) > 255:
    ...
    def originating_system(self, originating_system):
        ...
        :type: str
        """
        if originating_system is not None and len(originating_system) > 255:
    ...
    def authoring_tool_id(self, authoring_tool_id):
        ...
        :type: str
        """
        if authoring_tool_id is not None and len(authoring_tool_id) > 255:
