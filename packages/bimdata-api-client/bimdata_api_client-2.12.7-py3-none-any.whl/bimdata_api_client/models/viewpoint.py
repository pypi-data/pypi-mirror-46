...
class Viewpoint(object):
    ...
    def __init__(self, index=None, guid=None, orthogonal_camera=None, perspective_camera=None, lines=None, clipping_planes=None, snapshot=None, components=None, temp_id=None):  # noqa: E501
