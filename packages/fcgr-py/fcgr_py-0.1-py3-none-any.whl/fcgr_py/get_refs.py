...
def get_human_ref(path = "/Volumes/dusom_dhvi_bigdata/Tomaras_P01/Pacbio/Reference_Sequences/trimmed_references/Human_FCGRs_References_TRIMMED_nt.fasta"):
...
def get_rhesus_ref(path= "/Volumes/dusom_dhvi_bigdata/Tomaras_P01/Pacbio/Reference_Sequences/trimmed_references/Rhesus_FCGRs_References_nt.fasta"):
