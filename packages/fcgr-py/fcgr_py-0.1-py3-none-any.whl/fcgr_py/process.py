...
def fcgr_pipeline(input_dir, fastq_name, output_dir, order_num, pool_num=1, barcode_names = 'barcode_names.txt', threshold = .99):
    ...
    human_ref = get_refs.get_human_ref()
    rhesus_ref = get_refs.get_rhesus_ref()
