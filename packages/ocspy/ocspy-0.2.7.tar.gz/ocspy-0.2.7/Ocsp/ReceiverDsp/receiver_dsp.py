...
def superscalar(symbol_in, training_symbol, block_length, pilot_number, constl,g):
    ...
    divided_training_symbols[1::2,:] = divided_training_symbols[1::2,::-1]
...
def first_order_pll(divided_symbols, constl,g):
    ...
    for i in range(divided_symbols.shape[0]):
