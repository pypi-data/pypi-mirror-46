...
#
# Description:
# Processes PDB files similar to charmmlipid2amber.py, but removing hydrogens
# correcting atoms and adding TER lines that can problematic when using tleap
#############################################################################
...
if __name__ == '__main__':
    ...
    for line in output_file_list:
        if line.startswith(('ATOM', 'HETATM')):
            ...
            if resname != resname_last:
                resum_new = (resum_new+1)%100000
            # add TER lines if needed
            ...
            line_new = line[:12] + atomname_new + line[16:22] + resum_new_str + line[27:]
