...
def make_pipeline(
    ...
    phase1 = ParallelHyperModelFixedPhase(
        phase_name='phase_1_noise_scaling', phase_folders=phase_folders, tag_phases=tag_phases,
    ...
    phase2 = ParallelHyperFixedPhase(
        phase_name='phase_2_parallel_x2_end', phase_folders=phase_folders, tag_phases=tag_phases,
        parallel_species=[prior_model.PriorModel(arctic_params.Species),
                          prior_model.PriorModel(arctic_params.Species)],
        parallel_ccd=arctic_params.CCD,
        mask_function=mask_function,
