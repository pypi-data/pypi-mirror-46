...
pipeline_init = parallel_x3.make_pipeline(phase_folders=[ci_data_type, ci_data_model + '_b', ci_data_resolution],
                                     mask_function=mask_function_for_bug)

from workspace_jam.pipelines.normal.from_initialize import parallel_x3

pipeline_normal = parallel_x3.make_pipeline(phase_folders=[ci_data_type, ci_data_model + '_b', ci_data_resolution],
                                     mask_function=mask_function_for_bug)
