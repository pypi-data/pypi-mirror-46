...
pipeline_init = parallel_x3.make_pipeline(phase_folders=[ci_data_type, ci_data_model + '_a', ci_data_resolution],
...
pipeline_normal = parallel_x3.make_pipeline(phase_folders=[ci_data_type, ci_data_model + '_a', ci_data_resolution],
                                     mask_function=mask_function_for_bug, cosmic_ray_parallel_buffer=10,
                                     cosmic_ray_serial_buffer=10, cosmic_ray_diagonal_buffer=3)
