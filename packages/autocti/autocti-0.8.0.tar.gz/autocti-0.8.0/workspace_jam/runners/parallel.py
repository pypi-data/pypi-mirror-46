...
instance = pipeline_normal.phases[0].variable.instance_from_physical_vector(physical_vector=[0.5, 0.5, 0.5, 0.5, 0.6, 0.7, 0.8, 0.9])
print(instance.parallel_ccd.well_fill_alpha)
print(instance.parallel_ccd.well_fill_beta)
print(instance.parallel_ccd.well_fill_gamma)
stop
