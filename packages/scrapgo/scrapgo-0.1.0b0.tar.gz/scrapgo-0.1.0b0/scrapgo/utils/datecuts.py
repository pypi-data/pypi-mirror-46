...
def slice_date_range(start_date, end_date, by='year', interval=1, fmt=DATESTR_FMT):
    ...
    date_list = list(rrule(
        freq=freq, dtstart=ini_start_date,
        until=fin_end_date, interval=interval
    ))
