...
Usage:
  ...
  odoo-manager -h | --help
  odoo-manager convert [--source=<file>] [--from=<file_type>] [--to=<file_type>] [--dest=<file>] [--append] [--install] [-v | --verbose]
  odoo-manager format [--source=<directory_or_file>] [-v | --verbose]
  odoo-manager hello
...
Examples:
  odoo-manager hello
  odoo-manager format
  odoo-manager format -s my_module
  odoo-manager convert -s my_module/readme.md -d my_module/static/description/index.html
"""
