...
class CargoService(Service):
    ...
    def getCargoInformation(self, saleCode: str, lang: str = 'en') -> json:
        if saleCode is None or not saleCode.startswith("SC"):
            raise KeyError("Sale Code is not Valid!")
...
class ProductService(Service):
    ...
    def getProduct(self, lang: str, product_id: str) -> json:
        url = "{}&id=productId&value={}".format(self.requestURL('getProduct', 'json', 'json', lang), product_id)
        return self.session.get(url).json()

    def getProducts(self, startOffSet:int =0, rowCount:int =100, status:str ='A', withData=False, lang: str = 'en') -> json:
        if rowCount > 100:
            rowCount = 100
...
class SaleService(Service):
    ...
    def getSoldItems(self, startOffset:int =0, rowCount:int =100, withData=False, byStatus='S', lang: str = 'en') -> json:
        if rowCount > 100:
            rowCount = 100
    ...
    def getActiveSales(self, startOffset:int =0, rowCount:int =100, withData=False, lang: str = 'en') -> json:
        if rowCount > 100:
            rowCount = 100
    ...
    def getUnsoldItems(self, startOffset:int =0, rowCount:int =100, withData=False, lang: str = 'en') -> json:
        if rowCount > 100:
            rowCount = 100
        url = "{}&startOffSet={}&rowCount={}&withData={}".format(
    ...
    def getWonItems(self, startOffset:int =0, rowCount:int =100, withData=False, lang: str = 'en') -> json:
        if rowCount > 100:
            rowCount = 100
        url = "{}&startOffSet={}&rowCount={}&withData={}".format(
    ...
    def getBidItems(self, startOffset:int =0, rowCount:int =100, withData=False, lang: str = 'en') -> json:
        if rowCount > 100:
            rowCount = 100
        url = "{}&startOffSet={}&rowCount={}&withData={}".format(
    ...
    def getWatchItems(self, startOffset:int =0, rowCount:int =100, withData=False, lang: str = 'en') -> json:
        if rowCount > 100:
            rowCount = 100
        url = "{}&startOffSet={}&rowCount={}&withData={}".format(
    ...
    def getDidntWinItems(self, startOffset:int =0, rowCount:int =100, withData=False, lang: str = 'en') -> json:
        if rowCount > 100:
            rowCount = 100
        url = "{}&startOffSet={}&rowCount={}&withData={}".format(
    ...
    def getSale(self, sale_code: str, lang: str = 'en') -> json:
        if sale_code is None or not sale_code.startswith("SC"):
            raise KeyError("Sale Code is not Valid!")
        url = "{}&saleCode={}".format(self.requestURL('getSale', 'json', 'json', lang), sale_code)
        return self.session.get(url).json()
...
class UserMessageService(Service):
    ...
    def getInboxMessages(self, startOffset:int =0, rowCount:int =100, unread=False, lang: str = 'en') -> json:
        if rowCount > 100:
            rowCount = 100
    ...
    def sendNewMessage(self, to:str, title:str, content:str, sendCopy=False, lang: str = 'en'):
        req = {
            "to": to,
            "title": title,
    ...
    def getSendedMessages(self, startOffset:int =0, rowCount:int =100, lang: str = 'en') -> json:
        if rowCount > 100:
            rowCount = 100
