...
@click.option('--registry-url', prompt=True, default='$CI_REGISTRY')
@click.option('--registry-user', prompt=True, default='$CI_REGISTRY_USER')
@click.option('--registry-password', prompt=True, default='$CI_REGISTRY_PASSWORD')
