...
@click.option('--registry-password', prompt=True, hide_input=True)
@click.option('--enable-db', prompt=True, is_flag=True, default=False)
@click.option('--force', is_flag=True, default=False)
def create(project_name, registry_image, registry_url, registry_user, registry_password, enable_db, force):
