...
bootstrap_css = os.path.join(static_path, "bootstrap", "3.3.5", "css", "bootstrap.min.css")
font_awesome_css = os.path.join(static_path, "font-awesome", "4.4.0", "css", "font-awesome.min.css")
animate_css = os.path.join(static_path, "animate.css", "3.5.2", "animate.min.css")
chosen_css = os.path.join(static_path, "chosen", "1.8.2", "chosen.css")

jquery = os.path.join(static_path, "jquery", "2.1.4", "jquery.min.js")
bootstrap_js = os.path.join(static_path, "bootstrap", "3.3.5", "js", "bootstrap.min.js")
echarts_js = os.path.join(static_path, "echarts", "3.8.5", "echarts.min.js")
chosen_js = os.path.join(static_path, "chosen", "1.8.2", "chosen.jquery.js")
...
<head>
    ...
    <title>测试报告</title>""" \
    + """<link href="{}" rel="stylesheet">""".format(bootstrap_css) \
    + """<link href="{}" rel="stylesheet">""".format(font_awesome_css) \
    + """<link href="{}" rel="stylesheet">""".format(animate_css) \
    + """<link href="{}" rel="stylesheet">""".format(chosen_css) \
    + r"""
    <base target="_blank">
    <style type="text/css">
        pre {
...
+ """<script src="{}"></script>""".format(jquery) \
+ """<script src="{}"></script>""".format(bootstrap_js) \
+ """<script src="{}"></script>""".format(echarts_js) \
+ """<script src="{}"></script>""".format(chosen_js) \
+ r"""
