...
async def load_from_server(interpreter: Optional[NaturalLanguageInterpreter] = None,
...
class Agent(object):
    ...
    async def execute_action(
        ...
        dispatcher = Dispatcher(sender_id,
                                output_channel,
                                self.nlg)
        return await processor.execute_action(sender_id, action, dispatcher, policy,
                                              confidence)
