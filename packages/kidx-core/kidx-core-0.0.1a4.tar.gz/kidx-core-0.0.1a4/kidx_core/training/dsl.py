...
from kidx_core.exceptions import StoryParseError
from kidx_core.interpreter import RegexInterpreter
from kidx_core.training.structures import (
...
class EndToEndReader(MarkdownReader):
    def _parse_item(self, line: Text) -> Optional[Message]:
        ...
        syntax of <example> see the Kidx NLU docs on training data:
        ...
        raise ValueError("Encountered invalid end-to-end format for message "
                         ...
                         "evaluation#end-to-end-evaluation-of-kidx-nlu-and-"
                         "core".format(line))
