...
from kidx_core.actions.action import (ACTION_REVERT_FALLBACK_EVENTS_NAME,
                                      ACTION_DEFAULT_FALLBACK_NAME,
                                      ACTION_DEFAULT_ASK_REPHRASE_NAME,
                                      ACTION_DEFAULT_ASK_AFFIRMATION_NAME,
                                      ACTION_LISTEN_NAME)
from kidx_core.constants import FALLBACK_SCORE, USER_INTENT_OUT_OF_SCOPE
from kidx_core.domain import Domain, InvalidDomain
from kidx_core.policies.fallback import FallbackPolicy
from kidx_core.policies.policy import confidence_scores_for
...
class TwoStageFallbackPolicy(FallbackPolicy):
    ...
    def __init__(self,
        ...
        Args:
            ...
            deny_suggestion_intent_name: The name of the intent which is
                used to detect that the user denies the suggested intents.
        """
    ...
    def predict_action_probabilities(self,
        ...
        if self._is_user_input_expected(tracker):
            ...
            logger.debug("User '{}' rephrased intent"
