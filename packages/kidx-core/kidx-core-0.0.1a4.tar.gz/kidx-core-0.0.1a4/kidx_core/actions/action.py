...
class Action(object):
    ...
    async def run(self, dispatcher: 'Dispatcher', tracker: 'DialogueStateTracker',
...
class RemoteAction(Action):
    ...
    @staticmethod
    async def _utter_responses(responses: List[Dict[Text, Any]],
        ...
        for response in responses:
            if "template" in response:
                ...
                del kwargs["template"]
                draft = await dispatcher.nlg.generate(
                    response["template"],
                    tracker,
...
class ActionDefaultAskAffirmation(Action):
    ...
    async def run(self, dispatcher: 'Dispatcher', tracker: 'DialogueStateTracker',
        ...
        await dispatcher.utter_button_message(text=affirmation_message,
                                              buttons=[{'title': 'Yes',
                                                        'payload': '/{}'.format(
                                                            intent_to_affirm)},
                                                       {'title': 'No',
