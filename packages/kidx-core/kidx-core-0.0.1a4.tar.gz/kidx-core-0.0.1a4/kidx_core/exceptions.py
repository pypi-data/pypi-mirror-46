...
class KidxCoreException(Exception):
    """Basic exception for errors raised by Kidx Core."""


class StoryParseError(KidxCoreException, ValueError):
...
class UnsupportedDialogueModelError(KidxCoreException):
...
class AgentNotReady(KidxCoreException):
