...
from acs_wrapper.script.acs_preprocess import AcsPreprocess
...
class AcsProcess(object):
    ...
    def write_hdf(self, args):
        ...
        filename_output = f'{self.filepath_output}/df_{reader.prefix}_{level}_{year}_{estimate}.csv'
        df.to_csv(filename_output , index=True)
        df.to_hdf(filename_output)
