# -*- coding: utf-8 -*-
#
# ruopenrefs documentation build configuration file.
#
...
from ruopenrefs import VERSION
...
project = u'ruopenrefs'
copyright = u'2019, Igor Starikov'
...
htmlhelp_basename = 'ruopenrefsdoc'
...
latex_documents = [
  ('index', 'ruopenrefs.tex', u'ruopenrefs Documentation',
   u'Igor Starikov', 'manual'),
]
...
man_pages = [
    ('index', 'ruopenrefs', u'ruopenrefs Documentation',
     [u'Igor Starikov'], 1)
]
