...
class POWDist(object):
    ...
    def save(self):
        '''
        Save a distributable from the current data context and imports
        '''
        # Here we save the data that has been generated so far. We want to make the data
        # available for others, so most of the logic in here is putting things into a form
        # that others can resolve everything in order to reproduce our data on their
        # machine.
