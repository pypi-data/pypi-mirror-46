...
# def actions(
#     actions, color="white", ax=None, figsize=None, zoom=False, legloc="right", show=True
# ):
#     ax = field(ax=ax, color=color, figsize=figsize, show=False)
#     fig = plt.gcf()
#     figsize, _ = fig.get_size_inches()
...
#     ]
#     d["players"] = [
#         action.player if action.player != "" else "" for action in actions.itertuples()
#     ]
#     d["times"] = [
#         "%sm%ss" % (int(action.time_seconds) // 60, int(action.time_seconds) % 60)
#         for action in actions.itertuples()
#     ]
