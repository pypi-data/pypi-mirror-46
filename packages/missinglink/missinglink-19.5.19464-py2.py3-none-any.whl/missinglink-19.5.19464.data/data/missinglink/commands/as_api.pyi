...
class Data:
	...
	@staticmethod
	def create(org: str, display_name: Optional[str] = None, description: Optional[str] = None, data_path: Optional[str] = None, bucket: Optional[str] = None, linked: Optional[bool] = False, shared_storage_volume_id: Optional[int] = None) -> object: ...
	@staticmethod
