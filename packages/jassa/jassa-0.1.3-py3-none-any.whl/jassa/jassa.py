...
class jass:
    def __init__(self, debug = False, basedir = "jass_v1/jass"):
        ...
        self.negation_fn = pkg_resources.resource_filename('jassa', "data/negation.txt")
        ...
        self.posfn = pkg_resources.resource_filename('jassa', "data/NTUSD_positive_unicode.txt")
        ...
        self.negfn = pkg_resources.resource_filename('jassa', "data/NTUSD_negative_unicode.txt")
        ...
        self.cvawfn = pkg_resources.resource_filename('jassa', "data/cvaw3.csv")
        ...
        self.antusdfn = pkg_resources.resource_filename('jassa', "data/ANTUSD_unicode/opinion_word.csv")
        ...
        self.word_dictfn = pkg_resources.resource_filename('jassa', "data/dict.txt")
        ...
        self.stopword_fn = pkg_resources.resource_filename('jassa', "data/stopwords_chn.txt")
