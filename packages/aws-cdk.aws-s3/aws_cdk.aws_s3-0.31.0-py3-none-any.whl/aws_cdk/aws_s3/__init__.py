...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-s3", "0.31.0", __name__, "aws-s3@0.31.0.jsii.tgz")
...
class IBucket(aws_cdk.cdk.IResource, jsii.compat.Protocol):
    ...
    def export(self) -> "BucketAttributes":
...
__all__ = ["BlockPublicAccess", "BlockPublicAccessOptions", "Bucket", "BucketAttributes", "BucketEncryption", "BucketPolicy", "BucketPolicyProps", "BucketProps", "CfnBucket", "CfnBucketPolicy", "CfnBucketPolicyProps", "CfnBucketProps", "Coordinates", "EventType", "IBucket", "LifecycleRule", "NoncurrentVersionTransition", "NotificationKeyFilter", "StorageClass", "Transition", "__jsii_assembly__"]
