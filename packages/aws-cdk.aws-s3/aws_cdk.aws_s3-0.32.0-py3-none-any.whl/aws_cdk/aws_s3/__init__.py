...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-s3", "0.32.0", __name__, "aws-s3@0.32.0.jsii.tgz")
...
class Bucket(aws_cdk.cdk.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-s3.Bucket"):
    ...
    def add_event_notification(self, event: "EventType", dest: aws_cdk.aws_s3_notifications.IBucketNotificationDestination, *, prefix: typing.Optional[str]=None, suffix: typing.Optional[str]=None) -> None:
    ...
    def add_object_created_notification(self, dest: aws_cdk.aws_s3_notifications.IBucketNotificationDestination, *, prefix: typing.Optional[str]=None, suffix: typing.Optional[str]=None) -> None:
    ...
    def add_object_removed_notification(self, dest: aws_cdk.aws_s3_notifications.IBucketNotificationDestination, *, prefix: typing.Optional[str]=None, suffix: typing.Optional[str]=None) -> None:
...
__all__ = ["BlockPublicAccess", "BlockPublicAccessOptions", "Bucket", "BucketAttributes", "BucketEncryption", "BucketMetrics", "BucketPolicy", "BucketPolicyProps", "BucketProps", "CfnBucket", "CfnBucketPolicy", "CfnBucketPolicyProps", "CfnBucketProps", "Coordinates", "EventType", "IBucket", "LifecycleRule", "NoncurrentVersionTransition", "NotificationKeyFilter", "OnCloudTrailBucketEventOptions", "StorageClass", "Transition", "__jsii_assembly__"]
