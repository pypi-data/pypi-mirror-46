...
class Personality:
    ...
    def start(self):
        self.screen.sleepy_eyes()
        sleep(3)
        sound_thread = Thread(target=self.sound.happy)
        screen_thread = Thread(target=self.screen.draw_text("Connect to \"Zumi 1234\" on your device"))
        self._start_threading(sound_thread, screen_thread)
        sleep(3)
    ...
    def found_me(self):
        ...
        self.screen.draw_text("Go to \"zumi.local\" in your browser...")
        sleep(5)
    ...
    def connected_wifi(self):
        ...
        screen_thread = Thread(target=self.screen.draw_text("I'm connected to \"Robolink 100 \""))
        self._start_threading(sound_thread, screen_thread)
        sleep(3)
        self.awake()

    def offline_mode(self):
        self.screen.draw_text_center("We are starting with offline mode")
        self.awake()
