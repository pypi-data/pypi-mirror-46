...
The best way to send feedback is to file an issue at https://github.com/chekos/pypums/issues.
...
Ready to contribute? Here's how to set up `pypums` for local development.

1. Fork the `pypums` repo on GitHub.
...
3. The pull request should work for Python 2.7, 3.4, 3.5 and 3.6, and for PyPy. Check
   https://travis-ci.org/chekos/pypums/pull_requests
