...
setup(
    ...
    install_requires=["mo-collections>=2.31.19025","mo-dots>=2.46.19127","mo-files>=2.31.19025","mo-future>=2.46.19127","mo-json>=2.43.19055","mo-json-config>=2.34.19026","mo-kwargs>=2.45.19103","mo-logs>=2.46.19127","mo-math>=2.40.19027","mo-threads>=2.43.19055","mo-times>=2.40.19027"],
