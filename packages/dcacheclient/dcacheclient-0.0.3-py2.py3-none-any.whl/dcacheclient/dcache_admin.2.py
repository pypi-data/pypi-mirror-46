...
def qos_get_qos_list(args):
    ...
    with get_client(args) as dcache:
        response = dcache.qos.qos_getQosList(**vars(args))
...
def qos_get_queried_qos_for_files(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.qos.qos_getQueriedQosForFiles(**vars(args))
        print_response(response)
...
def qos_get_queried_qos_for_directories(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.qos.qos_getQueriedQosForDirectories(**vars(args))
        print_response(response)
...
def events_channel_metadata(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.events.events_channelMetadata(**vars(args))
        print_response(response)
...
def events_delete_channel(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.events.events_deleteChannel(**vars(args))
        print_response(response)
...
def events_modify(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.events.events_modify(**vars(args))
        print_response(response)
...
def events_get_channels(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.events.events_getChannels(**vars(args))
        print_response(response)
...
def events_register(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.events.events_register(**vars(args))
        print_response(response)
...
def events_channel_subscription(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.events.events_channelSubscription(**vars(args))
        print_response(response)
...
def events_delete(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.events.events_delete(**vars(args))
        print_response(response)
...
def events_subscribe(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.events.events_subscribe(**vars(args))
        print_response(response)
...
def events_channel_subscriptions(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.events.events_channelSubscriptions(**vars(args))
        print_response(response)
...
def events_get_event_types(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.events.events_getEventTypes(**vars(args))
        print_response(response)
...
def events_get_selector_schema(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.events.events_getSelectorSchema(**vars(args))
        print_response(response)
...
def events_get_event_schema(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.events.events_getEventSchema(**vars(args))
        print_response(response)
...
def events_service_metadata(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.events.events_serviceMetadata(**vars(args))
        print_response(response)
...
def events_get_event_type(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.events.events_getEventType(**vars(args))
        print_response(response)
...
def alarms_get_priority(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.alarms.alarms_getPriority(**vars(args))
        print_response(response)
...
def alarms_get_alarms(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.alarms.alarms_getAlarms(**vars(args))
        print_response(response)
...
def alarms_bulk_update_or_delete(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.alarms.alarms_bulkUpdateOrDelete(**vars(args))
        print_response(response)
...
def alarms_delete_alarm_entry(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.alarms.alarms_deleteAlarmEntry(**vars(args))
        print_response(response)
...
def alarms_update_alarm_entry(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.alarms.alarms_updateAlarmEntry(**vars(args))
        print_response(response)
...
def alarms_get_priorities(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.alarms.alarms_getPriorities(**vars(args))
        print_response(response)
...
def billing_get_data(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.billing.billing_getData(**vars(args))
        print_response(response)
...
def billing_get_p2ps(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.billing.billing_getP2ps(**vars(args))
        print_response(response)
...
def billing_get_reads(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.billing.billing_getReads(**vars(args))
        print_response(response)
...
def billing_get_restores(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.billing.billing_getRestores(**vars(args))
        print_response(response)
...
def billing_get_stores(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.billing.billing_getStores(**vars(args))
        print_response(response)
...
def billing_get_writes(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.billing.billing_getWrites(**vars(args))
        print_response(response)
...
def billing_get_grid(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.billing.billing_getGrid(**vars(args))
        print_response(response)
...
def billing_get_grid_data(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.billing.billing_getGridData(**vars(args))
        print_response(response)
...
def cells_get_cells(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.cells.cells_getCells(**vars(args))
        print_response(response)
...
def cells_get_cell_data(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.cells.cells_getCellData(**vars(args))
        print_response(response)
...
def cells_get_addresses(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.cells.cells_getAddresses(**vars(args))
        print_response(response)
...
def identity_get_user_attributes(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.identity.identity_getUserAttributes(**vars(args))
        print_response(response)
...
def namespace_get_file_attributes(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.namespace.namespace_getFileAttributes(**vars(args))
        print_response(response)
...
def namespace_cmr_resources(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.namespace.namespace_cmrResources(**vars(args))
        print_response(response)
...
def namespace_delete_file_entry(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.namespace.namespace_deleteFileEntry(**vars(args))
        print_response(response)
...
def namespace_get_attributes(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.namespace.namespace_getAttributes(**vars(args))
        print_response(response)
...
def poolmanager_get_pool_groups(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.poolmanager.poolmanager_getPoolGroups(**vars(args))
        print_response(response)
...
def poolmanager_get_pool_group(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.poolmanager.poolmanager_getPoolGroup(**vars(args))
        print_response(response)
...
def poolmanager_get_pools_of_group(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.poolmanager.poolmanager_getPoolsOfGroup(**vars(args))
        print_response(response)
...
def poolmanager_get_group_usage(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.poolmanager.poolmanager_getGroupUsage(**vars(args))
        print_response(response)
...
def poolmanager_get_queue_info(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.poolmanager.poolmanager_getQueueInfo(**vars(args))
        print_response(response)
...
def poolmanager_get_space_info(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.poolmanager.poolmanager_getSpaceInfo(**vars(args))
        print_response(response)
...
def poolmanager_get_queue_histograms(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.poolmanager.poolmanager_getQueueHistograms(**vars(args))
        print_response(response)
...
def poolmanager_get_files_histograms(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.poolmanager.poolmanager_getFilesHistograms(**vars(args))
        print_response(response)
...
def pools_get_pool(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.pools.pools_getPool(**vars(args))
        print_response(response)
...
def pools_get_movers(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.pools.pools_getMovers(**vars(args))
        print_response(response)
...
def pools_get_queue_histograms(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.pools.pools_getQueueHistograms(**vars(args))
        print_response(response)
...
def pools_get_files_histograms(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.pools.pools_getFilesHistograms(**vars(args))
        print_response(response)
...
def pools_get_pool_usage(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.pools.pools_getPoolUsage(**vars(args))
        print_response(response)
...
def pools_get_repository_info_for_file(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.pools.pools_getRepositoryInfoForFile(**vars(args))
        print_response(response)
...
def pools_get_nearline_queues(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.pools.pools_getNearlineQueues(**vars(args))
        print_response(response)
...
def pools_kill_movers(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.pools.pools_killMovers(**vars(args))
        print_response(response)
...
def pools_update_mode(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.pools.pools_updateMode(**vars(args))
        print_response(response)
...
def pools_get_pools(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.pools.pools_getPools(**vars(args))
        print_response(response)
...
def pools_get_restores(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.pools.pools_getRestores(**vars(args))
        print_response(response)
...
def poolmanager_get_links(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.poolmanager.poolmanager_getLinks(**vars(args))
        print_response(response)
...
def poolmanager_get_link_groups(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.poolmanager.poolmanager_getLinkGroups(**vars(args))
        print_response(response)
...
def poolmanager_get_partitions(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.poolmanager.poolmanager_getPartitions(**vars(args))
        print_response(response)
...
def poolmanager_match(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.poolmanager.poolmanager_match(**vars(args))
        print_response(response)
...
def poolmanager_get_units(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.poolmanager.poolmanager_getUnits(**vars(args))
        print_response(response)
...
def poolmanager_get_unit_groups(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.poolmanager.poolmanager_getUnitGroups(**vars(args))
        print_response(response)
...
def spacemanager_get_tokens_for_group(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.spacemanager.spacemanager_getTokensForGroup(**vars(args))
        print_response(response)
...
def spacemanager_get_link_groups(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.spacemanager.spacemanager_getLinkGroups(**vars(args))
        print_response(response)
...
def transfers_get_transfers(args):
    ...
    LOGGER.debug('args: %s' % str(args))
    with get_client(args) as dcache:
        response = dcache.transfers.transfers_getTransfers(**vars(args))
        print_response(response)
...
def get_parser(config):
    ...
    getPriority_parser.add_argument(
        "'--type'",
        required=True,
        help='''The alarm type.''',
        action='store',
    ...
    getAlarms_parser.add_argument(
        "'--offset'",
        required=False,
        help='''Number of entries to skip in directory listing.''',
        type=int,
    )
    getAlarms_parser.add_argument(
        "'--limit'",
        required=False,
        help='''Limit number of replies in directory listing.''',
        type=int,
    )
    getAlarms_parser.add_argument(
        "'--after'",
        required=False,
        help='''Return no alarms before this datestamp, in unix-time.''',
        type=int,
    )
    getAlarms_parser.add_argument(
        "'--before'",
        required=False,
        help='''Return no alarms after this datestamp, in unix-time.''',
        type=int,
    )
    getAlarms_parser.add_argument(
        "'--includeClosed'",
        required=False,
        help='''Whether to include closed alarms.''',
        action='store_true',
    )
    getAlarms_parser.add_argument(
        "'--severity'",
        required=False,
        help='''Select log entries with at least this severity.''',
        action='store',
    )
    getAlarms_parser.add_argument(
        "'--type'",
        required=False,
        help='''Select only log entries of this alarm type.''',
        action='store',
    )
    getAlarms_parser.add_argument(
        "'--host'",
        required=False,
        help='''Select only log entries from this host.''',
        action='store',
    )
    getAlarms_parser.add_argument(
        "'--domain'",
        required=False,
        help='''Select only log entries from this domain.''',
        action='store',
    )
    getAlarms_parser.add_argument(
        "'--service'",
        required=False,
        help='''Select only log entries from this service.''',
        action='store',
    )
    getAlarms_parser.add_argument(
        "'--info'",
        required=False,
        help='''Select only log entries that match the info.''',
        action='store',
    )
    getAlarms_parser.add_argument(
        "'--sort'",
        required=False,
        help='''A comma-seperated list of fields to sort log entries.''',
        action='store',
    )
    ...
    bulkUpdateOrDelete_parser.add_argument(
        "'--body'",
        required=False,
        help='''A JSON object describing the changes.  The "action" item is a string with either "update" or "delete" as a value.  The "items" item is a JSON Array. For the "delete" action, this array contains strings, each the key of a log entry to delete.  For the "update" action, the array contains JSON objects with a "key" item and a "closed" item.  The closed value is a boolean and the key value is a String.''',
        action='store',
    )
    ...
    deleteAlarmEntry_parser.add_argument(
        "'--key'",
        required=True,
        help='''The identifier for the specific log entry.''',
        action='store',
    )
    ...
    updateAlarmEntry_parser.add_argument(
        "'--key'",
        required=True,
        help='''The identifier for the specific log entry.''',
        action='store',
    ...
    updateAlarmEntry_parser.add_argument(
        "'--body'",
        required=False,
        help='''A JSON Object with a 'closed' item containing a JSON Boolean value.''',
        action='store',
    )
    ...
    getData_parser.add_argument(
        "'--key'",
        required=True,
        help='''The specification identifier for which to fetch data.''',
        action='store',
    )
    ...
    getP2ps_parser.add_argument(
        "'--before'",
        required=False,
        help='''Return no transfers after this datestamp.''',
        action='store',
    )
    getP2ps_parser.add_argument(
        "'--after'",
        required=False,
        help='''Return no transfers before this datestamp.''',
        action='store',
    )
    getP2ps_parser.add_argument(
        "'--limit'",
        required=False,
        help='''Maximum number of transfers to return.''',
        type=int,
    )
    getP2ps_parser.add_argument(
        "'--offset'",
        required=False,
        help='''Number of transfers to skip.''',
        type=int,
        default=0,
    )
    getP2ps_parser.add_argument(
        "'--serverPool'",
        required=False,
        help='''Only select transfers from the specified pool.''',
        action='store',
    )
    getP2ps_parser.add_argument(
        "'--clientPool'",
        required=False,
        help='''Only select transfers to the specified pool.''',
        action='store',
    )
    getP2ps_parser.add_argument(
        "'--client'",
        required=False,
        help='''Only select transfers triggered by the specified client.''',
        action='store',
    )
    getP2ps_parser.add_argument(
        "'--sort'",
        required=False,
        help='''How to sort responses.''',
        action='store',
        default='date',
    )
    ...
    getReads_parser.add_argument(
        "'--before'",
        required=False,
        help='''Return no reads after this datestamp.''',
        action='store',
    )
    getReads_parser.add_argument(
        "'--after'",
        required=False,
        help='''Return no reads before this datestamp.''',
        action='store',
    )
    getReads_parser.add_argument(
        "'--limit'",
        required=False,
        help='''Maximum number of reads to return.''',
        type=int,
    )
    getReads_parser.add_argument(
        "'--offset'",
        required=False,
        help='''Number of reads to skip.''',
        type=int,
        default=0,
    )
    getReads_parser.add_argument(
        "'--pool'",
        required=False,
        help='''Only select reads from the specified pool.''',
        action='store',
    )
    getReads_parser.add_argument(
        "'--door'",
        required=False,
        help='''Only select reads initiated by the specified door.''',
        action='store',
    )
    getReads_parser.add_argument(
        "'--client'",
        required=False,
        help='''Only select reads requested by the client.''',
        action='store',
    )
    getReads_parser.add_argument(
        "'--sort'",
    ...
    getRestores_parser.add_argument(
        "'--before'",
        required=False,
        help='''Return no tape reads after this datestamp.''',
        action='store',
    )
    getRestores_parser.add_argument(
        "'--after'",
        required=False,
        help='''Return no tape reads before this datestamp.''',
        action='store',
    )
    getRestores_parser.add_argument(
        "'--limit'",
        required=False,
        help='''Maximum number of tape reads to return.''',
        type=int,
    )
    getRestores_parser.add_argument(
        "'--offset'",
        required=False,
        help='''Number of tape reads to skip.''',
        type=int,
        default=0,
    )
    getRestores_parser.add_argument(
        "'--pool'",
        required=False,
        help='''Only select tape reads involving the specified pool.''',
        action='store',
    )
    getRestores_parser.add_argument(
        "'--sort'",
    ...
    getStores_parser.add_argument(
        "'--before'",
        required=False,
        help='''Return no tape writes after this datestamp.''',
        action='store',
    )
    getStores_parser.add_argument(
        "'--after'",
        required=False,
        help='''Return no tape writes before this datestamp.''',
        action='store',
    )
    getStores_parser.add_argument(
        "'--limit'",
        required=False,
        help='''Maximum number of tape writes to return.''',
        type=int,
    )
    getStores_parser.add_argument(
        "'--offset'",
        required=False,
        help='''Number of tape writes to skip.''',
        type=int,
        default=0,
    )
    getStores_parser.add_argument(
        "'--pool'",
        required=False,
        help='''Only select tape writes involving the specified pool.''',
        action='store',
    )
    getStores_parser.add_argument(
        "'--sort'",
    ...
    getWrites_parser.add_argument(
        "'--before'",
        required=False,
        help='''Return no writes after this datestamp.''',
        action='store',
    )
    getWrites_parser.add_argument(
        "'--after'",
        required=False,
        help='''Return no writes before this datestamp.''',
        action='store',
    )
    getWrites_parser.add_argument(
        "'--limit'",
        required=False,
        help='''Maximum number of writes to return.''',
        type=int,
    )
    getWrites_parser.add_argument(
        "'--offset'",
        required=False,
        help='''Number of writes to skip.''',
        type=int,
        default=0,
    )
    getWrites_parser.add_argument(
        "'--pool'",
        required=False,
        help='''Only select writes from the specified pool.''',
        action='store',
    )
    getWrites_parser.add_argument(
        "'--door'",
        required=False,
        help='''Only select writes initiated by the specified door.''',
        action='store',
    )
    getWrites_parser.add_argument(
        "'--client'",
        required=False,
        help='''Only select writes requested by the client.''',
        action='store',
    )
    getWrites_parser.add_argument(
        "'--sort'",
    ...
    getCellData_parser.add_argument(
        "'--address'",
        required=True,
        help='''The cell to query''',
        action='store',
    )
    ...
    getFileAttributes_parser.add_argument(
        "'--path'",
        required=True,
    ...
    getFileAttributes_parser.add_argument(
        "'--children'",
        required=False,
        help='''Whether to include directory listing.''',
        action='store_true',
        default=False,
    )
    getFileAttributes_parser.add_argument(
        "'--locality'",
        required=False,
        help='''Whether to include file locality information.''',
        action='store_true',
        default=False,
    )
    getFileAttributes_parser.add_argument(
        "'--locations'",
        required=False,
        help='''Whether to include replica locations.''',
        action='store_true',
    )
    getFileAttributes_parser.add_argument(
        "'--qos'",
        required=False,
        help='''Whether to include quality of service.''',
        action='store_true',
        default=False,
    )
    getFileAttributes_parser.add_argument(
    ...
    cmrResources_parser.add_argument(
        "'--path'",
        required=True,
        help='''Path of file or directory to be modified.''',
        action='store',
    )
    cmrResources_parser.add_argument(
        "'--body'",
        required=True,
        help='''A JSON object that has an 'action' item with a String value.
...
If action is 'qos' then the value of the JSON object 'target' item describes the desired QoS.''',
    ...
    deleteFileEntry_parser.add_argument(
        "'--path'",
        required=True,
        help='''Path of file or directory.''',
        action='store',
    ...
    getAttributes_parser.add_argument(
        "'--pnfsid'",
        required=True,
        help='''The PNFS-ID of a file or directory.''',
        action='store',
    )
    ...
    getPoolGroup_parser.add_argument(
        "'--group'",
        required=True,
        help='''The poolgroup to be described.''',
        action='store',
    )
    ...
    getPoolsOfGroup_parser.add_argument(
        "'--group'",
        required=True,
        help='''The poolgroup to be described.''',
        action='store',
    ...
    getGroupUsage_parser.add_argument(
        "'--group'",
        required=True,
        help='''The poolgroup to be described.''',
        action='store',
    ...
    getQueueInfo_parser.add_argument(
        "'--group'",
        required=True,
        help='''The poolgroup to be described.''',
        action='store',
    ...
    getSpaceInfo_parser.add_argument(
        "'--group'",
        required=True,
        help='''The poolgroup to be described.''',
        action='store',
    ...
    getQueueHistograms_parser.add_argument(
        "'--group'",
        required=True,
        help='''The poolgroup to be described.''',
        action='store',
    ...
    getFilesHistograms_parser.add_argument(
        "'--group'",
        required=True,
        help='''The poolgroup to be described.''',
        action='store',
    ...
    match_parser.add_argument(
        ...
        action='store',
        default='READ',
        choices=['READ', 'CACHE', 'WRITE', 'P2P', 'ANY']
    )
    match_parser.add_argument(
        "'--store'",
        required=False,
        help='''The name of the matching store unit.''',
        action='store',
        default='*',
    )
    match_parser.add_argument(
        "'--dcache'",
        required=False,
        help='''The name of the matching dcache unit.''',
        action='store',
        default='*',
    )
    match_parser.add_argument(
        "'--net'",
        required=False,
        help='''The name of the matching net unit.''',
        action='store',
        default='*',
    )
    match_parser.add_argument(
        "'--protocol'",
        required=False,
        help='''The matching protocol unit.''',
        action='store',
        default='*',
    )
    match_parser.add_argument(
        "'--linkGroup'",
        required=False,
        help='''The linkgroup unit, or 'none' for a request outside of a linkgroup.''',
        action='store',
        default='none',
    )
    ...
    getPool_parser.add_argument(
        "'--pool'",
        required=True,
        help='''The pool to be described.''',
        action='store',
    )
    ...
    getMovers_parser.add_argument(
        "'--type'",
        required=False,
        help='''A comma-seperated list of mover types. Currently, either 'p2p-client,p2p-server' or none (meaning all) is supported.''',
        action='store',
    )
    getMovers_parser.add_argument(
        "'--offset'",
        required=False,
        help='''The number of items to skip.''',
        type=int,
        default=0,
    )
    getMovers_parser.add_argument(
    ...
    getMovers_parser.add_argument(
        "'--pnfsid'",
        required=False,
        help='''Select movers operating on a specific PNFS-ID.''',
        action='store',
    )
    getMovers_parser.add_argument(
        "'--queue'",
        required=False,
        help='''Select movers with a specific queue.''',
        action='store',
    )
    getMovers_parser.add_argument(
        "'--state'",
        required=False,
        help='''Select movers in a particular state.''',
        action='store',
    )
    getMovers_parser.add_argument(
        "'--mode'",
        required=False,
        help='''Select movers with a specific mode.''',
        action='store',
    )
    getMovers_parser.add_argument(
        "'--door'",
        required=False,
        help='''Select movers initiated by a specific door.''',
        action='store',
    )
    getMovers_parser.add_argument(
        "'--storageClass'",
        required=False,
        help='''Select movers with a specific storage class.''',
        action='store',
    )
    getMovers_parser.add_argument(
        "'--sort'",
        required=False,
        help='''How returned items should be sorted.''',
        action='store',
        default='door,startTime',
    )
    ...
    getPoolUsage_parser.add_argument(
        "'--pool'",
        required=True,
        help='''The pool to be described.''',
        action='store',
    ...
    getRepositoryInfoForFile_parser.add_argument(
        "'--pool'",
        required=True,
        help='''The pool to be described.''',
        action='store',
    ...
    getRepositoryInfoForFile_parser.add_argument(
        "'--pnfsid'",
        required=True,
        help='''The PNFS-ID of the file to be described.''',
        action='store',
    )
    ...
    getNearlineQueues_parser.add_argument(
        "'--pool'",
        required=True,
        help='''The pool to be described.''',
        action='store',
    ...
    getNearlineQueues_parser.add_argument(
        "'--type'",
        required=False,
        help='''Select transfers of a specific type (flush, stage, remove).''',
        action='store',
    )
    getNearlineQueues_parser.add_argument(
        "'--offset'",
    ...
    getNearlineQueues_parser.add_argument(
        "'--pnfsid'",
        required=False,
        help='''Select only operations affecting this PNFS-ID.''',
        action='store',
    )
    getNearlineQueues_parser.add_argument(
        "'--state'",
        required=False,
        help='''Select only operations in this state.''',
        action='store',
    )
    getNearlineQueues_parser.add_argument(
        "'--storageClass'",
        required=False,
        help='''Select only operations of this storage class.''',
        action='store',
    )
    getNearlineQueues_parser.add_argument(
        "'--sort'",
        required=False,
        help='''How the returned values should be sorted.''',
        action='store',
    ...
    killMovers_parser.add_argument(
        "'--pool'",
        required=True,
        help='''The pool with the mover to be killed.''',
        action='store',
    )
    killMovers_parser.add_argument(
        "'--id'",
        required=True,
        help='''The id of the mover to be killed.''',
        type=int,
    )
    ...
    updateMode_parser.add_argument(
        "'--pool'",
        required=True,
        help='''The pool affected by the mode change.''',
        action='store',
    )
    updateMode_parser.add_argument(
        "'--body'",
        required=True,
        help='''JSON object describing how the pool should be modified. (Corresponds to PoolModeUpdate.)''',
        action='store',
    )
    ...
    getRestores_parser.add_argument(
        "'--token'",
        required=False,
        help='''Use the snapshot corresponding to this UUID.  The contract with the service is that if the parameter value is null, the current snapshot will be used, regardless of whether offset and limit are still valid.  Initial/refresh calls should always be without a token.  Subsequent calls should send back the current token; in the case that it no longer corresponds to the current list, the service will return a null token and an empty list, and the client will need to recall the method without a token (refresh).''',
        action='store',
    )
    getRestores_parser.add_argument(
        "'--offset'",
        required=False,
        help='''The number of restores to skip.''',
        type=int,
    )
    getRestores_parser.add_argument(
        "'--limit'",
        required=False,
        help='''The maximum number of restores to return.''',
        type=int,
    )
    getRestores_parser.add_argument(
        "'--pnfsid'",
        required=False,
        help='''Select only restores that affect this PNFS-ID.''',
        action='store',
    )
    getRestores_parser.add_argument(
        "'--subnet'",
        required=False,
        help='''Select only restores triggered by clients from this subnet.''',
        action='store',
    )
    getRestores_parser.add_argument(
        "'--pool'",
        required=False,
        help='''Select only restores on this pool.''',
        action='store',
    )
    getRestores_parser.add_argument(
        "'--status'",
        required=False,
        help='''Select only restores with this status.''',
        action='store',
    )
    getRestores_parser.add_argument(
        "'--sort'",
        required=False,
        help='''A comma-seperated list of fields on which to sort the results.''',
        action='store',
        default='pool,started',
    )
    ...
    getQosList_parser.add_argument(
        "'--type'",
        required=True,
        help='''The kind of object to query.''',
        action='store',
    ...
    getQueriedQosForFiles_parser.add_argument(
        "'--qos'",
        required=True,
        help='''The file quality of service to query.''',
        action='store',
    )
    ...
    getQueriedQosForDirectories_parser.add_argument(
        "'--qos'",
        required=True,
        help='''The directory quality of service to query.''',
        action='store',
    )
    ...
    getTokensForGroup_parser.add_argument(
        "'--id'",
        required=False,
        help='''The id of the space token.''',
        type=int,
    )
    getTokensForGroup_parser.add_argument(
        "'--voGroup'",
        required=False,
        help='''VO group associated with the token.''',
        action='store',
    )
    getTokensForGroup_parser.add_argument(
        "'--voRole'",
        required=False,
        help='''VO role associated with the token.''',
        action='store',
    )
    getTokensForGroup_parser.add_argument(
        "'--accessLatency'",
        required=False,
        help='''Access Latency associated with the token.''',
        action='store',
    )
    getTokensForGroup_parser.add_argument(
        "'--retentionPolicy'",
        required=False,
        help='''Retention Policy associated with the token.''',
        action='store',
    )
    getTokensForGroup_parser.add_argument(
        "'--groupId'",
        required=False,
        help='''Id of link group to which token belongs.''',
        type=int,
    )
    getTokensForGroup_parser.add_argument(
        "'--state'",
        required=False,
        help='''State of the token.''',
        action='store',
    )
    getTokensForGroup_parser.add_argument(
        "'--minSize'",
        required=False,
        help='''Minimum size (in bytes) of token.''',
        type=int,
    )
    getTokensForGroup_parser.add_argument(
        "'--minFreeSpace'",
        required=False,
        help='''Minimum amount of space (in bytes) still free for token.''',
        type=int,
    )
    ...
    getLinkGroups_parser.add_argument(
        "'--name'",
        required=False,
        help='''The name of the link group.''',
        action='store',
    )
    getLinkGroups_parser.add_argument(
        "'--id'",
        required=False,
        help='''The id of the link group.''',
        type=int,
    )
    getLinkGroups_parser.add_argument(
        "'--onlineAllowed'",
        required=False,
        help='''Whether the link group allows online access latency.''',
        action='store_true',
    )
    getLinkGroups_parser.add_argument(
        "'--nearlineAllowed'",
        required=False,
        help='''Whether the link group allows nearline access latency.''',
        action='store_true',
    )
    getLinkGroups_parser.add_argument(
        "'--replicaAllowed'",
        required=False,
        help='''Whether the link group allows replica retention policy.''',
        action='store_true',
    )
    getLinkGroups_parser.add_argument(
        "'--outputAllowed'",
        required=False,
        help='''Whether the link group allows output retention policy.''',
        action='store_true',
    )
    getLinkGroups_parser.add_argument(
        "'--custodialAllowed'",
        required=False,
        help='''Whether the link group allows custodial retention policy.''',
        action='store_true',
    )
    getLinkGroups_parser.add_argument(
        "'--voGroup'",
        required=False,
        help='''VO group associated with the link.''',
        action='store',
    )
    getLinkGroups_parser.add_argument(
        "'--voRole'",
        required=False,
        help='''VO role associated with the link.''',
        action='store',
    )
    getLinkGroups_parser.add_argument(
        "'--minAvailableSpace'",
        required=False,
        help='''Minimum amount of space (in bytes) still available via the link.''',
        type=int,
    )
    ...
    getTransfers_parser.add_argument(
        "'--token'",
        required=False,
        help='''Use the snapshot corresponding to this UUID.  The contract with the service is that if the parameter value is null, the current snapshot will be used, regardless of whether offset and limit are still valid.  Initial/refresh calls should always be without a token.  Subsequent calls should send back the current token; in the case that it no longer corresponds to the current list, the service will return a null token and an empty list, and the client will need to recall the method without a token (refresh).''',
        action='store',
    ...
    getTransfers_parser.add_argument(
        "'--limit'",
        required=False,
        help='''The maximum number items to return.''',
        type=int,
    )
    getTransfers_parser.add_argument(
        "'--state'",
        required=False,
        help='''Select transfers in this state (NOTFOUND, STAGING, QUEUED, RUNNING, CANCELED, DONE)''',
        action='store',
    )
    getTransfers_parser.add_argument(
        "'--door'",
        required=False,
        help='''Select transfers initiated through this door.''',
        action='store',
    )
    getTransfers_parser.add_argument(
        "'--domain'",
        required=False,
        help='''Select transfers initiated through a door in this domain.''',
        action='store',
    )
    getTransfers_parser.add_argument(
        "'--prot'",
        required=False,
        help='''Select transfers using this protocol.''',
        action='store',
    )
    getTransfers_parser.add_argument(
        "'--uid'",
        required=False,
        help='''Select transfers initiated by this user.''',
        action='store',
    )
    getTransfers_parser.add_argument(
        "'--gid'",
        required=False,
        help='''Select transfers initiated by a member of this group.''',
        action='store',
    )
    getTransfers_parser.add_argument(
        "'--vomsgroup'",
        required=False,
        help='''Select transfers initiated by a member of this vomsgroup.''',
        action='store',
    )
    getTransfers_parser.add_argument(
        "'--pnfsid'",
        required=False,
        help='''Select transfers involving this pnfsid.''',
        action='store',
    )
    getTransfers_parser.add_argument(
        "'--pool'",
        required=False,
        help='''Select transfers involving this pool.''',
        action='store',
    )
    getTransfers_parser.add_argument(
        "'--client'",
        required=False,
        help='''Select transfers involving this client.''',
        action='store',
    )
    getTransfers_parser.add_argument(
        "'--sort'",
        required=False,
        help='''A comma-seperated list of fields to sort the responses.''',
        action='store',
        default='door,waiting',
    )
    ...
    channelMetadata_parser.add_argument(
        "'--id'",
        required=True,
        help='''None''',
        action='store',
    ...
    deleteChannel_parser.add_argument(
        "'--id'",
        required=True,
        help='''None''',
        action='store',
    ...
    getChannels_parser.add_argument(
        "'--client-id'",
        required=False,
        help='''Limit channels by client-id''',
        action='store',
    )
    ...
    channelSubscription_parser.add_argument(
        "'--channel_id'",
        required=True,
        help='''None''',
        action='store',
    ...
    channelSubscriptions_parser.add_argument(
        "'--id'",
        required=True,
        help='''None''',
        action='store',
    ...
    getSelectorSchema_parser.add_argument(
        "'--type'",
        required=True,
        help='''The specific event type to be described.''',
        action='store',
    )
    ...
    getEventSchema_parser.add_argument(
        "'--type'",
        required=True,
        help='''The specific event type to be described.''',
        action='store',
    ...
    getEventType_parser.add_argument(
        "'--type'",
        required=True,
        help='''The specific event type to be described.''',
        action='store',
