...
from azureml.automl.core.training_utilities import _is_sparse_metrix_int_type, _upgrade_sparse_matric_type
...
def explain_model(fitted_model, X_train, X_test, best_run=None, features=None, y_train=None, **kwargs):
    ...
    try:
        ...
        explanation = explainer.explain_global(explainer_data_X_test)
        ...
        logging_utilities.log_traceback(import_error, logger)
        logger.warning(
