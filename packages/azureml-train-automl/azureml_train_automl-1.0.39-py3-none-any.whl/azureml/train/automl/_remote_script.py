...
def _set_problem_info_for_setup(
    ...
    num_samples = cast(DataInputType, fit_iteration_parameters_dict.get('X')).shape[0]
    subsampling = automl_settings_obj.enable_subsampling and utilities.subsampling_recommended(num_samples)
    ...
    automl._set_problem_info(
        ...
        preprocess=automl_settings_obj.preprocess, subsampling=subsampling,
        logger=logger
    )
