...
def get_net_for_opt_bond(ytm, par, ex_maturity, maturity, cupn_before_ex, cupon_after_ex, freq):
    pass


def get_ytm_for_opt_bond(net, maturity, cupn, freq, par=100, guess=3):
    pass
