...
import aws_cdk.cdk
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-codebuild", "0.31.0", __name__, "aws-codebuild@0.31.0.jsii.tgz")
...
class CfnProject(aws_cdk.cdk.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.CfnProject"):
    ...
    class ProjectTriggersProperty(jsii.compat.TypedDict, total=False):
        ...
        """
        filterGroups: typing.Union[aws_cdk.cdk.Token, typing.List[typing.Union[aws_cdk.cdk.Token, typing.List[typing.Union["CfnProject.WebhookFilterProperty", aws_cdk.cdk.Token]]]]]
...
class IProject(aws_cdk.cdk.IResource, aws_cdk.aws_iam.IGrantable, jsii.compat.Protocol):
    ...
    def export(self) -> "ProjectAttributes":
        """Export this Project.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.ProjectAttributes", jsii_struct_bases=[])
class ProjectAttributes(jsii.compat.TypedDict):
