...
def test_hash_files(static_fresh_project):
...
class Test_FrameLoader:
    def test_basic(self, static_fresh_project):
    ...
    def test_hash(self, static_fresh_project):
    ...
    def test_queue_background_removal(self, fresh_project):
        ...
        loader.queue_background_removal()
    ...
    def test_natural_file_order(self, tmp_path):
        ...
        files = [str(tmp_path / f"image_{i}.tiff") for i in range(8, 12)]
        for file in files:
            with open(file, "x"):
                pass
