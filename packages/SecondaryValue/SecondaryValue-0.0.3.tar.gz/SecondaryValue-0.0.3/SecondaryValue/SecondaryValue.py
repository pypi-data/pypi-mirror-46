...
class SecondaryValue:
    ...
    def _calc_deps(self, **kwargs):
        ...
        :returns: patched kwargs containing the dependencies
        :rtype: Tuple
        """
    ...
    def __call__(self, *args, **kwargs):
        ...
        :rtype: numpy data type or np array of [value, errors, ...]
        """

        kwargs = self._calc_deps(**kwargs)
