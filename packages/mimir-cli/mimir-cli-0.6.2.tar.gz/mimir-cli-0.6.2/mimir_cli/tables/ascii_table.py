"""
AsciiTable is the main table class. To be inherited by other tables.
Define convenience methods here.
"""

from mimir_cli.tables.base_table import BaseTable
from mimir_cli.tables.terminal_io import terminal_size
from mimir_cli.tables.width_and_alignment import (
    column_max_width,
    max_dimensions,
    table_width,
)
...
class AsciiTable(BaseTable):
    ...
    :ivar dict justify_columns: Horizontal justification. Keys are column indexes (int).
