...
"""
from mimir_cli.tables.build import build_border, build_row, flatten
from mimir_cli.tables.width_and_alignment import align_and_pad_cell, max_dimensions
...
class BaseTable(object):
    ...
    :ivar dict justify_columns:
      Horizontal justification.
      Keys are column indexes (int).
      Values are right/left/center.
    ...
    def gen_row_lines(self, row, style, inner_widths, height):
        ...
        Caller is expected to pass yielded lines to ''.join() to combine them into a
        printable line. Caller must append newline character to the end of joined line.
