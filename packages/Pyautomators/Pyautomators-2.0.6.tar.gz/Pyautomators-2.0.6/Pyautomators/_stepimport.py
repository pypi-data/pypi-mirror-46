...
.. warn:: Do not use directly
    ...
    It should not be used directly except in Pyautomators Runner classes
...
import os.path
import sys
from Pyautomators import step_registry as _step_registry
# from Pyautomators import matchers as _matchers
import six
...
class FakeModule(ModuleType):
    ...
    # -- SUPPORT FOR: Pyautomators.step_registry.setup_step_decorators()
...
class StepRegistryModule(FakeModule):
    """Provides a fake :mod:`Pyautomators.step_registry` module
    ...
    def __init__(self, step_registry):
        super(StepRegistryModule, self).__init__("Pyautomators.step_registry")
...
class StepMatchersModule(FakeModule):
    ...
    def __init__(self, matcher_factory):
        super(StepMatchersModule, self).__init__("Pyautomators.matchers")
        ...
        self.__name__ = "Pyautomators.matchers"
...
class PyautomatorsModule(FakeModule):
    ...
    def __init__(self, step_registry, matcher_factory=None):
        ...
        super(PyautomatorsModule, self).__init__("Pyautomators")
        setup_api_with_step_decorators(self, step_registry)
        setup_api_with_matcher_functions(self, matcher_factory)
        self.use_default_step_matcher = matcher_factory.use_default_step_matcher
...
class StepImportModuleContext(object):
    ...
    def __init__(self, step_container):
        ...
        Pyautomators_module = PyautomatorsModule(self.step_registry, self.matcher_factory)
        self.modules = {
            "Pyautomators": Pyautomators_module,
            "Pyautomators.matchers": step_matchers_module,
            "Pyautomators.step_registry": step_registry_module,
        }
...
def use_step_import_modules(step_container):
    ...
    (:mod:`Pyautomators.step_registry`, mod:`Pyautomators.matchers`).
