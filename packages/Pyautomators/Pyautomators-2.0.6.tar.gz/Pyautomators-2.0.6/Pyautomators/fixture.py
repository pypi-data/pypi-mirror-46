...
.. sourcecode:: python
    ...
    # -- FILE: Pyautomators4my_project/fixtures.py (or: features/environment.py)
...
.. sourcecode:: python
    ...
    from Pyautomators import use_fixture
    from Pyautomators4my_project.fixtures import browser_firefox
...
def use_fixture_by_tag(tag, context, fixture_registry):
    ...
    .. code-block:: python
        ...
        # -- FILE: features/environment.py
        from Pyautomators.fixture import use_fixture_by_tag
        from Pyautomators4my_project.fixtures import browser_firefox, browser_chrome
...
def fixture(func=None, name=None, pattern=None):
    ...
    def mark_as_fixture(func, name=None, pattern=None):
        ...
        func.Pyautomators_fixture = True
        return func
