...
from Pyautomators._types import ChainedExceptionUtil, ExceptionUtil
from Pyautomators.model_core import Argument, FileLocation, Replayable
...
class Match(Replayable):
    ...
    .. attribute:: arguments
       ...
       A list of :class:`~Pyautomators.model_core.Argument` instances containing the
...
class Matcher(object):
    ...
    def check_match(self, step):
        ...
        :class:`~Pyautomators.model_core.Argument` instances.

        The return value from this function will be converted into a
        :class:`~Pyautomators.matchers.Match` instance by *Pyautomators*.
        """
...
def register_type(**kw):
    ...
    .. code-block:: python
        ...
        from Pyautomators import register_type, given
        import parse
        ...
        # -- REGISTER TYPE-CONVERTER: With Pyautomators
...
matcher_mapping = {
    ...
    #   from Pyautomators import use_step_matcher
...
def use_step_matcher(name):
    ...
    There are several parsers available in *Pyautomators* (by default):
    ...
    **parse** (the default, based on: :pypi:`parse`)
        ...
        (see :func:`~Pyautomators.register_type()`).
