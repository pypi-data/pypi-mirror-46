...
import os.path
from Pyautomators.textutil import select_best_encoding, \
...
class Formatter(object):
    ...
    def feature(self, feature):
        ...
        :param feature:  Feature object (as :class:`Pyautomators.model.Feature`)
        """
        pass
    ...
    def background(self, background):
        ...
        :param background:  Background object (as :class:`Pyautomators.model.Background`)
        """
        pass
    ...
    def scenario(self, scenario):
        ...
        :param scenario:  Scenario object (as :class:`Pyautomators.model.Scenario`)
        """
        pass
    ...
    def step(self, step):
        ...
        :param step: Step object (as :class:`Pyautomators.model.Step`)
        """
        pass
