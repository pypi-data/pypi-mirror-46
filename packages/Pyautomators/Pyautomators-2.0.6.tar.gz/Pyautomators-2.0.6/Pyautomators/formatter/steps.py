...
from Pyautomators.step_registry import StepRegistry, registry
from Pyautomators.textutil import \
    compute_words_maxsize, indent, make_indentation, text as _text
from Pyautomators import i18n
...
class StepsFormatter(AbstractStepsFormatter):
    ...
    EXAMPLE:
        $ Pyautomators --dry-run -f steps features/
