# -*- coding: utf-8 -*-
"""
Read Pyautomators's JSON output files and store retrieved information in
:mod:`Pyautomators.model` elements.

Utility to retrieve runtime information from Pyautomators's JSON output.
...
import codecs
from Pyautomators import model
...
def parse(json_filename, encoding="UTF-8"):
    """
    Reads Pyautomators JSON output file back in and stores information in
    Pyautomators model elements.
