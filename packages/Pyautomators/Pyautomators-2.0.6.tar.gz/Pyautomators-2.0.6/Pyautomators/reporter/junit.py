...
Mapping of Pyautomators model elements to XML elements::
...
from Pyautomators.reporter.base import Reporter
from Pyautomators.model import Scenario, ScenarioOutline, Step
from Pyautomators.model_core import Status
from Pyautomators.formatter import ansi_escapes
from Pyautomators.model_describe import ModelDescriptor
from Pyautomators.textutil import indent, make_indentation, text as _text
from Pyautomators.userdata import UserDataNamespace
import six
if six.PY2:
...
class JUnitReporter(Reporter):
    """Generates JUnit-like XML test report for Pyautomators.
    """
    # -- XML REPORT:
    userdata_scope = "Pyautomators.reporter.junit"
    ...
    def setup_with_userdata(self, userdata):
        ...
        .. code-block:: ini
            ...
            # -- FILE: Pyautomators.ini
            [Pyautomators.userdata]
            Pyautomators.reporter.junit.show_hostname = false
        """
        # -- EXPERIMENTAL:
