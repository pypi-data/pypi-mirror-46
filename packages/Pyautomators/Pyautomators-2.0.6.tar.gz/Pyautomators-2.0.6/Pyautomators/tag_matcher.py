...
class ActiveTagMatcher(TagMatcher):
    ...
    .. code-block:: python
        ...
        from Pyautomators.tag_matcher import ActiveTagMatcher
        import sys
...
class OnlyWithCategoryTagMatcher(TagMatcher):
    ...
    .. code-block:: python
        ...
        # -- FILE: features/environment.py
        from Pyautomators.tag_matcher import OnlyWithCategoryTagMatcher
        import sys
...
class OnlyWithAnyCategoryTagMatcher(TagMatcher):
    ...
    .. code-block:: python
        ...
        # -- FILE: features/environment.py
        from Pyautomators.tag_matcher import OnlyWithAnyCategoryTagMatcher
        import sys
