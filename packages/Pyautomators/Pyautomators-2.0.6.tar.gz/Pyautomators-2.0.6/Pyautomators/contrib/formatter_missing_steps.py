...
from Pyautomators.runner_util import make_undefined_step_snippets
...
from Pyautomators import given, when, then, step
...
class MissingStepsFormatter(StepsUsageFormatter):
    ...
    .. code-block:: ini
        ...
        Pyautomators.formatter.missing_steps.template = # -*- coding: {encoding} -*-
    ...
    scope = "Pyautomators.formatter.missing_steps"
