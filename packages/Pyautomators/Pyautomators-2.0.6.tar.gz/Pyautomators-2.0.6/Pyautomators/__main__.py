...
import sys
import six
from Pyautomators import __version__
from Pyautomators.configuration import Configuration, ConfigError
from Pyautomators.parser import ParserError
from Pyautomators.runner import Runner
from Pyautomators.runner_util import print_undefined_step_snippets, reset_runtime, \
    InvalidFileLocationError, InvalidFilenameError, FileNotFoundError
from Pyautomators.textutil import compute_words_maxsize, text as _text
...
You may even leave off the "@" - Pyautomators doesn't mind.
...
def main(args=None):
    """Main function to run Pyautomators (as program).
    ...
    return run_Pyautomators(config)
