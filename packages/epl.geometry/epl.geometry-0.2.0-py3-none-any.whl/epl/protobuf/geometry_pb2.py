...
_FILEREQUESTCHUNK = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='results_encoding_type', full_name='epl.protobuf.FileRequestChunk.results_encoding_type', index=1,
...
_FILEREQUESTCHUNK.fields_by_name['results_encoding_type'].enum_type = _GEOMETRYENCODINGTYPE
