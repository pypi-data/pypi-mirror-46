...
class SharedTopicSubscriptionTaskSet:
    ...
    def __init__(self, dag, topic_project, topic, subscription, subscription_project, trigger_msg, max_messages=1000, ack_messages=True, gcp_conn_id='google_cloud_default'):
        self.gcp_conn_id = gcp_conn_id,
        self.dag = dag
