...
class SharedTopicPubSubPullSensor(PubSubPullSensor):
    ...
    def __init__(
        ...
        super(SharedTopicPubSubPullSensor, self).__init__(*args, **kwargs)
    ...
    def execute(self, context):
        return super(SharedTopicPubSubPullSensor, self).execute(context)
    ...
    def poke(self, context):
        ...
        if self._messages and self.ack_messages:
            ...
            if self._messages.attributes:
                print('Attributes:')
                for key in self._messages.attributes:
                    value = self._messages.attributes.get(key)
