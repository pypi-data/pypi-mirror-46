...
class MixIn (
    ...
    def __init__ (self):
        ...
        self.service_ns = None # IMP: set from wsgi_apps, services package root module
        self.mount_params = {}
        self.reloadables = {}
    ...
    def maybe_reload (self):
        ...
        for module in list (self.reloadables.keys ()):
            ...
            if self.reloadables [module] != fi:
                ...
                with self.glock:
                    if self.service_ns:
                        sys.modules [self.service_ns.__name__] = self.service_ns
                    with self.lock:                    
                    ...
                    if self.service_ns:
                        del sys.modules [self.service_ns.__name__]                    
