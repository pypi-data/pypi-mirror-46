"""Simple interface for opening videos and getting frames using cv2.
"""
import cv2
import time
...
class OpenVideo:
    ...
    def open_video(self, file_location):
        ...
        # Get video source width and height AND RETURN TRUE THAT THE FILE OPENED
        self.width = self.vid.get(cv2.CAP_PROP_FRAME_WIDTH)
        self.height = self.vid.get(cv2.CAP_PROP_FRAME_HEIGHT)
        self.frameCount = int(vid.get(cv2.CAP_PROP_FRAME_COUNT))
        return True
