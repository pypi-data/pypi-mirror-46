...
class UnknownError(CaptchaError):
    @staticmethod
...
class WrongUserKeyError(CaptchaError):
    @staticmethod
    def answer():
        return {
            "text": """Исключение порождается при неправильном Cptch.net KEY.
...
class NonExistentKeyError(CaptchaError):
    @staticmethod
    def answer():
        return {
            "text": """Исключение порождается при несуществующем Cptch.net KEY.
...
class PageUrlError(CaptchaError):
    @staticmethod
    def answer():
        return {
...
class NoSlotsError(CaptchaError):
    @staticmethod
    def answer():
        return {
...
class ZerroCaptchaSizeError(CaptchaError):
    @staticmethod
    def answer():
        return {
...
class ToBigCaptchaSizeError(CaptchaError):
    @staticmethod
    def answer():
        return {
            "text": """Исключение порождается при некорректной загрузке изображения.
...
class WrongCaptchaFormatError(CaptchaError):
    @staticmethod
    def answer():
        return {
...
class NotSupportedCaptchaTypeError(CaptchaError):
    @staticmethod
    def answer():
        return {
            "text": """Исключение порождается при загрузке некорректного изображения.
...
class ErrorUploadCaptchaError(CaptchaError):
    @staticmethod
    def answer():
        return {
            "text": """Исключение порождается при загрузке некорректного изображения.
...
class IPNotAllowedError(CaptchaError):
    @staticmethod
    def answer():
        return {
...
class BannedIPError(CaptchaError):
    @staticmethod
    def answer():
        return {
...
class BadTokenOrPageurlCaptchaError(CaptchaError):
    @staticmethod
    def answer():
        return {
...
class ErrorGoogleKeyCaptchaError(CaptchaError):
    @staticmethod
    def answer():
        return {
...
class BlockedimageCaptchaError(CaptchaError):
    @staticmethod
    def answer():
        return {
...
class MaxUserTurnCaptchaError(CaptchaError):
    @staticmethod
    def answer():
        return {
...
# res.php
class CaptchaNotReadyError(CaptchaError):
    @staticmethod
    def answer():
        return {
...
class UnsolvableCaptchaError(CaptchaError):
    @staticmethod
    def answer():
        return {
...
class WrongCaptchaIDFormatError(CaptchaError):
    @staticmethod
    def answer():
        return {
...
class WrongCaptchaIDError(CaptchaError):
    @staticmethod
    def answer():
        return {
...
class BadDuplicatesError(CaptchaError):
    @staticmethod
    def answer():
        return {
...
class ReportNotRecordedError(CaptchaError):
    @staticmethod
    def answer():
        return {
            "text": """Исключение порождается при некорректной загрузке изображения.
...
# NNNN
class Number1001Error(CaptchaError):
    @staticmethod
    def answer():
        return {
...
class Number1002Error(CaptchaError):
    @staticmethod
    def answer():
        return {
...
class Number1003Error(CaptchaError):
    @staticmethod
    def answer():
        return {
...
class Number1004Error(CaptchaError):
    @staticmethod
    def answer():
        return {
            "text": """Блокировка на 10 минут.
...
class Number1005Error(CaptchaError):
    @staticmethod
    def answer():
        return {
            "text": """Блокировка на 5 минут.
