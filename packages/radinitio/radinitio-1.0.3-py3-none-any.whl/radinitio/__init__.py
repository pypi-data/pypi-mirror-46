...
def simulate(
    ...
    try:
        ...
        print('radinitio.simulate started on {}.'.format(datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")), flush=True)
        print('Simulating for {} chromosomes.'.format(len(chromosomes)), flush=True)
        print_msp_params(msprime_simulate_args, sys.stdout)
        print(mutation_opts, flush=True)
        print(library_opts, flush=True)
        print(pcr_opts, flush=True)

        # Load the genome.
        print('Loading the genome...', flush=True)
        ...
        # Run msprime
        print('Simulating chromosomes with msprime...', flush=True)
...
def make_population(
    ...
    try:
        ...
        sys.stdout = open('{}/radinitio.log'.format(out_dir), "w")
        print('RADinitio version {}'.format(__version__), flush=True)
        print('radinitio.make_population started on {}.'.format(datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")), flush=True)
        print('Simulating for {} chromosomes.'.format(len(chromosomes)), flush=True)
        print_msp_params(msprime_simulate_args, sys.stdout)
        print(mutation_opts, flush=True)
