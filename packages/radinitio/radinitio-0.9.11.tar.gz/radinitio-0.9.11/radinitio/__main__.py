...
def main():
    ...
    if args.n_pops > 1:
        ...
        mig_r = 0.001
        m = mig_r / (4 * (args.n_pops - 1)) # per generation migration rate FIXME: @Nicolas 2019-05-06: This needs more explanation.
        msprime_simulate_args['migration_matrix'] = [ [
                0 if i == j else m
    ...
    # Print PCR duplicate distribution
    pcr_opts.print_seq_clone_dist(args.out_dir)
