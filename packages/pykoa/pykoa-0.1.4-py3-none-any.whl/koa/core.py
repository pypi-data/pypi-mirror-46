...
#       
        self.tap_url = \
	    'http://vmkoatest.ipac.caltech.edu/cgi-bin/TAP/nph-tap.py'
        self.query_url = \
	    'http://vmkoatest.ipac.caltech.edu/cgi-bin/KoaAPI/nph-makeQuery?'
        self.koaurl = 'http://vmkoatest.ipac.caltech.edu/cgi-bin/getKOA/nph-getKOA?return_mode=json&'
        self.caliburl = \
            'http://vmkoatest.ipac.caltech.edu/cgi-bin/KoaAPI/nph-getCaliblist?'
...
#
#        self.tap_url = \
#	    'https://koa.ipac.caltech.edu/cgi-bin/TAP/nph-tap.py'
#        self.query_url = \
#	    'https://koa.ipac.caltech.edu/cgi-bin/KoaAPI/nph-makeQuery?'
#        self.koaurl = 'https://koa.ipac.caltech.edu/cgi-bin/getKOA/nph-getKOA?return_mode=json&'
#        self.caliburl = \
#            'https://koa.ipac.caltech.edu/cgi-bin/KoaAPI/nph-getCaliblist?'
...
#        url = "http://vmkoadev.ipac.caltech.edu:9010/cgi-bin/KoaAPI/nph-koaLogin?" + data_encoded
        url = "http://vmkoatest.ipac.caltech.edu/cgi-bin/KoaAPI/nph-koaLogin?" + data_encoded
