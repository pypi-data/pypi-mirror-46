...
class TemplateLoaderTest(TenantTestCase):
    ...
    def setUpClass(cls):
        cls.engine = Engine(
            loaders=["django_common_user_tenants.template.loaders.filesystem.Loader"]
        )
...
class TenantCachedLoaderTestCase(TenantTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.engine = Engine(
            loaders=[
                (
                    "django_common_user_tenants.template.loaders.cached.Loader",
                    ["django_common_user_tenants.template.loaders.filesystem.Loader"],
                )
            ]
        )
