...
class TenantsConfig(AppConfig):
    ...
    def ready(self):
        ...
        if 'django_common_user_tenants.tenants.routers.TenantSyncRouter' not in settings.DATABASE_ROUTERS:
            raise ImproperlyConfigured("DATABASE_ROUTERS setting must contain "
                                       "'django_common_user_tenants.tenants.routers.TenantSyncRouter'.")
