...
class Bunny:
    ...
    def handler(self, environ, start_response):
        ...
        if url_array[1] == 'static':
            mime_type = MimeTypes().guess_type(url_array[-1])[0]
            try:
            ...
            start_response('200 OK', [('Content-Type', mime_type), ('Server', 'BunnyPy')])
        ...
        if len(self.__controllers__.keys()) > 0:
            ...
            self.__erase_query__()
            start_response('200 OK', [('Content-Type', 'text/html;charset=utf-8'), ('Server', 'BunnyPy')])
