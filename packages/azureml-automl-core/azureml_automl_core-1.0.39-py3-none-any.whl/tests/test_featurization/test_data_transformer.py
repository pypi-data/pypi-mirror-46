...
from azureml.automl.core.featurization import TextFeaturizers, WordEmbeddingTransformer
from azureml.automl.core.featurization.data import AbstractWordEmbeddingsProvider
...
class TestMemoryAwareFeaturization(unittest.TestCase):
    ...
    @file_data("test_data_transformer_data.json")
    @patch('azureml.automl.core.featurization.text.wordembedding_transformer.WordEmbeddingTransformer.'
