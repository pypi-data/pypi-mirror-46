...
from azureml.automl.core.featurization.timeseries.grain_index_featurizer import GrainIndexFeaturizer
from azureml.automl.core.featurization.timeseries.lag_lead_operator import LagLeadOperator
from azureml.automl.core.featurization.timeseries.time_series_imputer import TimeSeriesImputer
...
class TestFTKMLTransformsGrainIndexFeaturizer(unittest.TestCase):
    ...
    def test_grain_index_featurizer_column_overwrite(self):
        ...
        with self.assertRaises(AzureMLForecastException):
