...
from azureml.automl.core.featurization import CategoricalFeaturizers
from azureml.automl.core.featurization import CatImputer
from azureml.automl.core.featurization import HashOneHotVectorizerTransformer
from azureml.automl.core.featurization import LabelEncoderTransformer
from azureml.automl.core.featurization import OneHotEncoderTransformer
from azureml.automl.core.featurization.generic import CrossValidationTargetEncoder
