...
class BankRegistryAbstract:
    ...
    def deploy_bank(self,
        ...
        """
        return UnsentTransaction(self.meta_, self.w3_contract.functions.deployBank(to_pay_ether, date_args_uint256_array_4, deploy_num_args_uint256_array_4, _loan_token_address, data_bytes), to_pay_ether)
