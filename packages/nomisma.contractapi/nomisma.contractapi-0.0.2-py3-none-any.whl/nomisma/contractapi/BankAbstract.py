...
class BankAbstract:
    ...
    def deposit_equity(self,
        ...
        :return: an UnsentTransaction for [bool]
        """
        return UnsentTransaction(self.meta_, self.w3_contract.functions.depositEquity(to_pay_ether, amount, commission), to_pay_ether)
    ...
    def deposit_debt(self,
        ...
        :return: an UnsentTransaction for [bool]
        """
        return UnsentTransaction(self.meta_, self.w3_contract.functions.depositDebt(to_pay_ether, amount, commission), to_pay_ether)
    ...
    def borrow(self,
        ...
        """
        return UnsentTransaction(self.meta_, self.w3_contract.functions.borrow(to_pay_ether, collateral_type_address, collateral_amount, desired_idx), to_pay_ether)
    ...
    def pay_back_loans(self,
        ...
        :return: an UnsentTransaction for [None]
        """
        return UnsentTransaction(self.meta_, self.w3_contract.functions.payBackLoans(to_pay_ether, loan_idxes_uint256_list, payback_amounts_uint256_list), to_pay_ether)
    ...
    def preinit(self,
        ...
        :return: an UnsentTransaction for [bool]
        """
        return UnsentTransaction(self.meta_, self.w3_contract.functions.preinit(to_pay_ether, address_args_address_array_8, number_args_uint256_array_6, date_args_uint256_array_4, data_bytes), to_pay_ether)
