...
class PtsV2PaymentsPost201ResponseErrorInformation(object):
    ...
    def reason(self, reason):
        ...
        :type: str
        """
        allowed_values = ["AVS_FAILED", "CONTACT_PROCESSOR", "CV_FAILED", "EXPIRED_CARD", "PROCESSOR_DECLINED", "INSUFFICIENT_FUND", "STOLEN_LOST_CARD", "ISSUER_UNAVAILABLE", "UNAUTHORIZED_CARD", "CVN_NOT_MATCH", "EXCEEDS_CREDIT_LIMIT", "INVALID_CVN", "PAYMENT_REFUSED", "INVALID_ACCOUNT", "GENERAL_DECLINE", "DECISION_PROFILE_REJECT", "SCORE_EXCEEDS_THRESHOLD"]
