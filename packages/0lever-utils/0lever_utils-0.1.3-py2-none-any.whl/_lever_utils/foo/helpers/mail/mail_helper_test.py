...
from _lever_utils.foo.helpers.time import get_time
from _lever_utils.foo.helpers.mail.mail_helper import MailServer
import time
...
while True:
    ...
    if tmp != last_mail_info:
        ...
        for latest_result_file in latest_result_files:
            ...
            # with open("/Users/chaoyang/tmp/"+get_time(sf="%Y-%m-%d_%H%M%S")+b[0]["name"], 'w') as f:
