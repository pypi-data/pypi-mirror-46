...
#                        t3b=0.
                ...
                if (rho3>1):
                        print("   TKEout t3a =%15.5f   and  t3b  %f  " % (t3a,t3b)  )
                else:
...
#              0,1       2,3            4,     5
        if output!="all":
                ...
                output=output.split(',')
                if len(output)>1:
                        print("H...  from bash-you can get the array values   my_array=( $(<command>) ) ", file=sys.stderr)
                        print("H...                   ${#my_array[@]}  ${my_array[0]}   ", file=sys.stderr)
