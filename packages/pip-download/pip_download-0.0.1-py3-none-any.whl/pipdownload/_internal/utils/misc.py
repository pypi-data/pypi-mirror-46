...
from pipdownload._vendor.retrying import retry  # type: ignore
from pipdownload._vendor.six import PY2
from pipdownload._vendor.six.moves import input, shlex_quote
from pipdownload._vendor.six.moves.urllib import parse as urllib_parse
from pipdownload._vendor.six.moves.urllib.parse import unquote as urllib_unquote

from pipdownload._internal.exceptions import CommandError, InstallationError
from pipdownload._internal.locations import (
    running_under_virtualenv, site_packages, user_site, virtualenv_no_global,
    write_delete_marker_file,
)
from pipdownload._internal.utils.compat import (
...
if MYPY_CHECK_RUNNING:
    ...
    from pipdownload._internal.utils.ui import SpinnerInterface
...
subprocess_logger = std_logging.getLogger('pipdownload.subprocessor')
...
def unpack_file(
    ...
    if (content_type == 'application/zip' or
        ...
        from pipdownload._internal.vcs.subversion import Subversion
...
def protect_pip_from_modification_on_windows(modifying_pip):
    """Protection of pipdownload.exe from modification on Windows
