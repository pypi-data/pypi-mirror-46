...
from pipdownload._vendor.packaging.version import parse
...
def _showwarning(message, category, filename, lineno, file=None, line=None):
    if file is not None:
        ...
        # deprecation messages for pipdownload.
        logger = logging.getLogger("pipdownload._internal.deprecations")
