...
from pipdownload._internal.utils import appdirs
from pipdownload._internal.utils.compat import WINDOWS, expanduser
...
if WINDOWS:
    ...
    config_basename = 'pipdownload.ini'
    ...
    config_basename = 'pipdownload.conf'
