...
from pipdownload._vendor import pkg_resources
from pipdownload._vendor.distlib.scripts import ScriptMaker
from pipdownload._vendor.packaging.utils import canonicalize_name
from pipdownload._vendor.six import StringIO

from pipdownload._internal import pep425tags
from pipdownload._internal.download import path_to_url, unpack_url
...
if MYPY_CHECK_RUNNING:
    ...
    from pipdownload._internal.req.req_install import InstallRequirement
    from pipdownload._internal.download import PipSession
    from pipdownload._internal.index import FormatControl, PackageFinder
    from pipdownload._internal.operations.prepare import (
        RequirementPreparer
    )
