...
.. warning::
   ...
   `opencal` package. If you just want to write code that uses it
...
In your terminal, change to the directory where you cloned `opencal`, and type::

    conda env create -f environment.yml

This will create a conda virtual environment called `opencal-dev` with all
the OpenCAL dependencies and a few useful packages for development and
interaction.
...
* On Windows, in your Anaconda Prompt, run ``activate opencal-dev``
* On MacOSX and Linux, in your Terminal, run ``source activate opencal-dev``
...
type::
    ...
    conda list -n opencal-dev

If later you want to leave the `opencal-dev` virtual environment:
...
then on, all the OpenCAL binaries and the library itself will be
...
.. _available on GitHub: https://gitlab.com/jdhp/opencal-lib-python
...
.. _TODO.md: https://gitlab.com/jdhp/opencal-lib-python/blob/master/TODO.md
