...
# $Id: wallet.py,v 1.6 2019/04/21 09:25:03 scottgreen Exp $
...
def audit_transactions(transaction_records):
    log.info("==FULL AUDIT TRANSACTIONS==")
    ...
    for wallet in sorted(Wallet.wallets):
        log.info(Wallet.wallets[wallet])
