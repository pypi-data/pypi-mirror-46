...
The following as a set of guidelines for contributing to vigo.
...
by the [vigo Code of Conduct](CODE_OF_CONDUCT.md).
...
This section guides you through submitting a bug report for vigo.
...
[cursory search](https://github.com/4383/vigo/issues?q=is%3Aissue%20is%3Aopen%20)
...
* **Describe the exact steps which reproduce the problem** in as many details as possible. For example, start by explaining how you use the vigo command line, e.g. which command exactly you used in the terminal. When listing steps, **don't just say what you did, but explain how you did it**.
...
* **Did the problem start happening recently** (e.g. after updating to a new version of vigo) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of vigo?** What's the most recent version in which the problem doesn't happen? You can install older versions of vigo from [the pypi repository](https://pypi.org/project/vigo/).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of vigo are you using?** You can get the exact version by running `pip freeze | grep "vigo"` in your terminal.
* **What's the name and version of the OS you're using**?
* **What's the version of python you're using**?

### Suggesting Enhancements

This section guides you through submitting an enhancement suggestion for vigo, including completely new features and minor improvements to existing functionality. Following these guidelines helps maintainers and the community understand your suggestion and find related suggestions.
...
* **Include screenshots and animated GIFs** which help you demonstrate the steps or point out the part of vigo which the suggestion is related to. You can use [this tool](https://www.cockos.com/licecap/) to record GIFs on macOS and Windows, and [this tool](https://github.com/colinkeenan/silentcast) or [this tool](https://github.com/GNOME/byzanz) on Linux.
* **Explain why this enhancement would be useful** to most vigo users.
* **List some other tools or applications where this enhancement exists.**
* **Specify which version of vigo you're using.** You can get the exact version by running `pip freeze| grep "vigo"` in your terminal.
...
If you're hitting a bug in vigo or just want to experiment with adding a feature, follow these steps.
...
```shell
$ git clone https://github.com/4383/vigo
```

#### Setup your environment

From there, you can navigate into the directory where you've cloned the vigo source code,
...
$ git pull-request 
Forked repository: https://github.com/4383/vigo
...
To https://github.com/4383/vigo.git
 + 73a733f7...1be2bf29 somefeature -> somefeature (forced update)
 Pull-request created: https://github.com/4383/vigo/pull/33
```
