...
class Package:
    ...
    def _get_project_version(self):
        # filepath = self._search_xcodeproj() + "/project.pbxproj"
        # print("start change default environment variable")
        filepath = "/Users/xycoder/Desktop/IOS/享道出行/ios-shell-driver/ios-shell-driver.xcodeproj/project.pbxproj"
    ...
    def package_to_platform(self,platform=None, project_version=None, project_build=None):
        """
    ...
    def auto_package(self, project_address=None, branch_name=None, platform=None, net_env=None, project_version=None, project_build=None):
        if branch_name == None:
            branch_name = "Develop"
        if platform == None:
            platform = "pgyer"

        print("自动打包 项目：",project_address," 分支为：",branch_name," 发布平台为：",platform," 网络环境：",net_env," 版本号：",project_version," 编译号：",project_build)
