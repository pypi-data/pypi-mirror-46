...
from src.broker.broker import EventListener, Broker, Event
...
class OccupancyProcessorTests(unittest.TestCase):
    ...
    def test_occupancy_processor_multiple(self):
        test_occupancy_1 = {str(i): False for i in range(1, 7)}
        test_occupancy_2 = {str(i): True for i in range(1, 7)}
        ...
        occupancy_list = [True for _ in range(nr_occupied)]
        occupancy_list.extend([False for _ in range(nr_of_seats - nr_occupied)])
