from save_to_db.exceptions import (ModelClsAlreadyRegistered,
...
class MergePolicy(dict):
    ...
    There are conflicts of two types:
        ...
        - Meging models have x-to-one relationship with other model class, but
          point to diffent model instances.
        - Meging models have x-to-many relationship with other model class, but
          assing all the many models to one merged models breaks one or more
          unique constraints.
    ...
    :param policy:
        A dictionary that looks like this:
            ...
            .. code-block:: Python
                ...
                merge_policy = {
                    OrmModelClass_1: {
                        x_to_1_field_1: resolve_x_to_1_field_function_1,
                        x_to_1_field_2: resolve_x_to_1_field_function_2,
                        1_to_many_field_1: resolve_1_to_many_field_function_1,
            ...
            **Where:**
                ...
                - *x_to_1_field_1* is a x-to-one foreign key field name from the
                  class.
                - *1_to_many_field_1* is a one-to-may foreign key field from the
                  class.
                - *resolve_x_to_1_field_function_1* is a merge function for the
                  field that accepts arguments:
                ...
                - *resolve_1_to_many_field_function_1* is a merge function for
                  ...
                  *resolve_x_to_1_field_function_1* and a list of unique
    ...
    :param defaults:
        Default model resolver. A dictionary that looks like this:
            ...
            .. code-block:: Python
                ...
                defaults = {
                    OrmModelClass_1: {
                        'one': resolve_x_to_1_field_function_1,
                        'many': resolve_1_to_many_field_function_1,
                        ...
                    },
                    ...
                }
            ...
            **Where:**
                ...
                - *OrmModelClass_1*,
                - *resolve_x_to_1_field_function_1*,
                - and *'resolve_1_to_many_field_function_1* are same as for the
                  `policy` parameter.
    ...
    def __init__(self, db_adapter, policy, defaults=None):
        ...
        self.registered_models = set(policy.keys()).union(defaults.keys())
    ...
    def __resolve_defaults(self):
        ...
        for model_cls in self.db_adapter.iter_all_models():
            for fkey, fmodel_cls, direction, _ in \
                    self.db_adapter.iter_relations(model_cls):
                ...
                if fkey not in self[model_cls]:
                    self[model_cls][fkey] = \
                        self.defaults[fmodel_cls][multiplication_key]
