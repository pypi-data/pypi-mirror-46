...
class TestItemHooks(TestBase):
    ...
    def test_models_merge_hooks(self):
        self.setup_models_2()
        ...
        def before_models_merge(self, models):
            hook_history.append(
                ['before_models_merge', [m.f_integer for m in models]])
        
        def after_models_merge(self, model):
            hook_history.append(
                ['after_models_merge', model.f_integer])
        
        self.ItemGeneralOne.before_models_merge = before_models_merge
        self.ItemGeneralOne.after_models_merge = after_models_merge
        ...
        expected = [
            ['before_models_merge', [1, 2]],
            ['after_models_merge', 1],
        ]
        self.assertEqual(hook_history, expected)