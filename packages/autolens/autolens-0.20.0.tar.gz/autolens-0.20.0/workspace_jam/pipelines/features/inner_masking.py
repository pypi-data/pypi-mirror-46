...
def make_pipeline(phase_folders=None, tag_phases=True, inner_mask_radii=None):
    ...
    class LensSubtractedPhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens = results.from_phase('phase_1_use_inner_radii_input').variable.lens_galaxies.lens
            self.source_galaxies.source = results.from_phase('phase_1_use_inner_radii_input').variable.source_galaxies.source
