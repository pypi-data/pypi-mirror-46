...
def make_pipeline(phase_folders=None, tag_phases=True, sub_grid_size=2, bin_up_factor=None, positions_threshold=None,
    ...
    class GridPhase(autofit_ph.as_grid_search(ph.LensSourcePlanePhase)):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.mass.centre = results.from_phase('phase_1_lens_pl_shear_source_sersic').\
                constant.lens_galaxies.lens.mass.centre

            self.lens_galaxies.lens.mass.axis_ratio = results.from_phase('phase_1_lens_pl_shear_source_sersic').\
                constant.lens_galaxies.lens.mass.axis_ratio

            self.lens_galaxies.lens.mass.phi = results.from_phase('phase_1_lens_pl_shear_source_sersic').\
                constant.lens_galaxies.lens.mass.phi

            self.lens_galaxies.lens.mass.slope = results.from_phase('phase_1_lens_pl_shear_source_sersic').\
                constant.lens_galaxies.lens.mass.slope

            self.lens_galaxies.lens.shear = results.from_phase('phase_1_lens_pl_shear_source_sersic').\
                constant.lens_galaxies.lens.shear

            self.lens_galaxies.lens.mass.einstein_radius = results.from_phase('phase_1_lens_pl_shear_source_sersic').\
                variable_relative(r=0.2).lens_galaxies.lens.mass.einstein_radius
    ...
    class SubhaloPhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens = results.from_phase('phase_1_lens_pl_shear_source_sersic').variable.lens_galaxies.lens
            ...
            self.source_galaxies.source = results.from_phase('phase_2_subhalo_search').best_result.\
