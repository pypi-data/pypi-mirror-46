    ...
    class LensSourcePhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens.mass.centre = \
                results.from_phase('phase_2_lens_sie_shear_source_inversion').variable.lens_galaxies.lens.mass.centre

            self.lens_galaxies.lens.mass.axis_ratio = \
                results.from_phase('phase_2_lens_sie_shear_source_inversion').variable.lens_galaxies.lens.mass.axis_ratio

            self.lens_galaxies.lens.mass.phi = \
                results.from_phase('phase_2_lens_sie_shear_source_inversion').variable.lens_galaxies.lens.mass.phi

            self.lens_galaxies.lens.mass.einstein_radius_in_units = \
                results.from_phase('phase_2_lens_sie_shear_source_inversion').variable_absolute(a=0.3).lens_galaxies.lens.mass.einstein_radius_in_units

            ### Lens Shear, Shear -> Shear ###

            self.lens_galaxies.lens.mass.shear = \
                results.from_phase('phase_2_lens_sie_shear_source_inversion').variable.lens_galaxies.lens.shear

            ### Source Inversion, Inv -> Inv ###

            self.source_galaxies.source.pixelization = \
                results.from_phase('phase_3_lens_sie_shear_refine_source_inversion').constant.source_galaxies.source.pixelization

            self.source_galaxies.source.regularization = \
                results.from_phase('phase_3_lens_sie_shear_refine_source_inversion').variable.source_galaxies.source.regularization
    ...
    class InversionPhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens = \
                results.from_phase('phase_1_lens_pl_shear_source_inversion').constant.lens_galaxies.lens

            ### Source Inversion, Inv -> Inv ###

            self.source_galaxies.source = \
                results.from_phase('phase_1_lens_pl_shear_source_inversion').variable.source_galaxies.source
