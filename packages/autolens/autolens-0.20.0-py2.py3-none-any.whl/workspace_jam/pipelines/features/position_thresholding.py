...
#        mass models.
    ...
    class LensSubtractedPhase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens = results.from_phase('phase_1_use_positions').variable.lens_galaxies.lens
            self.source_galaxies.source = results.from_phase('phase_1_use_positions').variable.source_galaxies.source
