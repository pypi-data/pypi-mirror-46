...
def make_pipeline(phase_folders=None, interp_pixel_scale=0.05):
    ...
    class LensSourceX2Phase(ph.LensSourcePlanePhase):
        ...
        def pass_priors(self, results):
            ...
            self.lens_galaxies.lens = results.from_phase('phase_1_x1_source').variable.lens_galaxies.lens
            self.source_galaxies.source_0 = results.from_phase('phase_1_x1_source').variable.source_galaxies.source_0
